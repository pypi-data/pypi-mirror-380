...
class VideoDownloader:
    ...
    def _download_single(self, video_url: str,video_path:str=None):
        ...
        try:
            ...
            final_path = video_path or self.video_path or info.get("video_path") or os.path.join(self.download_directory, f"video.{ext}")
...
def get_video_info_spec(
    ...
    if not video_info:   # yt-dlp failed
        logger.warning(f"[get_video_info_spec] No info for {url}")
        return None
