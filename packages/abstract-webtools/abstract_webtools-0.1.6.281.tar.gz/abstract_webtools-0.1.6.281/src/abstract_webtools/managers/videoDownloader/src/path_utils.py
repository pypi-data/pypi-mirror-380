...
def downloadvideo(
    ...
    *args, **kwargs,
    ...
    # Attach the rest of the schema without creating a second folder:
    # pass the *root* and tell it whether we're flat or not.
    video_root_for_schema = base_root
    info = ensure_standard_paths(info, video_root_for_schema, flat_layout=flat_layout)
