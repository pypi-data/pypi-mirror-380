...
class VideoDownloader:
    def __init__(self, url=None,download_directory=None, user_agent=None,
        ...
        self.url = get_corrected_url(url or video_url) 
    ...
    def _download_single(self, url=None,download_directory=None, user_agent=None,
                         ...
                         registry=None, force_refresh=False,
                         flat_layout: bool = False,video_url =None):
         url = get_corrected_url(url or video_url or self.url) 

         ydl_opts = ydl_opts or self.ydl_opts or {}
         get_download = get_download or self.get_download
         ...
         self.url = get_corrected_url(url or video_url or self.url) 
...
def download_video(video_url,
        ...
        videoDownload_mgr = get_videoDownloader(video_url=video_url,
            download_directory=download_directory,
            user_agent=user_agent,
            video_extention=video_extention,
            download_video=download_video,
        ...
        return videoDownload_mgr._download_single(video_url=video_url,video_path=video_path)
