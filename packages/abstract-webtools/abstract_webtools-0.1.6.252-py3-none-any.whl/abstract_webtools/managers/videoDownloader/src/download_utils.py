...
class VideoDownloader:
    ...
    def _download_single(self, video_url: str):
        ...
        try:
            ...
            # Always build a directory for the video_id (or flat root if flat_layout)
            ...
            # Resolve temp download path and extension
