...
class AttackIQRestClient:
    ...
    def __init__(self, platform_url: str, platform_api_token: str):
        ...
        logger.info(f"Token type detection: is_jwt={is_jwt}, using auth_prefix='{auth_prefix}'")
        logger.info(f"Token preview: {platform_api_token[:10]}... (length: {len(platform_api_token)})")
        self.headers = {
