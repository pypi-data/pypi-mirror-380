...
class V1ContainerExtendedResourceRequest(BaseModel):
    ...
    container_name: StrictStr = Field(
        description="The name of the container requesting resources.",
        alias="containerName",
    )
    request_name: StrictStr = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "containerName": (
                    obj.get("containerName")
                    if obj.get("containerName") is not None
                    else ""
                ),
                "requestName": (
                    obj.get("requestName") if obj.get("requestName") is not None else ""
                ),
                "resourceName": (
