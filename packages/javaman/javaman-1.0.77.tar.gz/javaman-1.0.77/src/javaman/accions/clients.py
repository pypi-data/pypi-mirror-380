...
class Clients:
    ...
    _url_clients_classificacions = '/clients/{client_id}/classificacions'
    ...
    def get_clients_classificacions(self, p_client_id: int) -> list:
        req = self._con.get(url=self._url_clients_classificacions.format(client_id=p_client_id))
        result = req.json()
        return result
