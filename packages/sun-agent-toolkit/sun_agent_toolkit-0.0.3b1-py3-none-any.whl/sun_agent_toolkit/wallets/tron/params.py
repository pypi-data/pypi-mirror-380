...
class BuildSendTrxParameters(BaseModel):
    ...
    from_address: str | None = Field(
        ...
        default=None,
        validation_alias=AliasChoices("from", "fromAddress", "from_address"),
    )
...
class BuildSendTokenParameters(BaseModel):
    ...
    tokenId: str = Field(
        ...
        validation_alias=AliasChoices("tokenId", "token_id", "token"),
    )
    from_address: str | None = Field(
        description="Optional sender address. Defaults to the wallet address if omitted.",
        default=None,
...
class UnfreezeBalanceParameters(BaseModel):
    ...
    amountInSun: str | None = Field(
        description="Amount to unfreeze in SUN. If omitted, unfreezes all available for the specified resource.",
        default=None,
    )
