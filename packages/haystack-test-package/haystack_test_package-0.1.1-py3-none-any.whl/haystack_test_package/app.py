...
def create_app(
    ...
    *,
    ...
    state: Dict[str, Any] = {"model": preloaded_model}
    ...
    async def _startup() -> None:
        ...
        try:
            state["model"] = await download_and_load_model(cfg.s3_model_path)
    ...
    async def health():
        ...
        return {"status": "ok", "model_loaded": True, "cache_size": len(features_cache)}
    ...
    async def root():
        return {"message": "ML Scoring Service is running."}
