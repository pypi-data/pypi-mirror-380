...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "pulp_labels", "pulp_last_updated", "pulp_href", "base_url", "prn", "no_content_change_since", "content_guard", "name", "pulp_created", "hidden"]
