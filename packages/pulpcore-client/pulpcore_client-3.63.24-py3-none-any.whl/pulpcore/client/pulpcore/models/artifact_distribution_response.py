...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, hidden=False, name=None, base_url=None, no_content_change_since=None, content_guard=None, pulp_href=None, pulp_labels=None, pulp_last_updated=None, pulp_created=None, prn=None, local_vars_configuration=None):  # noqa: E501
