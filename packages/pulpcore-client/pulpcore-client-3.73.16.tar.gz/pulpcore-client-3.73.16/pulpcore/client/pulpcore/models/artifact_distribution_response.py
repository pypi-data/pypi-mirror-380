...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "no_content_change_since", "base_url", "pulp_last_updated", "pulp_created", "prn", "pulp_labels", "pulp_href", "name", "hidden", "base_path"]
