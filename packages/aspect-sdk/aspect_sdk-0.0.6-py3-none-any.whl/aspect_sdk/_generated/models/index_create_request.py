...
class IndexCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "default_features", "is_sample"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IndexCreateRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if is_sample (nullable) is None
        # and model_fields_set contains the field
        if self.is_sample is None and "is_sample" in self.model_fields_set:
            _dict['is_sample'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IndexCreateRequest from a dict"""
        if obj is None:
            return None
