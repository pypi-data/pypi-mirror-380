...
class AnalyzeAskResponse(BaseModel):
    """
    AnalyzeAskResponse
    """ # noqa: E501
    answer: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["answer", "reasoning"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalyzeAskResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalyzeAskResponse from a dict"""
        if obj is None:
            return None
