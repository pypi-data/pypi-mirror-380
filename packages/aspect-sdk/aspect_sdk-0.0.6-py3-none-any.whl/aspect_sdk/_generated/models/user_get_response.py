...
class UserGetResponse(BaseModel):
    ...
    created: datetime
    updated: datetime
    tokens_remaining: StrictInt
    is_aspect_admin: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "external_id", "first_name", "last_name", "email", "avatar_url", "created", "updated", "tokens_remaining", "is_aspect_admin"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if is_aspect_admin (nullable) is None
        # and model_fields_set contains the field
        if self.is_aspect_admin is None and "is_aspect_admin" in self.model_fields_set:
            _dict['is_aspect_admin'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_aspect_admin": obj.get("is_aspect_admin")
        })
