...
class Http10Client:
    ...
    def request(method, url, headers=None, params=None, data=None, json=None, files=None,
        ...
        if parsed.scheme == "https":
            ssl_context = ssl.create_default_context() if verify else ssl._create_unverified_context()
        ...
        if proxy:
            ...
            if parsed.scheme == "https":
                conn = http.client.HTTPSConnection(proxy_parsed.hostname, proxy_parsed.port, timeout=timeout, context=ssl_context)
            else:
