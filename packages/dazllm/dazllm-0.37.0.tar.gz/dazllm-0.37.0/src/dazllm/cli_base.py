...
from .core import Llm, Conversation, ConfigurationError, DazLlmError, LlmResponse
...
class CliProviderBase(Llm):
    ...
    def _check_executable(self):
        ...
        try:
            result = subprocess.run(
                [self.executable, self._get_help_flag()],
                capture_output=True,
                text=True
            )
    ...
    def _extract_json(self, text: str) -> dict:
        ...
        cleaned = text.strip()
        prefixes = ["Here is the JSON:", "JSON:", "Output:", "Result:", "Response:", "Here's the JSON:"]
