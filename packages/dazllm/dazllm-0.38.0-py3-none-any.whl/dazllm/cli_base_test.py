...
def test_real_cli_providers():
    """Test that real CLI providers properly inherit from base"""
    # Test Claude CLI inherits from base
    assert issubclass(LlmClaudeCli, CliProviderBase)
    ...
    assert hasattr(claude_cli, "_extract_json")
...
def test_async_methods():
    ...
    async def run_async_tests():
        ...
        assert isinstance(result, AsyncTest)
