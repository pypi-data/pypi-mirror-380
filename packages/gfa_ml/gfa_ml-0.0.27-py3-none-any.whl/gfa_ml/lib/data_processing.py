...
def create_time_aware_sequences(
    ...
    try:
        if (history_size % interval_minutes) != 0:
        ...
        for index_i in valid_indices:
            ...
            start_index = index_i - (retention_time + window_size / 2)
            end_index = index_i - (retention_time - window_size / 2 + 1)
            ...
            if input_sequence.shape[0] == window_size:
