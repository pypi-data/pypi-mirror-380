...
class FeatureTableClient:
        ...
        try:
            if is_streaming:
                ...
                df.write \
                    .mode(mode) \
                    .insertInto(table_name)
                self._feast_client.client.write_to_offline_store(feature_view_name=table_name, df=df.toPandas())
                return None
    ...
    def _read_online_table(self, table_name: str, database_name: str, online_config: RedisStoreConfig,
        ...
        if not entity_row:
            ...
            if result_row:
                ...
                return self._spark.createDataFrame(online_view)
            else:
