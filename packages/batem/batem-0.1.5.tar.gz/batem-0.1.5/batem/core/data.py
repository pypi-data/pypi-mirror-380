...
The module provides:
- DataProvider: Main interface for accessing all types of measurement and weather data
- IndependentVariableSet: Container for time-series measurement data with regular sampling
- ParameterSet: Container for constant parameters and configuration values
- ParameterizedVariableSet: Container for variables that depend on other parameters
- VariableAccessorRegistry: Registry system for managing data accessors and bindings
- Bindings: System for linking model variable names to measurement data names
- VariableAccessor classes: Abstract and concrete implementations for data access patterns
