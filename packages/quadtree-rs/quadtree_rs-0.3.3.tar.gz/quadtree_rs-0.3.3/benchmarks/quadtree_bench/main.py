...
def main():
    ...
    parser.add_argument(
        "--max-points", type=int, default=20,
    ...
    parser.add_argument(
        "--n-queries", type=int, default=500,
    ...
    parser.add_argument(
        "--max-experiment-points", type=int, default=500_000,
    ...
    parser.add_argument(
        "--output-prefix", type=str, default="quadtree_bench",
    ...
    parser.add_argument(
        ...
        help="Don't show plots in browser"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--bounds", nargs=4, type=int, default=[0, 0, 1000, 1000],
...
def run_custom_benchmark(bounds=(0, 0, 1000, 1000),
                        max_points=20,
                        max_depth=10,
                        experiments=None):
    """
