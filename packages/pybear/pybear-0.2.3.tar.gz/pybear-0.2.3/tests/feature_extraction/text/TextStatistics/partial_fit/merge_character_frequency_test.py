...
from pybear.feature_extraction.text._TextStatistics._partial_fit. \
    _merge_character_frequency import _merge_character_frequency



class TestMergeCharacterFrequency:

    # all validation is handled by _val_character_frequency, which is
    # tested elsewhere
    ...
    def test_accuracy(self):
        ...
        out1 = _merge_character_frequency(_wf_1, _wf_2)
        ...
        out2 = _merge_character_frequency(_wf_3, out1)
