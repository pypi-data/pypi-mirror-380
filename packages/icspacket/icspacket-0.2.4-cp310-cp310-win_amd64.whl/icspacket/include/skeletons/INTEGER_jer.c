 ...
 */
static enum jer_pbd_rval INTEGER__jer_body_decode(
...
asn_dec_rval_t INTEGER_decode_jer(const asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t INTEGER_encode_jer(const asn_TYPE_descriptor_t *td,
                                  const asn_jer_constraints_t *constraints,
