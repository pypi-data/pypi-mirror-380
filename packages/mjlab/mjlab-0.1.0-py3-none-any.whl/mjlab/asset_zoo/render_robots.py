...
from mjlab.utils.spec_config import LightCfg, TextureCfg
...
def render_robots(name: str, cfg: EntityCfg):
  ...
  light = LightCfg(pos=(2, 2, 3), dir=(-0.5, -0.5, -1), type="spot", castshadow=False)
  robot = Entity(replace(cfg, textures=(skybox_tex,), lights=(light,)))
  model = robot.compile()
