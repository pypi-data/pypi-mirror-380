    ...
    def register_model_version(
        ...
        with ModelSerializer.from_model(model, model_type) as model_serializer:
            ...
            if input_schema is None:
                raise ValueError("You must specify at least one of input_schema to register a model version.")
            if output_schema is None and output_features is None:
                raise ValueError("You must specify at least one of output_schema to register a model version.")
