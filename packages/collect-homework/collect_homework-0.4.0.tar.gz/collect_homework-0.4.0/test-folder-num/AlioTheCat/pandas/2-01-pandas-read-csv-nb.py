...
# %%
nm = "PassengerId,Survived,Pclass,Name,Sex,Age,SibSp,Parch,Ticket,Fare,Cabin,Embarked".split(",")
df = pd.read_csv("data/petit-titanic.csv", sep=";", header=None, names=nm)
pd.DataFrame.head(df)
...
# %%
print(len(df.columns), len(df.index), sep="\n")
