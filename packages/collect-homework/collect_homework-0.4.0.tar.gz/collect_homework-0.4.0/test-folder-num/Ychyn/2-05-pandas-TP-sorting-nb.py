...
# %%
# votre code
df = pd.read_csv('data/titanic.csv', usecols = ['PassengerId', 'Survived', 'Pclass', 'Name', 'Sex', 'Age', 'Fare'], index_col='PassengerId')
df.head()
...
# %%
# votre code
df1.plot(y=['Age'],style='b.')
# C'est la même chose (juste en bleu)
