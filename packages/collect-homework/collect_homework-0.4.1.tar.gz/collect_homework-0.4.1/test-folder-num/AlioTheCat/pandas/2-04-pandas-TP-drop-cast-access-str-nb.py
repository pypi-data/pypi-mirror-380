...
## le type de la masse est un objet ! et pas un entier/flottant
...
# %%
# votre code
pd.Series.unique(df["Mass (lb)"])

# Cette colonne n'est pas homogène, on a des strings de nombres, 
# car parfois les valeurs sont des majorations/minorations, et également un NaN
...
df["Mass (lb)"] = pd.to_numeric(df["Mass (lb)"], errors="coerce") #on remplace par NaN si pb rencontré
