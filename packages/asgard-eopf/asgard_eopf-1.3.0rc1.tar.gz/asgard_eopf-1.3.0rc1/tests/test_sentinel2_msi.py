...
def test_2025_config_for_msi():
    ...
    # use DEM90 as xr.Dataset
    dem_path = "s3://common/ADFstatic/S00__ADF_DEM90_20000101T000000_21000101T000000_20240605T132601.zarr"
    s3_config = {
        "key": os.environ.get("S3_COMMON_ACCESS"),
        "secret": os.environ.get("S3_COMMON_SECRET"),
        "client_kwargs": {
    ...
    dem_store = FSStore(dem_path, mode="r", **s3_config)

    # use geoid as zarr FSStore
    geoid_path = "s3://common/ADFstatic/S00__ADF_GEOI8_20000101T000000_21000101T000000_20250326T182038.zarr"
    s3_config = {
        "key": os.environ.get("S3_COMMON_ACCESS"),
        "secret": os.environ.get("S3_COMMON_SECRET"),
        "client_kwargs": {
