...
# Canonical, typed schemas for the six OTel tables that Depths v0.1.0
...
SPAN_SCHEMA = EventSchema(
    ...
    defaults={
        ...
        "status_code":"UNSET", "status_message":"", "kind":"INTERNAL", "parent_span_id":"", "span_attrs_json":"{}",
    },
    computed={
...
SPAN_LINK_SCHEMA = EventSchema(
    ...
    defaults={
        "schema_version": 1, "link_attrs_json":"{}",
        "service_name": "unknown",
        "service_namespace":"", "service_instance_id":"", "service_version":"", "deployment_env":"",
        "scope_name":"", "scope_version":"", "resource_attrs_json":"{}", "scope_attrs_json":"{}",
    },
...
METRIC_HIST_SCHEMA = EventSchema(
    ...
    defaults={
        ...
        "bounds_json":"[]","counts_json":"[]","exp_zero_count":0,"exp_scale":0,
        "exp_positive_json":"{}","exp_negative_json":"{}","quantiles_json":"[]",
        "point_attrs_json":"{}", "exemplars_json":"[]",
        "service_name": "unknown",
        "service_namespace":"", "service_instance_id":"", "service_version":"", "deployment_env":"",
        "scope_name":"", "scope_version":"", "resource_attrs_json":"{}", "scope_attrs_json":"{}",
    },
    ...
    json_fields={"resource_attrs_json","scope_attrs_json","bounds_json","counts_json",
