...
class CollectionService:
    ...
    def create_collection(self, name: str, dimension: int = 1024, description: Optional[str] = None) -> Collection:
        ...
        try:
            ...
            logger.info(f"Created collection record: {name} (ID: {collection.id}, dim: {dimension})")
    ...
    def rename_collection(self, old_name: str, new_name: str) -> Optional[Collection]:
        ...
        try:
            ...
            logger.info(f"Successfully renamed collection from '{old_name}' to '{new_name}' (ID: {collection.id})")
            return collection
