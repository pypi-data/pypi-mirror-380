...
def test_polygonize(api, mock_raster_data, mock_success_task_data):
    ...
    task = raster.polygonize(
        output_layer_name='test'
    )
    assert type(task) == Task


def test_clip(api, mock_raster_data, mock_success_task_data, mock_vector_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
...
def test_slope(api, mock_raster_data, mock_success_task_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
...
def test_aspect(api, mock_raster_data, mock_success_task_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
...
def test_reclassify(api, mock_raster_data, mock_success_task_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
...
def test_resample(api, mock_raster_data, mock_success_task_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
...
def test_fill_nodata(api, mock_raster_data, mock_success_task_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
    ...
    task = raster.fill_nodata(
        output_raster_name='test'
    )
    assert type(task) == Task


def test_proximity(api, mock_raster_data, mock_success_task_data):
    task = Task(api, uuid=mock_success_task_data['uuid'], data=mock_success_task_data)
    api.get_task.return_value = task
    api.post.return_value = {
        'task_id': mock_success_task_data['uuid']
