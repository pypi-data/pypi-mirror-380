...
from geobox.analysis import Analysis
...
def test_idw_interpolation(api, mock_success_task_data, mock_vector_data, mock_field_data):
    ...
    task = Analysis.idw_interpolation(
        api=api,
        layer=vector,
        output_raster_name='test',
        z_field=field
