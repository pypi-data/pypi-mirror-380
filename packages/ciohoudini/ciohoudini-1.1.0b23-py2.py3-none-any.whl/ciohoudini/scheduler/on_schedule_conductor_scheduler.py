...
class PDGConductorScheduler:
    ...
    def prepare_batch_job(self, work_item_chain, topnet_path, wrapper_script_source):
        ...
        if use_multiple_machines:
            ...
            task_command = f'hython "{script_path}" --hip_file {hip_file_path} --topnet_path {topnet_path} --use_single_machine --working_dir {working_dir_path} --output_dir render_dir'
