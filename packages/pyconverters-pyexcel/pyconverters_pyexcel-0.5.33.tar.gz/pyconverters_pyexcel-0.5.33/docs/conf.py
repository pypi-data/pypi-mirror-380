...
import pyconverters_pyexcel


# -- Project information -----------------------------------------------------

project = "pyconverters_pyexcel"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_pyexcel.__version__
release = pyconverters_pyexcel.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_pyexcel.__file__)
