...
class GeoJSONMappingGenerator():
    ...
    def parse(self):
        ...
        featuresMap.add_predicate_object_map_with_template("hasGeometry",self.resource_uri+"_Geometry_{{{}}}".format(self.generated_id),"ogc")

        geometriesMap = toposkg_lib_triples_map.TriplesMap("http://www.opengis.net/ont/geosparql#",self.resource_uri+"_Geometry","GeometryMap")
