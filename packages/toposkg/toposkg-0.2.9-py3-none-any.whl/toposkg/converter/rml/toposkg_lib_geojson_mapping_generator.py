...
class GeoJSONMappingGenerator():
    ...
    def parse(self):
        ...
        featuresMap.add_predicate_object_map_with_template("hasGeometry",self.resource_uri+"Geometry_{}_{{{}}}".format(self.fast_hash8("GeometryMap"+self.file_hash),self.generated_id),"ogc")
