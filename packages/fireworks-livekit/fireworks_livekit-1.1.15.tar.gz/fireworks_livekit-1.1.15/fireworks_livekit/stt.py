    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            max_retries: Maximum number of transcription retry attempts. Defaults to 1.
    ...
    def update_options(
        ...
        *,
        ...
        if is_given(max_retries):
            if not 1 <= max_retries <= 10:
                raise ValueError("max_retries must be between 1 and 10")
            self._opts.max_retries = max_retries
...
class SpeechStream(stt.SpeechStream):
    ...
    async def _connect_ws(self) -> aiohttp.ClientWebSocketResponse:
        live_config = {
            ...
            "vad_kwargs": (json.dumps(self._opts.vad_kwargs) if is_given(self._opts.vad_kwargs) else None),
