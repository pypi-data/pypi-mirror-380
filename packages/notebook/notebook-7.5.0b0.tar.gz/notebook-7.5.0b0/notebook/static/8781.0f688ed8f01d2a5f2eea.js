...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14286);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(31273),
    __webpack_require__(44266),
    __webpack_require__(77682),
    __webpack_require__(81461),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(53305),
  __webpack_require__(53479),
  __webpack_require__(42009),
  __webpack_require__(24275),
  __webpack_require__(64090),
  __webpack_require__(57760),
  __webpack_require__(80194),
  
      (__webpack_require__(81322)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(18126)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(20539),
  __webpack_require__(65895),
  
      (__webpack_require__(46547)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(30267)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(97269),
  
      (__webpack_require__(46513)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(9743)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(27001)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(71475)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(91541)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(21152),
  __webpack_require__(24891),
  __webpack_require__(67465),
  __webpack_require__(75853),
  
      (__webpack_require__(23997)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(84861),
  __webpack_require__(33430),
  __webpack_require__(68027),
  
      (__webpack_require__(81542)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(85464),
  __webpack_require__(20140),
  __webpack_require__(706),
  __webpack_require__(25952),
  __webpack_require__(13910),
  __webpack_require__(17229),
  __webpack_require__(57469),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(97102)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(99332),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(17657),
  __webpack_require__(67208),
  
      (__webpack_require__(59388)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(6466)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(89357)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(9829).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(37635).IServiceManager);
...
//# sourceMappingURL=8781.0f688ed8f01d2a5f2eea.js.map?v=0f688ed8f01d2a5f2eea