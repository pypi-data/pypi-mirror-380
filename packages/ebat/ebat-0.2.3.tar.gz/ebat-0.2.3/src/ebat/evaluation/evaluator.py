...
from src.ebat.evaluation.metrics.gini_coefficient import gini_coefficient
from src.ebat.evaluation.metrics.biometric_information import (
...
class ResultsBase:
    ...
    def save_results(self):
        ...
        file_name = (
            f"{datetime.now().strftime('%Y-%m-%dT%H%M%S-%f')}_{self.approach_name}.json"
        )
