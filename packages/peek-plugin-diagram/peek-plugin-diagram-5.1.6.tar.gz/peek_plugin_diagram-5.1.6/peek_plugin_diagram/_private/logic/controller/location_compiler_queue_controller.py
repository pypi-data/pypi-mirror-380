...
class _Notifier(ACIProcessorStatusNotifierABC):
    ...
    def setProcessorStatus(self, state: bool, queueSize: int):
        ...
        self._adminStatusController.status.locationIndexCompilerQueueLastUpdateDate = datetime.now(
            timezone.utc
        )
    ...
    def setProcessorTableTotal(self, total: int):
        ...
        self._adminStatusController.status.locationIndexCompilerQueueTableTotal = (
            total
        )
        self._adminStatusController.status.locationIndexCompilerQueueLastTableTotalUpdate = datetime.now(
            timezone.utc
        )
        self._adminStatusController.notify()
