...
class _Notifier(ACIProcessorStatusNotifierABC):
    ...
    def setProcessorStatus(self, state: bool, queueSize: int):
        ...
        self._adminStatusController.status.branchIndexCompilerQueueLastUpdateDate = datetime.now(
            timezone.utc
        )
    ...
    def setProcessorTableTotal(self, total: int):
        ...
        self._adminStatusController.status.branchIndexCompilerQueueTableTotal = (
            total
        )
        self._adminStatusController.status.branchIndexCompilerQueueLastTableTotalUpdate = datetime.now(
            timezone.utc
        )
        self._adminStatusController.notify()
