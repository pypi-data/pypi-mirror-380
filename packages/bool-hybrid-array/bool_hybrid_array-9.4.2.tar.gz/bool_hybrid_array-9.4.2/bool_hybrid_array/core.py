...
class BoolHybridArray(MutableSequence,Exception):
    ...
    def get_shape(self):
        return (self.size,)
class BoolHybridArr(BoolHybridArray):
    __module__ = 'bool_hybrid_array'
...
class ReadOnlyAttribute:
    ...
    def __set__(self, instance, value):
        raise AttributeError("无法修改只读内置常量")
    def __delete__(self, instance):
        raise AttributeError("无法删除只读内置常量")
builtins.__setattr__ = protected_builtins_setattr
builtins.__delattr__ = protected_builtins_delattr
builtins.np = np
builtins.T = ReadOnlyAttribute(BHA_bool(1))
builtins.F = ReadOnlyAttribute(BHA_bool(0))
builtins.BHA_Bool = ReadOnlyAttribute(BHA_Bool)
builtins.BHA_List = ReadOnlyAttribute(BHA_List)
builtins.FalsesArray = ReadOnlyAttribute(FalsesArray)
builtins.TruesArray = ReadOnlyAttribute(TruesArray)
builtins.BoolHybridArr = ReadOnlyAttribute(BoolHybridArr)
builtins.BoolHybridArray = ReadOnlyAttribute(BoolHybridArray)
