...
############################
    ...
    print(f"\nChaleur totale récupérée par le réseau d'échangeurs (y compris hors mCp) : {self.total_heat_recovered} kW")
    self.percent_recovered = 100 * self.total_heat_recovered/self.heat_recovery
    print(f"Pourcentage de chaleur récupérée par le réseau d'échangeurs (y compris hors mCp) : {self.percent_recovered:.2f} %\n")
