...
class RESTClient:
    ...
    def cancel_all_orders(
        self, subaccount_id: str, product_ids: Optional[List[str]] = None, **kwargs
    ...
    def get(
        self, url_path: Any, params: Union[dict, None] = None, **kwargs
    ) -> Dict[str, Any]: ...
    ...
    def withdraw_token(
        self, dto: InitiateWithdrawDto, token_id: str, **kwargs
    ) -> WithdrawDto: ...
    def _get_pages(
        self,
        endpoint: str,
