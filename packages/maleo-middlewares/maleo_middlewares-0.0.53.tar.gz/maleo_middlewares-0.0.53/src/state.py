...
from maleo.schemas.operation.action.resource import Factory as ResourceOperationActionFactory
...
class StateMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        try:
            ...
            # Operation ID
            operation_id = extract_operation_id(IdSource.HEADER, conn=conn, generate=True)
            ...
            print("Unexpected error while assigning connection state:\n", traceback.format_exc())
