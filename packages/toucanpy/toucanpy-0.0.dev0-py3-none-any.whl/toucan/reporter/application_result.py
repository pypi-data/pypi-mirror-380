...
class ApplicationResult:
    ...
    def has_complete_support(self) -> Union[bool, None]:
        """
    ...
    def all_files_recognized(self) -> Union[bool, None]:
        """
    ...
    def all_parsing_rules_pass(self) -> Union[bool, None]:
        """
    ...
    def new_old_version(cls, app_name: str, new_version: str):
        """
        Method to create an ApplicationResult when the run has a new version but is a lower version than the previous version.
        """
