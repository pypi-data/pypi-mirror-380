...
from toucan.utils.apk_utils import get_apk_version, get_apk_package_name, get_apk_app_name
...
def start_emulators(config: ToucanConfig, interactive: bool = False, snapshot: str = None) -> Tuple[ToucanAndroidDevice, ToucanAndroidDevice]:
    """
...
def get_file_from_emulator(emulator: ToucanAndroidDevice,
                           toucan_file: ToucanFile,
