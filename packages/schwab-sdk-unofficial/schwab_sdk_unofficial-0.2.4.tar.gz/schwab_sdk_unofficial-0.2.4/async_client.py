...
class AsyncClient:
    ...
    def __init__(
        ...
        Args:
            ...
            token_path: Path al archivo de tokens o ":memory:" para modo en memoria
        """
        ...
        self.token_handler = TokenHandler(client_id, client_secret, redirect_uri, token_path)
    ...
    async def login(self):
        """Perform OAuth login (async wrapper)."""
