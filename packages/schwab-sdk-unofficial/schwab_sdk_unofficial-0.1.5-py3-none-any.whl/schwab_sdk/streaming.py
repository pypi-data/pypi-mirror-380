...
class Streaming:
    ...
    def create_option_symbol(symbol: str, expiration: str, option_type: str, strike_price: float) -> str:
        ...
        Returns:
            Formatted option symbol for Schwab streaming (e.g., "AAPL  251003C00257500")
            
        Example:
            >>> ws.create_option_symbol("AAPL", "2025-10-03", "C", 257.5)
            "AAPL  251003C00257500"
        """
        ...
        # Format strike price to 8 digits (multiply by 1000 and pad with zeros)
        strike_price_str = f"{int(strike_price * 1000):08d}"
        
        # Combine all components
        return f"{symbol}  {exp_formatted}{option_type}{strike_price_str}"
