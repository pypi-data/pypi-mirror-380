...
class Accounts:
    ...
    def get_account_by_id(self, account_number: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        Args:
            account_number: Número de cuenta o accountHash
            
        Returns:
            Respuesta JSON con información de la cuenta específica
        """
        endpoint = f"{self.base_url}/accounts/{account_number}"
        response = self.client._request("GET", endpoint, params=params or {}, timeout=10)
        response.raise_for_status()
        return response.json()
    ...
    def get_transactions(self, account_number: str, from_date: str = None, to_date: str = None, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        """
        endpoint = f"{self.base_url}/accounts/{account_number}/transactions"
    ...
    def get_transaction(self, account_number: str, transaction_id: str) -> Dict[str, Any]:
        """
        ...
        """
        endpoint = f"{self.base_url}/accounts/{account_number}/transactions/{transaction_id}"
        response = self.client._request("GET", endpoint, timeout=10)
        response.raise_for_status()
        return response.json()
