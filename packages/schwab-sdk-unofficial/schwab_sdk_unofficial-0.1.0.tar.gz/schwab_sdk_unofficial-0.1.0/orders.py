...
class Orders:
    ...
    def replace_order(self, account_number: str, order_id: str, new_order_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def preview_order(self, account_number: str, order_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        """
        endpoint = f"{self.base_url}/accounts/{account_number}/previewOrder"
        headers = {"Content-Type": "application/json"}
        try:
            response = self.client._request("POST", endpoint, json=order_data, headers=headers, timeout=15)
