...
class TokenHandler:
    ...
    def __init__(self, client_id: str, client_secret: str, redirect_uri: str, token_path: Optional[str] = None, token_data: Optional[Dict[str, Any]] = None):
        """
