...
##################### 9abcb3bb3c5efcf078b7e0de7c92000e ##############################
...
class calibrater:
    ...
    def smooth(self, tablein, tableout, field=[ ], smoothtype='median', smoothtime=float(60.0), ratesmooth=False):
        ...
        """
        return self._swigobj.smooth(tablein, tableout, field, smoothtype, smoothtime, ratesmooth)
