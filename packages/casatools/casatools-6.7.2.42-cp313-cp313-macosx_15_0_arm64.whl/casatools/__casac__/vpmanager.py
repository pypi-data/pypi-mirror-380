...
class vpmanager(object):
    ...
    def setcannedpb(self, *args, **kwargs):
        r"""
        setcannedpb(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _commonpb=string("DEFAULT"), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def setpbairy(self, *args, **kwargs):
        r"""
        setpbairy(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _dishdiam=casac::variant( ), _blockagediam=casac::variant( ), _maxrad=casac::variant( ), _reffreq=casac::variant( ), _squintdir=casac::variant( ), _squintreffreq=casac::variant( ), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def setpbcospoly(self, *args, **kwargs):
        r"""
        setpbcospoly(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _coeff=std::vector< double >({-1}), _scale=std::vector< double >({-1}), _maxrad=casac::variant( ), _reffreq=casac::variant( ), _isthispb=string("PB"), _squintdir=casac::variant( ), _squintreffreq=casac::variant( ), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def setpbgauss(self, *args, **kwargs):
        r"""
        setpbgauss(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _halfwidth=casac::variant( ), _maxrad=casac::variant( ), _reffreq=casac::variant( ), _isthispb=string("PB"), _squintdir=casac::variant( ), _squintreffreq=casac::variant( ), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def setpbinvpoly(self, *args, **kwargs):
        r"""
        setpbinvpoly(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _coeff=std::vector< double >({-1}), _maxrad=casac::variant( ), _reffreq=casac::variant( ), _isthispb=string("PB"), _squintdir=casac::variant( ), _squintreffreq=casac::variant( ), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def setpbnumeric(self, *args, **kwargs):
        r"""
        setpbnumeric(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _vect=std::vector< double >({-1}), _maxrad=casac::variant( ), _reffreq=casac::variant( ), _isthispb=string("PB"), _squintdir=casac::variant( ), _squintreffreq=casac::variant( ), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def setpbpoly(self, *args, **kwargs):
        r"""
        setpbpoly(self, _telescope=string("VLA"), _othertelescope=string(""), _dopb=bool(true), _coeff=std::vector< double >({-1}), _maxrad=casac::variant( ), _reffreq=casac::variant( ), _isthispb=string("PB"), _squintdir=casac::variant( ), _squintreffreq=casac::variant( ), _dosquint=bool(false), _paincrement=casac::variant( ), _usesymmetricbeam=bool(false)) -> record *
    ...
    def getanttypes(self, *args, **kwargs):
        r"""
        getanttypes(self, _telescope=string(""), _obstime=casac::variant( ), _freq=casac::variant( ), _obsdirection=casac::variant( )) -> std::vector< std::string >
    ...
    def numvps(self, *args, **kwargs):
        r"""
        numvps(self, _telescope=string(""), _obstime=casac::variant( ), _freq=casac::variant( ), _obsdirection=casac::variant( )) -> long
    ...
    def getvp(self, *args, **kwargs):
        r"""
        getvp(self, _telescope=string(""), _antennatype=string(""), _obstime=casac::variant( ), _freq=casac::variant( ), _obsdirection=casac::variant( )) -> record *
    ...
    def getvps(self, *args, **kwargs):
        r"""
        getvps(self, _telescope=string(""), _antennas=std::vector< std::string >({}), _obstimestart=casac::variant( ), _obstimeend=casac::variant( ), _minfreq=casac::variant( ), _maxfreq=casac::variant( ), _obsdirection=casac::variant( )) -> record *
