...
class componentlist(object):
    ...
    def concatenate(self, *args, **kwargs):
        r"""
        concatenate(self, _list=casac::variant( ), _which=std::vector< long >({-1}), _log=bool(true)) -> bool
    ...
    def putkeyword(self, *args, **kwargs):
        r"""
        putkeyword(self, _keyword=string("metadata"), _value=casac::variant( ))
    ...
    def getkeyword(self, *args, **kwargs):
        r"""
        getkeyword(self, _keyword=string("metadata")) -> casac::variant *
    ...
    def sample(self, *args, **kwargs):
        r"""
        sample(self, _direction=casac::variant( ), _pixellatsize=casac::variant( ), _pixellongsize=casac::variant( ), _frequency=casac::variant( )) -> std::vector< double >
    ...
    def addcomponent(self, *args, **kwargs):
        r"""
        addcomponent(self, _flux=casac::variant( ), _fluxunit=string("Jy"), _polarization=string("Stokes"), _dir=casac::variant( ), _shape=string("point"), _majoraxis=casac::variant( ), _minoraxis=casac::variant( ), _positionangle=casac::variant( ), _freq=casac::variant( ), _spectrumtype=string("constant"), _index=casac::variant( ), _optionalparms=std::vector< double >({0.0}), _label=string("")) -> bool
    ...
    def setflux(self, *args, **kwargs):
        r"""
        setflux(self, _which=long(0L), _value=casac::variant( ), _unit=string("Jy"), _polarization=string("Stokes"), _error=casac::variant( ), _log=bool(true)) -> bool
    ...
    def setrefdir(self, *args, **kwargs):
        r"""
        setrefdir(self, _which=long(1), _ra=casac::variant( ), _dec=casac::variant( ), _log=bool(true)) -> bool
    ...
    def setshape(self, *args, **kwargs):
        r"""
        setshape(self, _which=long(0L), _type=string("Point"), _majoraxis=casac::variant( ), _minoraxis=casac::variant( ), _positionangle=casac::variant( ), _majoraxiserror=casac::variant( ), _minoraxiserror=casac::variant( ), _positionangleerror=casac::variant( ), _optionalparms=std::vector< double >({0.0}), _log=bool(true)) -> bool
    ...
    def setstokesspectrum(self, *args, **kwargs):
        r"""
        setstokesspectrum(self, _which=long(0L), _type=string("spectral index"), _index=std::vector< double >({0.0}), _tabularfreqs=std::vector< double >({1.0e11}), _tabulari=std::vector< double >({1.0}), _tabularq=std::vector< double >({0.0}), _tabularu=std::vector< double >({0.0}), _tabularv=std::vector< double >({0.0}), _reffreq=casac::variant( ), _frame=string("LSRK")) -> bool
    ...
    def setspectrum(self, *args, **kwargs):
        r"""
        setspectrum(self, _which=long(0L), _type=string("spectral index"), _index=casac::variant( ), _tabularfreqs=std::vector< double >({1.0e11}), _tabularflux=std::vector< double >({1.0}), _tabularframe=string("LSRK")) -> bool
    ...
    def iscomponentlist(self, *args, **kwargs):
        r"""
        iscomponentlist(self, _tool=casac::variant( )) -> bool
