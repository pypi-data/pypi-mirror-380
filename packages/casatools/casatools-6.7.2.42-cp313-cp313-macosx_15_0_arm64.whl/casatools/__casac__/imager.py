...
class imager(object):
    ...
    def advise(self, *args, **kwargs):
        r"""
        advise(self, _takeadvice=bool(true), _amplitudeloss=double(0.05), _fieldofview=casac::variant( ), _pixels=_pixels_advise, _cell=_cell_advise, _facets=_facets_advise, _phasecenter=_phasecenter_advise) -> bool
    ...
    def clean(self, *args, **kwargs):
        r"""
        clean(self, _algorithm=string("clark"), _niter=long(1000), _gain=double(0.1), _threshold=casac::variant( ), _displayprogress=bool(false), _model=std::vector< std::string >({}), _keepfixed=std::vector< bool >({false}), _complist=string(""), _mask=std::vector< std::string >({}), _image=std::vector< std::string >({}), _residual=std::vector< std::string >({}), _psfimage=std::vector< std::string >({}), _interactive=bool(false), _npercycle=long(100), _masktemplate=string("")) -> record *
    ...
    def clipimage(self, *args, **kwargs):
        r"""
        clipimage(self, _image=string(""), _threshold=casac::variant( )) -> bool
    ...
    def clipvis(self, *args, **kwargs):
        r"""
        clipvis(self, _threshold=casac::variant( )) -> bool
    ...
    def defineimage(self, *args, **kwargs):
        r"""
        defineimage(self, _nx=long(128), _ny=long(-1), _cellx=casac::variant( ), _celly=casac::variant( ), _stokes=string("I"), _phasecenter=casac::variant( ), _mode=string("mfs"), _nchan=long(-1), _start=casac::variant( ), _step=casac::variant( ), _spw=std::vector< long >({0}), _restfreq=casac::variant( ), _outframe=string("LSRK"), _veltype=string("radio"), _facets=long(1), _movingsource=casac::variant( ), _distance=casac::variant( ), _projection=string("SIN")) -> bool
    ...
    def filter(self, *args, **kwargs):
        r"""
        filter(self, _type=string("gaussian"), _bmaj=casac::variant( ), _bmin=casac::variant( ), _bpa=casac::variant( )) -> bool
    ...
    def getweightgrid(self, *args, **kwargs):
        r"""
        getweightgrid(self, _type=string("imaging"), _wgtimages=std::vector< std::string >({})) -> casac::variant *
    ...
    def predictcomp(self, *args, **kwargs):
        r"""
        predictcomp(self, _objname=string(""), _standard=string(""), _epoch=casac::variant( ), _freqs=std::vector< double >({1.0e11}), _pfx=string("predictcomp")) -> string
    ...
    def mask(self, *args, **kwargs):
        r"""
        mask(self, _image=string(""), _mask=string(""), _threshold=casac::variant( )) -> bool
    ...
    def mem(self, *args, **kwargs):
        r"""
        mem(self, _algorithm=string("entropy"), _niter=long(20), _sigma=casac::variant( ), _targetflux=casac::variant( ), _constrainflux=bool(false), _displayprogress=bool(false), _model=std::vector< std::string >({}), _keepfixed=std::vector< bool >({false}), _complist=string(""), _prior=std::vector< std::string >({}), _mask=std::vector< std::string >({}), _image=std::vector< std::string >({}), _residual=std::vector< std::string >({})) -> bool
    ...
    def pb(self, *args, **kwargs):
        r"""
        pb(self, _inimage=string(""), _outimage=string(""), _incomps=string(""), _outcomps=string(""), _operation=string("apply"), _pointingcenter=casac::variant( ), _parangle=casac::variant( ), _pborvp=string("pb")) -> bool
    ...
    def regionmask(self, *args, **kwargs):
        r"""
        regionmask(self, _mask=string(""), _region=initialize_record(""), _boxes=casac::variant( ), _circles=casac::variant( ), _value=double(1.0)) -> bool
    ...
    def regiontoimagemask(self, *args, **kwargs):
        r"""
        regiontoimagemask(self, _mask=string(""), _region=initialize_record(""), _boxes=casac::variant( ), _circles=casac::variant( ), _value=double(1.0)) -> bool
    ...
    def setbeam(self, *args, **kwargs):
        r"""
        setbeam(self, _bmaj=casac::variant( ), _bmin=casac::variant( ), _bpa=casac::variant( )) -> bool
    ...
    def selectvis(self, *args, **kwargs):
        r"""
        selectvis(self, _vis=string(""), _nchan=std::vector< long >({-1}), _start=std::vector< long >({0}), _step=std::vector< long >({1}), _spw=casac::variant( ), _field=casac::variant( ), _baseline=casac::variant( ), _time=casac::variant( ), _scan=casac::variant( ), _intent=string(""), _observation=casac::variant( ), _uvrange=casac::variant( ), _taql=string(""), _usescratch=bool(false), _datainmemory=bool(false), _writeaccess=bool(true)) -> bool
    ...
    def setjy(self, *args, **kwargs):
        r"""
        setjy(self, _field=casac::variant( ), _spw=casac::variant( ), _modimage=string(""), _fluxdensity=std::vector< double >({0.0,0.0,0.0,0.0}), _standard=string("SOURCE"), _scalebychan=bool(false), _spix=std::vector< double >({0.0}), _reffreq=casac::variant( ), _polindex=std::vector< double >({0.0}), _polangle=std::vector< double >({0.0}), _rotmeas=double(0.0), _time=string(""), _scan=string(""), _intent=string(""), _observation=string(""), _interpolation=string("nearest")) -> record *
    ...
    def setsdoptions(self, *args, **kwargs):
        r"""
        setsdoptions(self, _scale=double(1.0), _weight=double(1.0), _convsupport=long(-1), _pointingcolumntouse=string("DIRECTION"), _truncate=casac::variant( ), _gwidth=casac::variant( ), _jwidth=casac::variant( ), _minweight=double(0.), _clipminmax=bool(false), _enablecache=bool(false), _convertfirst=string("NEVER")) -> bool
    ...
    def setvp(self, *args, **kwargs):
        r"""
        setvp(self, _dovp=bool(false), _usedefaultvp=bool(true), _vptable=string(""), _dosquint=bool(false), _parangleinc=casac::variant( ), _skyposthreshold=casac::variant( ), _telescope=string(""), _verbose=bool(true)) -> bool
    ...
    def setweightgrid(self, *args, **kwargs):
        r"""
        setweightgrid(self, _weight=casac::variant( ), _type=string("imaging")) -> bool
    ...
    def smooth(self, *args, **kwargs):
        r"""
        smooth(self, _model=std::vector< std::string >({}), _image=std::vector< std::string >({}), _usefit=bool(true), _bmaj=casac::variant( ), _bmin=casac::variant( ), _bpa=casac::variant( ), _normalize=bool(true)) -> bool
    ...
    def weight(self, *args, **kwargs):
        r"""
        weight(self, _type=string("natural"), _rmode=string("none"), _noise=casac::variant( ), _robust=double(0.0), _fieldofview=casac::variant( ), _npixels=long(0), _mosaic=bool(false)) -> bool
