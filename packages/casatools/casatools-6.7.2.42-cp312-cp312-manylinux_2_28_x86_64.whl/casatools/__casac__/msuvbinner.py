...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_msuvbinner')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_msuvbinner')
    _msuvbinner = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_msuvbinner', [dirname(__file__)])
        except ImportError:
            import _msuvbinner
            return _msuvbinner
        try:
            _mod = imp.load_module('_msuvbinner', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class msuvbinner(_object):
    """Proxy of C++ casac::msuvbinner class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, msuvbinner, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, msuvbinner, name)
    __repr__ = _swig_repr

    def __init__(self, *args, **kwargs):
        """__init__(self, _phasecenter, _nx, _ny, _ncorr, _nchan, _cellx, _celly, _fstart, _fstep, _memfrac, _wproject, _doflag) -> msuvbinner"""
        this = _msuvbinner.new_msuvbinner(*args, **kwargs)
        try:
...
msuvbinner_swigregister = _msuvbinner.msuvbinner_swigregister
msuvbinner_swigregister(msuvbinner)
