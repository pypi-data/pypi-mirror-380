...
class calibrater(object):
    ...
    def selectvis(self, *args, **kwargs):
        r"""
        selectvis(self, _time=casac::variant( ), _spw=casac::variant( ), _scan=casac::variant( ), _field=casac::variant( ), _intent=casac::variant( ), _observation=casac::variant( ), _baseline=casac::variant( ), _uvrange=casac::variant( ), _chanmode=string("none"), _nchan=long(1), _start=long(0), _step=long(1), _mstart=Quantity(std::vector<double>(1,0.0),"km/s"), _mstep=Quantity(std::vector<double>(1,0.0),"km/s"), _msselect=string("")) -> bool
    ...
    def setapply(self, *args, **kwargs):
        r"""
        setapply(self, _type=string(""), _t=double(0.0), _table=string(""), _field=casac::variant( ), _interp=string("linear"), _select=string(""), _calwt=bool(false), _spwmap=std::vector< long >({-1}), _opacity=std::vector< double >({0.0})) -> bool
    ...
    def setsolvegainspline(self, *args, **kwargs):
        r"""
        setsolvegainspline(self, _table=string(""), _append=bool(false), _mode=string("PHAS"), _splinetime=double(10800), _preavg=double(0.0), _npointaver=long(10), _phasewrap=double(250), _refant=casac::variant( )) -> bool
    ...
    def setsolvebandpoly(self, *args, **kwargs):
        r"""
        setsolvebandpoly(self, _table=string(""), _append=bool(false), _t=casac::variant( ), _combine=string(""), _degamp=long(3), _degphase=long(3), _visnorm=bool(false), _solnorm=bool(true), _maskcenter=long(0), _maskedge=double(5.0), _refant=casac::variant( )) -> bool
    ...
    def delmod(self, *args, **kwargs):
        r"""
        delmod(self, _otf=bool(false), _field=casac::variant( ), _spw=casac::variant( ), _scr=bool(false)) -> bool
    ...
    def fluxscale(self, *args, **kwargs):
        r"""
        fluxscale(self, _tablein=string(""), _reference=casac::variant( ), _tableout=string(""), _transfer=casac::variant( ), _listfile=string(""), _append=bool(false), _refspwmap=std::vector< long >({-1}), _gainthreshold=float(-1.0), _antenna=string(""), _timerange=string(""), _scan=string(""), _incremental=bool(false), _fitorder=long(1), _display=bool(false)) -> record *
    ...
    def accumulate(self, *args, **kwargs):
        r"""
        accumulate(self, _tablein=string(""), _incrtable=string(""), _tableout=string(""), _field=casac::variant( ), _calfield=casac::variant( ), _interp=string("linear"), _t=double(-1.0), _spwmap=std::vector< long >({-1})) -> bool
    ...
    def smooth(self, *args, **kwargs):
        r"""
        smooth(self, _tablein=string(""), _tableout=string(""), _field=casac::variant( ), _smoothtype=string("median"), _smoothtime=double(60.0), _ratesmooth=bool(false)) -> bool
    ...
    def rerefant(self, *args, **kwargs):
        r"""
        rerefant(self, _tablein=string(""), _tableout=string(""), _refantmode=string("flexible"), _refant=casac::variant( )) -> bool
    ...
    def listcal(self, *args, **kwargs):
        r"""
        listcal(self, _caltable=string(""), _field=casac::variant( ), _antenna=casac::variant( ), _spw=casac::variant( ), _listfile=string(""), _pagerows=long(50)) -> bool
