...
class simulator(object):
    ...
    def settimes(self, *args, **kwargs):
        r"""
        settimes(self, _integrationtime=casac::variant( ), _usehourangle=bool(true), _referencetime=casac::variant( )) -> bool
    ...
    def observe(self, *args, **kwargs):
        r"""
        observe(self, _sourcename=string(""), _spwname=string(""), _starttime=casac::variant( ), _stoptime=casac::variant( ), _add_observation=bool(false), _state_sig=bool(true), _state_ref=bool(false), _state_cal=double(0.0), _state_load=double(0.0), _state_sub_scan=long(0), _state_obs_mode=string("OBSERVE_TARGET.ON_SOURCE"), _observer=string("CASA simulator"), _project=string("CASA simulation")) -> bool
    ...
    def setlimits(self, *args, **kwargs):
        r"""
        setlimits(self, _shadowlimit=double(1e-6), _elevationlimit=casac::variant( )) -> bool
    ...
    def setconfig(self, *args, **kwargs):
        r"""
        setconfig(self, _telescopename=string("VLA"), _x=std::vector< double >({0}), _y=std::vector< double >({0}), _z=std::vector< double >({0}), _dishdiameter=std::vector< double >({0}), _offset=std::vector< double >({0}), _mount=std::vector< std::string >({"ALT-AZ"}), _antname=std::vector< std::string >({"A"}), _padname=std::vector< std::string >({"P"}), _coordsystem=string("global"), _referencelocation=casac::variant( )) -> bool
    ...
    def setfield(self, *args, **kwargs):
        r"""
        setfield(self, _sourcename=string("SOURCE"), _sourcedirection=casac::variant( ), _calcode=string(""), _distance=casac::variant( )) -> bool
    ...
    def setmosaicfield(self, *args, **kwargs):
        r"""
        setmosaicfield(self, _sourcename=string("SOURCE"), _calcode=string(""), _fieldcenter=casac::variant( ), _xmosp=long(1), _ymosp=long(1), _mosspacing=casac::variant( ), _distance=casac::variant( )) -> bool
    ...
    def setspwindow(self, *args, **kwargs):
        r"""
        setspwindow(self, _spwname=string("XBAND"), _freq=casac::variant( ), _deltafreq=casac::variant( ), _freqresolution=casac::variant( ), _refcode=string("TOPO"), _nchannels=long(1), _stokes=string("RR LL")) -> bool
    ...
    def setoptions(self, *args, **kwargs):
        r"""
        setoptions(self, _ftmachine=string("ft"), _cache=long(0), _tile=long(16), _gridfunction=string("SF"), _location=casac::variant( ), _padding=double(1.3), _facets=long(1), _maxdata=double(2000.0), _wprojplanes=long(1)) -> bool
    ...
    def setvp(self, *args, **kwargs):
        r"""
        setvp(self, _dovp=bool(true), _usedefaultvp=bool(true), _vptable=string(""), _dosquint=bool(true), _parangleinc=casac::variant( ), _skyposthreshold=casac::variant( ), _pblimit=double(1.0e-2)) -> bool
    ...
    def setbandpass(self, *args, **kwargs):
        r"""
        setbandpass(self, _mode=string("calculate"), _table=string(""), _interval=casac::variant( ), _amplitude=std::vector< double >({0.0})) -> bool
    ...
    def setapply(self, *args, **kwargs):
        r"""
        setapply(self, _table=string(""), _type=string(""), _t=double(0.0), _field=casac::variant( ), _interp=string("linear"), _calwt=bool(false), _spwmap=std::vector< long >({-1}), _opacity=double(0.0)) -> bool
    ...
    def setgain(self, *args, **kwargs):
        r"""
        setgain(self, _mode=string("fbm"), _table=string(""), _interval=casac::variant( ), _amplitude=std::vector< double >({0.01})) -> bool
    ...
    def oldsetnoise(self, *args, **kwargs):
        r"""
        oldsetnoise(self, _mode=string("calculate"), _table=string(""), _simplenoise=casac::variant( ), _antefficiency=double(0.8), _correfficiency=double(0.85), _spillefficiency=double(0.85), _tau=double(0.1), _trx=double(50), _tatmos=double(230.0), _tcmb=double(2.7)) -> bool
    ...
    def setnoise(self, *args, **kwargs):
        r"""
        setnoise(self, _mode=string("simplenoise"), _table=string(""), _simplenoise=casac::variant( ), _pground=casac::variant( ), _relhum=double(20.0), _altitude=casac::variant( ), _waterheight=casac::variant( ), _pwv=casac::variant( ), _tatmos=double(250.0), _tau=double(0.1), _antefficiency=double(0.8), _spillefficiency=double(0.85), _correfficiency=double(0.88), _trx=double(50), _tground=double(270.0), _tcmb=double(2.73), _OTF=bool(true), _senscoeff=double(0.), _rxtype=long(0)) -> bool
    ...
    def setpa(self, *args, **kwargs):
        r"""
        setpa(self, _mode=string("calculate"), _table=string(""), _interval=casac::variant( )) -> bool
