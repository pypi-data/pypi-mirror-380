...
def format_confidence_report(results: dict) -> str:
    ...
    report.append(f"   High Confidence (≥0.8): {summary.get('high_confidence_count', 0)}")
    report.append(f"   Medium Confidence (0.60-0.8): {summary.get('medium_confidence_count', 0)}")
