...
class TestProjectDevVars:
    ...
    def test_pdv_str(self):
        ...
        warnings.warn(" vvv  the following warning/line can be IGNORED == test warning in unit test")
        assert pdv['a_non_str_type_var'] == 1           # with warning
        warnings.warn("^^^^^ the previous warning/line can be  IGNORED == test warning in unit test")
