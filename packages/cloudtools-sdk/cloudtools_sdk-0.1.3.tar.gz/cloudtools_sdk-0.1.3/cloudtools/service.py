...
class CloudService:
    ...
    def action(self, func: Optional[ActionCallable] = None, *, name: Optional[str] = None, timeout: Optional[Union[int, timedelta]] = None, attempts: Optional[int] = None) -> Callable[[ActionCallable], ActionCallable]:
