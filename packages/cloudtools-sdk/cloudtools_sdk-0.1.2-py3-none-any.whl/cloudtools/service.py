...
class CloudService:
    ...
    def action(self, func: Optional[ActionCallable] = None, *, name: Optional[str] = None, timeout: Optional[Union[int, timedelta]] = None) -> Callable[[ActionCallable], ActionCallable]:
    ...
    def task(self, name: Optional[str] = None, timeout: Optional[Union[int, timedelta]] = None) -> Callable[[TaskCallable], TaskCallable]:
