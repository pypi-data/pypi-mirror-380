...
class CloudService:
    ...
    def action(self, func: Optional[ActionCallable] = None, *, name: Optional[str] = None) -> Callable[[ActionCallable], ActionCallable]:
    ...
    def task(self, name: Optional[str] = None) -> Callable[[TaskCallable], TaskCallable]:
