 ...
 */
extern PyObject *modulecode_edaclass(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"edaclass", modulecode_edaclass, 0, 0, NUITKA_TRANSLATED_FLAG
