class JSONBackend:
    ...
    def __init__(self, fallthrough=True):
        ...
        self.load_backend('yaml', dumps='dump', loads='safe_load', loads_exc='YAMLError')
    ...
    def load_backend(self, name, dumps='dumps', loads='loads', loads_exc=ValueError):
        ...
        if not self._store(self._encoders, name, mod, dumps) or not self._store(self._decoders, name, mod, loads):
            return False
