...
class UsersAPI:  # noqa: D101
    ...
    def _build_nca_invitation_payload(
        self, email: str, roles: List[str], expiry_hours: int, org_name: str, name: str = None
    ) -> dict:
        ...
        payload = {
            "email": email,
            "inviteAs": nca_role,
            "message": f"You have been invited to join {org_name} organization",
    ...
    def nca_invite_user(self, email: str, roles: List[str], team: str = None, expiry_hours: int = 24, name: str = None):
        ...
        payload = self._build_nca_invitation_payload(email, roles, expiry_hours, org_name, name)
