...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "name", "pulp_href", "base_path", "prn", "base_url", "content_guard", "pulp_created", "hidden", "pulp_labels", "pulp_last_updated"]
