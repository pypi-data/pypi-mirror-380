...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "base_path", "pulp_last_updated", "prn", "content_guard", "name", "pulp_created", "pulp_href", "base_url", "hidden", "no_content_change_since"]
