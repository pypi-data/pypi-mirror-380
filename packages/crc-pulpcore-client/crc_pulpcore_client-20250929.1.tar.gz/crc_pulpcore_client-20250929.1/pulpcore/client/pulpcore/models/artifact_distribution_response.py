...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "pulp_last_updated", "base_url", "hidden", "prn", "no_content_change_since", "pulp_labels", "pulp_href", "content_guard", "name", "base_path"]
