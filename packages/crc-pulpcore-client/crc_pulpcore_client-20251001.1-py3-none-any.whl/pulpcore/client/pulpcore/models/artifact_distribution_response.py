...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "prn", "pulp_href", "name", "base_path", "pulp_last_updated", "pulp_created", "base_url", "content_guard", "no_content_change_since", "hidden"]
