...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "base_path", "pulp_href", "hidden", "content_guard", "base_url", "pulp_last_updated", "name", "pulp_labels", "no_content_change_since", "prn"]
