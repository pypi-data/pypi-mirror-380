...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "pulp_href", "pulp_created", "pulp_last_updated", "pulp_labels", "name", "no_content_change_since", "hidden", "prn", "base_url", "content_guard"]
