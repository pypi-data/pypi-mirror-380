...
class AlgorithmApi:
    ...
    @validate_arguments
    def get_algorithm(self, algorithm_id: StrictStr, **kwargs) -> GetAlgorithmResponse:  # noqa: E501
    ...
    def get_algorithm_with_http_info(self, algorithm_id: StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetAlgorithmResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def list_algorithms(self, **kwargs) -> ListAlgorithmsResponse:  # noqa: E501
    ...
    def list_algorithms_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListAlgorithmsResponse, status_code(int), headers(HTTPHeaderDict))
        """
