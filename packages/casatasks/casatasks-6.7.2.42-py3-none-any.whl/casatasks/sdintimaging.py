...
##################### ca888a2f22e7dfabc903d68b3be18731 ##############################
...
class _sdintimaging:
    ...
    usedata              Output image type: 'int' - use interferometric data only; 
                         ...
                         'sdint' - use both single dish and interferometric data (only Stokes I)
    ...
    stokes               Stokes Planes to make
                         ...
                         Options: 'I','Q','U','V','IV','QU','IQ','UV','IQUV','RR','LL','XX','YY','RRLL','XXYY','pseudoI'
                                       ...
                                       Note: for parameter usedata='sdint', presently only stokes='I' is supported.
