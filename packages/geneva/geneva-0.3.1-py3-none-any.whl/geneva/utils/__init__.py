...
RETRY_LANCE_ATTEMPTS = os.environ.get("GENEVA_RETRY_LANCE_ATTEMPTS", 7)
RETRY_LANCE_INITIAL_SECS = os.environ.get("GENEVA_RETRY_LANCE_INITIAL_SECS", 0.5)
RETRY_LANCE_MAX_SECS = os.environ.get("GENEVA_RETRY_LANCE_MAX_SECS", 120.0)


def _should_retry_concurrent_writers_error(exception: Exception) -> bool:
