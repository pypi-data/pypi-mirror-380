import abc
import tree_sitter
from ..document import QTextDocument as QTextDocument, QTextEditChange as QTextEditChange
...
class QSyntaxHighlighter(QObject, metaclass=abc.ABCMeta):
    ...
    def __init__(self, scheme: QCodeScheme, document: QTextDocumentCursor) -> None: ...
    @property
...
class QTreeSitterSyntaxHighlighter(QSyntaxHighlighter, metaclass=abc.ABCMeta):
    ...
    def __init__(self, parser: tree_sitter.Parser, scheme: QCodeScheme, document: QTextDocument) -> None: ...
    @property
