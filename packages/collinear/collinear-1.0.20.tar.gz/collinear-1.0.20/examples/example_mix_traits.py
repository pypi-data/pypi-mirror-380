"""Trait mixing demo (mix_traits=True), kept simple.

Loads `.env`, runs a few simulations with pairwise trait mixing, prints transcripts.
"""
...
def main() -> None:
    ...
    sims = client.simulate(
        steer_config={
            ...
            "traits": {"confusion": ["low"], "impatience": ["medium", "high"], "skeptical": ["medium"]},
