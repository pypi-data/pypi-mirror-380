...
def _get_node_info(azure_api: AzureApiHelper, r_group: ResourceGroup, vm: VirtualMachine) -> NodeInfo | None:
    ...
    assert vm.hardware_profile is not None, "VM hardware profile cannot be None"
    assert vm.hardware_profile.vm_size is not None, "VM size cannot be None"
    ...
    ), "Power state name cannot be None"
