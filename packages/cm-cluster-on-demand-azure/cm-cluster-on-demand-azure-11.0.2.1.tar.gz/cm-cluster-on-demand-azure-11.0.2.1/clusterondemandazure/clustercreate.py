...
class ClusterCreate(ClusterCommand):
    ...
    def generate_bright_conf(self) -> dict[str, Any]:
        kwargs = dict()
        ...
        # TODO: BCM-31705 cod-azure should take advantage of the common cluster-on-demand/clusterondemand/brightsetup.py
        if config["healthchecks_to_disable"]:
            bs["bright"]["healthchecks_to_disable"] = config["healthchecks_to_disable"]
    ...
    def cloud_init_script(self) -> str:
        ...
        bright_conf = ClusterCreate._shell_escape(yaml.dump(self.generate_bright_conf()))
