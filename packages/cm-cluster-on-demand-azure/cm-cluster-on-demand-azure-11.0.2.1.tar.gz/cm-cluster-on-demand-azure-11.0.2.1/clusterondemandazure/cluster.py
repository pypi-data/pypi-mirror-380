...
class Cluster:
        ...
        for cluster_name in cluster_names:
            ...
            try:
                image_name = next(
                    ...
                    if hn.tags
                    and hn.tags.get("BCM Image name")
                )
    ...
    @staticmethod
    def _get_cluster_name_from_tags(resource: VirtualMachine | ResourceGroup) -> str:
    ...
    def _set_primary_secondary_head_nodes(self) -> None:
        ...
        try:
            if len(self.head_nodes) == 1:
                ...
                first_hn_ha_tag = self.head_nodes[0].tags.get("BCM HA", None) if self.head_nodes[0].tags else None
                second_hn_ha_tag = self.head_nodes[1].tags.get("BCM HA", None) if self.head_nodes[1].tags else None
