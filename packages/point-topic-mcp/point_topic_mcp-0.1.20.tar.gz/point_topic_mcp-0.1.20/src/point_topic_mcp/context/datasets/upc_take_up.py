def get_dataset_summary():
    ...
    RPT_POSTCODE_LINES_DISTRIBUTION_RESIDENTIAL table has a row for each postcode, with the total number of residential lines for each ISP and technology.
    RPT_POSTCODE_LINES_DISTRIBUTION_BUSINESS table has a row for each postcode, with the total number of business lines for each ISP and technology.
    RPT_ALL_QUARTERLY_RESULTS_RESIDENTIAL table has a row for each postcode, ISP and technology, with the total number of residential lines for each ISP and technology.
    RPT_ALL_QUARTERLY_RESULTS_BUSINESS table has a row for each postcode, ISP and technology, with the total number of business lines for each ISP and technology.
    """
