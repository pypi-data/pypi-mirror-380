...
def upgrade():
    op.execute(__alterColumnPkBigInt("pl_graphdb", "GraphDbChunkQueue"))
    op.execute(__alterColumnPkBigInt("pl_graphdb", "GraphDbEncodedChunk"))
    op.execute(__alterColumnPkBigInt("pl_graphdb", "GraphDbSegment"))

    op.execute(__alterColumnPkBigInt("pl_graphdb", "ItemKeyIndex"))
    op.execute(__alterColumnPkBigInt("pl_graphdb", "ItemKeyIndexCompilerQueue"))
    op.execute(__alterColumnPkBigInt("pl_graphdb", "ItemKeyIndexEncodedChunk"))
