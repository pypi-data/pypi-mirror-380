...
SEGMENT_COMPILER_ENABLED = PropertyKey(
    "Segment Compiler Enabled", True, propertyDict=globalProperties
)

ITEM_KEY_COMPILER_ENABLED = PropertyKey(
    "Item Key Compiler Enabled", True, propertyDict=globalProperties
)
