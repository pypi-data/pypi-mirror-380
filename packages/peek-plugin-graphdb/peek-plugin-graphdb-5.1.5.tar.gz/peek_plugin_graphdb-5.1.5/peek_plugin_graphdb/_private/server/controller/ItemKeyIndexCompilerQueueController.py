...
class _Notifier(ACIProcessorStatusNotifierABC):
    ...
    def setProcessorStatus(self, state: bool, queueSize: int):
        ...
        self._adminStatusController.status.itemKeyIndexCompilerQueueLastUpdateDate = datetime.now(
            timezone.utc
        )
    ...
    def setProcessorTableTotal(self, total: int):
        ...
        self._adminStatusController.status.itemKeyIndexCompilerQueueTableTotal = (
            total
        )
        self._adminStatusController.status.itemKeyIndexCompilerQueueLastTableTotalUpdate = datetime.now(
            timezone.utc
        )
        self._adminStatusController.notify()
