...
class SurfaceMesh:
    ...
    def add_vertices(self, arg: Annotated[NDArray[numpy.float64], dict(order='C', device='cpu')], /) -> None: ...

    def add_triangle(self, arg0: int, arg1: int, arg2: int, /) -> None: ...

    def add_triangles(self, arg: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...

    def add_quad(self, arg0: int, arg1: int, arg2: int, arg3: int, /) -> None: ...

    def add_quads(self, arg: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...

    def add_polygon(self, arg: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...

    def add_polygons(self, arg: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...

    def add_hybrid(self, arg0: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], arg1: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...

    @overload
    def remove_vertices(self, arg: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...
    ...
    @overload
    def remove_facets(self, arg: Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')], /) -> None: ...
    ...
    def get_position(self, arg: int, /) -> Annotated[NDArray[numpy.float64], dict(order='C', device='cpu')]: ...

    def ref_position(self, arg: int, /) -> Annotated[NDArray[numpy.float64], dict(order='C', device='cpu')]: ...
    ...
    def get_facet_vertices(self, arg: int, /) -> Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')]: ...

    def ref_facet_vertices(self, arg: int, /) -> Annotated[NDArray[numpy.uint32], dict(order='C', device='cpu')]: ...
