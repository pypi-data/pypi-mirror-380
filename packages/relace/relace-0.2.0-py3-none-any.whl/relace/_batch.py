...
from ._client import RelaceAgentSDK
from .types.repo_info import RepoInfo
from .types.file_param import FileParam
from .types.repo_update_contents_params import (
...
class BatchDiffUpdate:
    def __init__(self, client: RelaceAgentSDK, repo_id: str) -> None:
        self.client = client
    ...
    def execute(self, metadata: Optional[Dict[str, str]] = None) -> RepoInfo:
        ...
        return self.client.repo.update_contents(
            self.repo_id,
            source=source,
...
def attach_batch_update() -> None:
    def batch_diff_update(self: "RelaceAgentSDK", repo_id: str) -> BatchDiffUpdate:
        return BatchDiffUpdate(self, repo_id)

    def batch_files_update(self: "RelaceAgentSDK", repo_id: str) -> BatchFilesUpdate:
        return BatchFilesUpdate(self, repo_id)

    def batch_files_create(self: "RelaceAgentSDK") -> BatchFilesCreate:
        return BatchFilesCreate(self)

    RelaceAgentSDK.batch_diff_update = batch_diff_update  # type: ignore[attr-defined]
    RelaceAgentSDK.batch_files_update = batch_files_update  # type: ignore[attr-defined]
    RelaceAgentSDK.batch_files_create = batch_files_create  # type: ignore[attr-defined]
