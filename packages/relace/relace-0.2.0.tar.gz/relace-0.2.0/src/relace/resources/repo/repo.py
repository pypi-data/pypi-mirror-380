...
from ...types import (
    ...
    repo_clone_params,
    repo_create_params,
    repo_ask_question_params,
    repo_update_contents_params,
    repo_retrieve_content_params,
)
...
from ...types.repo_ask_question_response import RepoAskQuestionResponse
from ...types.repo_retrieve_content_response import RepoRetrieveContentResponse
...
class RepoResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                repo_ask_question_params.RepoAskQuestionParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RepoAskQuestionResponse,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                repo_retrieve_content_params.RepoRetrieveContentParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RepoRetrieveContentResponse,
        )
    ...
    def update_contents(
        ...
        *,
        metadata: Optional[Dict[str, str]] | Omit = omit,
        source: Optional[repo_update_contents_params.Source] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                repo_update_contents_params.RepoUpdateContentsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class RepoResourceWithRawResponse:
    def __init__(self, repo: RepoResource) -> None:
        ...
        self.ask_question = (  # pyright: ignore[reportDeprecated]
            to_raw_response_wrapper(
                repo.ask_question,  # pyright: ignore[reportDeprecated],
            )
        )
        ...
        self.retrieve_content = to_raw_response_wrapper(
            repo.retrieve_content,
        )
        self.update_contents = to_raw_response_wrapper(
            repo.update_contents,
        )
...
class AsyncRepoResourceWithRawResponse:
    def __init__(self, repo: AsyncRepoResource) -> None:
        ...
        self.update_contents = async_to_raw_response_wrapper(
            repo.update_contents,
        )
...
class RepoResourceWithStreamingResponse:
    def __init__(self, repo: RepoResource) -> None:
        ...
        self.update_contents = to_streamed_response_wrapper(
            repo.update_contents,
        )
...
class AsyncRepoResourceWithStreamingResponse:
    def __init__(self, repo: AsyncRepoResource) -> None:
        ...
        self.update_contents = async_to_streamed_response_wrapper(
            repo.update_contents,
        )
