...
class Pipeline:
    ...
    def progress(self, uuid: str | UUID = "current") -> int:
    ...
    def master_files(self, uuid: str | UUID = "current") -> dict[str, str]:
        """Get a {source: path} mapping of generated master files."""
