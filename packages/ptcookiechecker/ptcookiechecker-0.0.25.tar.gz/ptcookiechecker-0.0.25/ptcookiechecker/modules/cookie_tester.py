            ...
            try:
                ...
                for pattern in error_patterns:
                    ...
                    if match:
                        ...
                        if matches:
                            # path only
                            ptprinthelper.ptprint(matches[0], bullet_type="ADDITIONS", condition=not self.use_json, indent=12, colortext=True )

                        else:
                            # full error
                            ptprinthelper.ptprint(match.group(0), bullet_type="ADDITIONS", condition=not self.use_json, indent=8, colortext=True)
