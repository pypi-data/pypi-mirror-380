                ...
                if local_files_found[0]["sha"] == remote_file["sha"]:
                    ...
                    if saved_sha == remote_file["sha"]:  # file is modified locally only
                        ...
                        if remote_path not in local_and_remote_modified:
                            local_and_remote_modified[remote_path] = []
