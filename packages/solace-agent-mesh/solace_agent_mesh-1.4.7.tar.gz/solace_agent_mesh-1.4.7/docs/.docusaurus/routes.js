...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '51a'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', '156'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', 'c46'),
            routes: [
              {
