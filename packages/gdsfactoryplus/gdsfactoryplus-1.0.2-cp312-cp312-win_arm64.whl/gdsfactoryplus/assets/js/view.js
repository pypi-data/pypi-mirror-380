 ...
 */
function initializeViewer(isTempRdb, isMoveEnabled = true, viewerTheme = "dark") {
    tempRdb = isTempRdb;
        ...
        setTimeout(() => {
            ...
            if (!moveEnabled) {
                ...
                if (moveToolButton) {
                    ...
                    moveToolButton.title = "Moving instances is disabled for cells from python source";
...
function setupMessageListener() {
    window.addEventListener("message", (event) => {
        ...
        if (content.startsWith("<report-database>")) {
            sendLyrdb(content);
            return
        }
