...
Currently supports optional Ray integration for fitness evaluation.
Falls back to sequential evaluation if Ray is not available or not requested.
"""
...
def _ensure_ray_initialized(num_cpus: Optional[int] = None,
