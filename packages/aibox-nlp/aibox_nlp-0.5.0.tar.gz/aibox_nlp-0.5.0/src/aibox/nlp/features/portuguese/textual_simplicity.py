...
class TextualSimplicityFeatures(DataclassFeatureSet):
    """Características de simplicidade textual."""
...
class TextualSimplicityExtractor(FeatureExtractor):
    """Extrator de características de simplicidade textual.
    ...
    @property
    def feature_set(self) -> type[TextualSimplicityFeatures]:
        return TextualSimplicityFeatures

    def extract(self, text: str, **kwargs) -> TextualSimplicityFeatures:
        del kwargs
    ...
    def _compute_simple_word_ratio(self, doc: Doc) -> float:
        ...
        for sentence in sentences:
            ...
            ratio = 0.0
            try:
                ratio = total_simple_words / total_content_words
