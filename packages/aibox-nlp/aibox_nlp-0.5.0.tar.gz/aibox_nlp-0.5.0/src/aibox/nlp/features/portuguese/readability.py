...
class ReadabilityFeatures(DataclassFeatureSet):
    ...
    Referências:
        ...
        `[2] <https://doi.org/10.5753/sbie.2024.242747 >`_:
        Rosa, B. A., Oliveira, H., Mello,
        R. F., & Oliveira, E. A. (2024). Combinação
        de Modelos de Aprendizado de Máquina utilizando
        Teoria de Resposta ao Item para Avaliação de
        Coesão Textual em Redações no contexto do ENEM.
        In Anais do XXXV Simpósio Brasileiro de Informática
        na Educação (SBIE 2024) (pp. 1999–2012). Simpósio
        Brasileiro de Informática na Educação. Sociedade
...
class ReadabilityExtractor(FeatureExtractor):
    ...
    @property
    def feature_set(self) -> type[ReadabilityFeatures]:
