"""Regressor utilizando k-NN."""

import numpy as np
from sklearn.neighbors import KNeighborsRegressor as _KNRegressor
...
class KNeighborsRegressor(Estimator):
    """Regressor baseado nos vizinhos mais próximos. Essa classe é
    um wrapper de :py:class:`sklearn.neighbors.KNeighborsRegressor`.
    """
    ...
    def __init__(
        ...
        self._kn = _KNRegressor(**self._hyperparams)
