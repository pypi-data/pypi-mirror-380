...
class WebvizSettingsDrawer(Component):
    """A WebvizSettingsDrawer component.
...
- id (string; required)"""
    ...
    def __init__(self, children=None, id=Component.REQUIRED, **kwargs):
        ...
        self._type = 'WebvizSettingsDrawer'
        ...
        super(WebvizSettingsDrawer, self).__init__(children=children, **args)
