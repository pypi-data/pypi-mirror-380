...
def spline_tool(
    ...
    """Implementation for creating multiple spline actors from stroke data."""
    logger.info(f"Sending spline_tool command with {len(strokes)} strokes.")
    params = {
        "strokes": strokes,
        "scale_factor": scale_factor
    }
    return send_unreal_command("spline_tool", params)
