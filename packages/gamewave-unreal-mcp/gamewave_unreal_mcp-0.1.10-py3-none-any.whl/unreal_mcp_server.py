...
class UnrealConnection:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            self.socket.settimeout(UNREAL_API_TIMEMOUT)
    ...
    def receive_full_response(self, sock, buffer_size=4096) -> bytes:
        ...
        chunks = []
        sock.settimeout(UNREAL_API_TIMEMOUT)
        try:
            while True:
...
from executor_tools.python_executor_tools import register_python_executor_tools
from executor_tools.command_line_executor_tools import register_command_line_executor_tools
from pcg_tools.pcg_tools import register_pcg_tools
from download_tools.download_tools import register_download_tools
...
register_command_line_executor_tools(mcp)
...
def info():
    ...
    ## Command line Executor Tools
    - **execute_command_line(command: str)**
       Execute command line operation in unreal engine.
        ...
        Examples:
            # Command to take a high resolution screenshot with multiplier 1 in Unreal Engine.
            execute_command_line(command="HighResShot 1")

    - **get_output_log_filepath()**
        Get output log file path in unreal engine. 
        ...
        Returns:
            Dict containing:
                ...
                - result: Result is the log file path.
    ...
    ### Command Line Executor Tools
    - Execute command line operation in unreal engine. This tool uses Unreal's console to execute command line operations.
"""
