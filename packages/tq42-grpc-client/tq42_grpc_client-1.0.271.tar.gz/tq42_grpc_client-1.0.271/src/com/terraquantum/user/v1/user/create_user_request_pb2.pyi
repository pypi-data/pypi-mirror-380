...
class CreateUserProfileRequest(_message.Message):
    __slots__ = ("first_name", "middle_name", "last_name", "company", "role", "primary_area_of_interest", "picture", "newsletter_sign_up")
