...
class VariationalGate(_message.Message):
    __slots__ = ("wire", "rotation")
    WIRE_FIELD_NUMBER: _ClassVar[int]
    ROTATION_FIELD_NUMBER: _ClassVar[int]
    wire: int
    rotation: _shared_pb2.MeasureProto
    def __init__(self, wire: _Optional[int] = ..., rotation: _Optional[_Union[_shared_pb2.MeasureProto, str]] = ...) -> None: ...
