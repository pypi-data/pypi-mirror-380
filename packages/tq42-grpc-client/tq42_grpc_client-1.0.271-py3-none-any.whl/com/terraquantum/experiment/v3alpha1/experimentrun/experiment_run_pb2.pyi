...
class ExperimentRunProto(_message.Message):
    __slots__ = ("id", "experiment_id", "sequential_id", "status", "algorithm", "hardware", "metadata", "result", "created_by", "created_at", "started_at", "finished_at", "last_running_status", "error_message", "cancelled_by", "deleted_at", "project_id")
