...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`
   * - ev_biot_stress
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`
   ...
   * - dw_div_grad
     ...
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`
   * - dw_dot
     ...
     - :ref:`osc <quantum-oscillator>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`wel <quantum-well>`, :ref:`bal <large_deformation-balloon>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`bor <quantum-boron>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`aco <acoustics-acoustics>`, :ref:`hyd <quantum-hydrogen>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`aco <acoustics-acoustics3d>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`aco <acoustics-acoustics>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`
   * - ev_integrate
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`osc <quantum-oscillator>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`poi <diffusion-poisson>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`cub <diffusion-cube>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`wel <quantum-well>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`bor <quantum-boron>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`aco <acoustics-acoustics>`, :ref:`hyd <quantum-hydrogen>`, :ref:`sin <diffusion-sinbc>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`tim.poi <diffusion-time_poisson>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`mul.nod.lcb <linear_elasticity-multi_node_lcbcs>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`mul.poi.con <linear_elasticity-multi_point_constraints>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`tru.bri <linear_elasticity-truss_bridge>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`its.1 <linear_elasticity-its2D_1>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`sto <navier_stokes-stokes>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`
   * - ev_surface_moment
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`hyp <large_deformation-hyperelastic>`, :ref:`act.fib <large_deformation-active_fibres>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`bal <large_deformation-balloon>`, :ref:`per.tl <large_deformation-perfusion_tl>`
   * - dw_tl_he_neohook_ad
