...
class GetStatistics200Response(BaseModel):
    ...
    """ # noqa: E501
    link_id: Optional[UUID] = Field(default=None, description="Link API ID")
    clicks: Optional[StrictInt] = Field(default=None, description="Total number of visits, combining clicks and scans")
    unique_clicks: Optional[StrictInt] = Field(default=None, description="Number of unique visitors, combining clicks and scans")
