...
class FoldersApi:
    ...
    def create_folder(
        self,
        create_folder_request: Annotated[Optional[CreateFolderRequest], Field(description="You can use this endpoint to add a folder to URLR.")] = None,
        ...
        :param create_folder_request: You can use this endpoint to add a folder to URLR.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateFolder200Response",
            '401': "GetLink401Response",
            '429': "CreateLink429Response",
            '409': "CreateFolder409Response",
        }
    ...
    def create_folder_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateFolder200Response]:
        """Create a folder
    ...
    def get_folders(
        self,
        team_id: Annotated[UUID, Field(description="Workspace API ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
