...
class AccessPointMessageSpecV1_0_0(DownlinkMessageSpec):
    ...
    header = {"def": ["msg_type", "msg_len"], "struct": ">BB"}
    ...
    msg_types = {
        ...
        "Control": {"type": 0xA0, "def": ["ctrl_cmd", "data"], "struct": ">H{}s"},
        "SetConfigMode": {
            "type": 0xB0,
...
class AccessPointMessageSpecV1_0_1(AccessPointMessageSpecV1_0_0):
    ...
    def __init__(self):
        ...
        self.control_types.update(
            {
                "SET_SYNC_DC": {"type": 0x0012, "def": ["sync"], "struct": ">B"},
                "SET_SCHEDULE": {"type": 0x0020, "def": ["sched"], "struct": ">21s"},
                "SET_ACK_MODE": {"type": 0x0108, "def": ["mode"], "struct": ">B"},
                "SET_TX_POWER": {"type": 0x0109, "def": ["tx_pwr"], "struct": ">B"},
            }
        )
...
UplinkQueueStats = namedtuple("UplinkQueueStats", ["uplinkQueueFillLevel", "uplinkQueueMsgCount"])

TaskStats = namedtuple(
    "TaskStats",
    [
        "taskBHConnectionErrorCount",
...
class AccessPoint(Module, AirfinderSubject):
    ...
    def __init__(self, **kwargs):
        ...
        if not _data:
            url = "{}/airfinder/{}/{}".format(self.network_asset_url, self.af_subject_name, self.subject_id)
    ...
    def send_unicast_message(
        self, endnode, payload, ble_ttl_s, uuid=None, gateway_addr=None, time_to_live_s=60.0, port=0, priority=10
    ):
        ...
        pld = self._get_spec(vers).build_message(
            "Unicast", endnode_addr=addr, time_to_live_s=ble_ttl_s, uuid=uuid, data=payload
        )
        return self.send_message(
            pld, gateway_addr=gateway_addr, time_to_live_s=time_to_live_s, port=port, priority=priority
        )

    def send_multicast_message(
        self, app_token, payload, ble_ttl_s, uuid, gateway_addr=None, time_to_live_s=60.0, port=0, priority=10
    ):
        ...
        pld = self._get_spec(vers).build_message(
            "Multicast", app_tok=app_tok_hex, time_to_live_s=ble_ttl_s, uuid=uuid, data=payload
        )
        return self.send_message(
            pld, gateway_addr=gateway_addr, time_to_live_s=time_to_live_s, port=port, priority=priority
        )
    ...
    def uplink_queue_stats(self):
        ...
        None otherwise."""
        try:
            return UplinkQueueStats(int(self._md.get("uplinkQueueFillLevel")), int(self._md.get("uplinkQueueMsgCount")))
        except ValueError:
            return None
    ...
    def set_config_mode(
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_message(
            "SetConfigMode", timeout=timeout, app_tok=bytearray(app_token), net_tok=bytearray(net_token), key=key
        )
        return self.send_message(
            pld, gateway_addr=gateway_addr, time_to_live_s=time_to_live_s, port=port, priority=priority
        )
    ...
    @classmethod
    def multicast_set_config_mode(
        cls, timeout, app_token, net_token, key, time_to_live_s, vers, gateways, port=0, priority=10
    ):
        """Requests that the AP enters Configuration Mode.
    ...
    def set_ap_type(self, ap_type, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_AP_TYPE", ap_type=ap_type)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_ap_type(cls, ap_type, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_AP_TYPE message
        ...
        Returns:
            :class:`conductor.subject.DownlinkMessage`
        """
        pld = cls._get_spec(vers).build_ctrl_message("SET_AP_TYPE", ap_type=ap_type)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_location_group(self, group, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_LOCATION_GROUP", loc_group=group)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_location_group(cls, group, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_LOCATION_GROUP message
        ...
        Returns:
            :class:`conductor.subject.DownlinkMessage`
        """
        pld = cls._get_spec(vers).build_ctrl_message("SET_LOCATION_GROUP", loc_group=group)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_location_weight(self, weight, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_LOCATION_WEIGHT", loc_weight=weight)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_location_weight(cls, weight, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_LOCATION_WEIGHT message
        ...
        Returns:
            :class:`conductor.subject.DownlinkMessage`
        """
        pld = cls._get_spec(vers).build_ctrl_message("SET_LOCATION_WEIGHT", loc_weight=weight)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_rssi_adj(self, offset, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_RSSI_ADJ", rss_adj=offset)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_rssi_adj(cls, offset, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_RSSI_ADJ message
        ...
        """
        # TODO: Data Validation?
        pld = cls._get_spec(vers).build_ctrl_message("SET_RSSI_ADJ", rss_adj=offset)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_adv_rate(self, rate, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_ADV_RATE", adv_rate=rate)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_adv_rate(cls, rate, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_ADV_RATE message
        ...
        if (rate < 20) or (rate > 10000):
            raise ValueError("Advertising rate must be in the range 20-10000ms!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_ADV_RATE", adv_rate=rate)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_adv_refresh(self, interval, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        if (interval < 200) or (interval > 10000):
            raise ValueError("Advertising refresh interval must be in the " "range of 200-10000ms!")
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_ADV_REFRESH", adv_refresh=interval)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_adv_refresh(cls, interval, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_ADV_REFRESH message
        ...
        if (interval < 200) or (interval > 10000):
            raise ValueError("Advertising refresh interval must be in the " "range of 200-10000ms!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_ADV_REFRESH", adv_refresh=interval)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_time_sync_rate(self, rate, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_TIME_SYNC_RATE", sync_time_rate=rate)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_time_sync_rate(cls, rate, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_TIME_SYNC_RATE message.
        ...
        if (rate < 5) or (rate > 86400):
            raise ValueError("Time sync rate must be in the range 5-86400s!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_TIME_SYNC_RATE", sync_time_rate=rate)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_conn_timeout(self, interval, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_CONN_TIMEOUT", conn_timeout=interval)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_conn_timeout(cls, interval, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_CONN_TIMEOUT message
        ...
        if (interval < 500) or (interval > 300000):
            raise ValueError("Connection timeout interval must be in the range" " 500-300000ms!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_CONN_TIMEOUT", conn_timeout=interval)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_status_rate(self, rate, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_STATUS_RATE", status_rate=rate)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_status_rate(cls, rate, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_STATUS_RATE message
        ...
        if (rate < 60) or (rate > 86400):
            raise ValueError("Status message interval must be in the range" " 60-86400s!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_STATUS_RATE", status_rate=rate)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_mailbox_rate(self, rate, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        if (rate < 20) or (rate > 86400):
            raise ValueError("Mailbox check rate must be in the range" " 20-86400s!")
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_MAILBOX_RATE", mailbox_int=rate)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_mailbox_rate(cls, rate, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_MAILBOX_RATE message
        ...
        if (rate < 20) or (rate > 86400):
            raise ValueError("Mailbox check rate must be in the range" " 20-86400s!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_MAILBOX_RATE", mailbox_int=rate)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_queue_send_rate(self, rate, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_QUEUE_SEND_RATE", send_rate=rate)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_queue_send_rate(cls, rate, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_QUEUE_SEND_RATE message
        ...
        if (rate < 5000) or (rate > 1800000):
            raise ValueError("Queue send rate must be in the range " "10000-1800000s!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_QUEUE_SEND_RATE", send_rate=rate)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_queue_threshold(self, thresh, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_QUEUE_THRESH", send_threshold=thresh)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_queue_threshold(cls, thresh, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_QUEUE_THRESH message
        ...
        if thresh > 100:
            raise ValueError("Queue threshold cannot be > 100%!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_QUEUE_THRESH", send_threshold=thresh)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_enable_ble(self, enable, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_ENABLE_BLE", enable=enable)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_enable_ble(cls, enable, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_ENABLE_BLE message
        ...
        Returns:
            :class:`conductor.subject.DownlinkMessage`
        """
        pld = cls._get_spec(vers).build_ctrl_message("SET_ENABLE_BLE", enable=enable)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def request_status(self, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
    ...
    @classmethod
    def multicast_request_status(cls, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a GET_STATUS message
    ...
    def enable_location(self, enable, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_ENABLE_LOCATION", enable=enable)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_enable_location(cls, enable, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_ENABLE_LOCATION message
        ...
        if type(enable) != bool:
            raise TypeError("enable must be True or False")
        pld = cls._get_spec(vers).build_ctrl_message("SET_ENABLE_LOCATION", enable=enable)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_ack_mode(self, mode, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_ACK_MODE", mode=ack_mode)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_ack_mode(cls, mode, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_ACK_MODE message
        ...
        if not AckMode.has_value(mode):
            raise ValueError("{} is not a valid ACK mode".format(mode))
        ack_mode = AckMode(mode)
        pld = cls._get_spec(vers).build_ctrl_message("SET_ACK_MODE", mode=ack_mode)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_tx_power(self, power, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_TX_POWER", tx_pwr=power)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_tx_power(cls, power, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Sends a SET_TX_POWER message
        ...
        """
        # TODO: Add parameter checking
        pld = cls._get_spec(vers).build_ctrl_message("SET_TX_POWER", tx_pwr=power)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def trigger_assert(self, gateway_addr=None, acked=True, time_to_live_s=60, port=0, priority=10):
        """
    ...
    @classmethod
    def multicast_trigger_assert(cls, time_to_live_s, vers, gateways, port=0, priority=10):
        """
        Triggers an assert in the AP
