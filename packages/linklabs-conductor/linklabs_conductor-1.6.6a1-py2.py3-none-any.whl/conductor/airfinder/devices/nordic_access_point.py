...
class NordicAPMessageSpecV2_0_0(AccessPointMessageSpecV1_1_0):
    ...
    def __init__(self):
        ...
        self.msg_types.update({"ConfigurationQuery": {"type": 0xA1, "def": ["uuid"], "struct": "I"}})
        self.control_types = deepcopy(self.control_types)
        self.control_types.update(
            {
                "CONFIG_BLE_FRONT_END": {"type": 0x010A, "def": ["config"], "struct": ">B"},
                "SAMPLE_BATT": {"type": 0x0103},
                "SET_DST": {"type": 0x0021, "def": ["enable"], "struct": ">B"},
                "SET_DUTY_CYCLE": {"type": 0x0022, "def": ["window"], "struct": ">B"},
            }
        )
...
class NordicAPMessageSpecV2_0_1(NordicAPMessageSpecV2_0_0):
    ...
    def __init__(self):
        ...
        self.control_types.update(
            {
                "SET_NET_TOKEN": {"type": 0x0001, "def": ["net_tok"], "struct": ">I", "defaults": [0x4F50454E]},
                "SET_DL_BAND": {
                    "type": 0x00A0,
                    "def": [
                        "band_edge_lower",
                ...
                "SET_DS_NET_TOKEN": {"type": 0x00A1, "def": ["net_tok"], "struct": ">I", "defaults": [0x4F50454E]},
            }
        )
...
class NordicAPMessageSpecV2_0_2(NordicAPMessageSpecV2_0_1):
    ...
    def __init__(self):
        ...
        self.control_types.update(
            {
                "SET_NORDIC_GW_RSSI": {"type": 0x00B0, "def": ["rssi"], "struct": ">i"},
                "SET_SYM_SCAN_MODE": {"type": 0x00B1, "def": ["mode"], "struct": ">H"},
                "SET_SYM_SCAN_ATTEMPTS": {"type": 0x00B2, "def": ["attempts"], "struct": ">B"},
                "SET_SYM_HOP_INT": {"type": 0x00B3, "def": ["interval"], "struct": ">I"},
                "SET_MAX_GW_ERROR": {"type": 0x00B4, "def": ["max_err"], "struct": ">B"},
                "SET_SYM_INFO_SCAN_INT": {"type": 0x00B5, "def": ["interval"], "struct": ">I"},
                "SET_SYM_GW_RSSI": {"type": 0x00B0, "def": ["rssi"], "struct": ">H"},
                "TRIGGER_BOOTLOADER": {"type": 0x0600, "def": ["hash"], "struct": ">I"},
                "GET_NORDIC_MAC": {"type": 0x0601, "def": ["mac"], "struct": ">h"},
            }
        )
...
class NordicAPMessageSpecV2_0_4(NordicAPMessageSpecV2_0_3):
    ...
    def __init__(self):
        ...
        self.control_types.update(
            {
                "vFOTA_CONTROL": {"type": 0x0602, "def": ["version", "command", "data"], "struct": ">BB{}s"},
                "TRIGGER_BOOTLOADER": {"type": 0x0604, "def": ["interval"], "struct": ">I"},
            }
        )
        ...
        self.vfota_control_types = {
            ...
            "TEST_MODE": {"type": 0x05, "def": ["state"], "struct": ">B"},
            "DEVICE_REPORT_REQ": {
                "type": 0x06,
            },
            "DAT_FILE_REQ": {"type": 0x07, "def": ["dat_length", "dat_file"], "struct": ">B{}s"},
            "STATUS_REQ": {
                "type": 0x08,
            },
        }
...
class NordicAccessPoint(AccessPoint):
    ...
    def send_configuration_query(self, gateway_addr=None, time_to_live_s=60.0, port=0, priority=10):
        ...
        pld = self._get_spec(vers).build_message("ConfigurationQuery", uuid=uuid4().fields[0])
    ...
    def config_ble_front_end(
        self, enable, antenna, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10
    ):
        """
    ...
    def multicast_config_ble_front_end(cls, enable, antenna, time_to_live_s, vers, gateways):
        ...
        val = 0x01 if enable else 0x00
        val += 0x02 if antenna == AntennaPort.ANT_B else 0x00
        pld = cls._get_spec(vers).build_ctrl_message("CONFIG_BLE_FRONT_END", config=val)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def sample_batt(self, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
    ...
    def multicast_set_sym_gw_rssi(cls, rssi, time_to_live_s, vers, gateways):
        ...
        if rssi < -121 or rssi > -40:
            raise ValueError("RSSI must be within -121 and -40!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_SYM_GW_RSSI", rssi=rssi)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_nordic_gw_rssi(self, rssi, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        if rssi < -121 or rssi > -40:
            raise ValueError("RSSI must be within -121 and -40!")
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_NORDIC_GW_RSSI", rssi=rssi)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)
    ...
    def multicast_set_nordic_gw_rssi(cls, rssi, time_to_live_s, vers, gateways):
        ...
        if rssi < -121 or rssi > -40:
            raise ValueError("RSSI must be within -121 and -40!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_NORDIC_GW_RSSI", rssi=rssi)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_scan_mode(self, scan_mode, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_SYM_SCAN_MODE", mode=scan_mode)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_scan_mode(cls, scan_mode, time_to_live_s, vers, gateways):
        """
        Sends a SET_SYM_SCAN_MODE message
        ...
        if not ScanMode.has_value(scan_mode):
            raise ValueError("Scan mode must be in ScanMode Enum!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_SYM_SCAN_MODE", mode=scan_mode)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_max_scan_attempts(self, attempts, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_SYM_SCAN_ATTEMPTS", attempts=attempts)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)
    ...
    def multicast_set_max_scan_attempts(cls, attempts, time_to_live_s, vers, gateways):
        ...
        if attempts < 2 or attempts > 10:
            raise ValueError("Scan attempts must be between 2 and 10!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_SYM_SCAN_ATTEMPTS", attempts=attempts)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_hop_interval(self, interval, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        if interval < 600 or interval > 1382400:
            raise ValueError("Hop Interval must range from 600 - 1382400" " seconds (16 days)!")
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_SYM_HOP_INT", interval=interval)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_hop_interval(cls, interval, time_to_live_s, vers, gateways):
        """
        Sends a SET_SYM_HOP_INT message
        ...
        if interval < 600 or interval > 1382400:
            raise ValueError("Hop Interval must range from 600 - 1382400" " seconds (16 days)!")
        pld = cls._get_spec(vers).build_ctrl_message("SET_SYM_HOP_INT", interval=interval)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)

    def set_max_gw_errors(self, errors, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
        ...
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_MAX_GW_ERROR", max_err=errors)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_max_gw_errors(cls, errors, time_to_live_s, vers, gateways):
        """
        Sends a SET_MAX_GW_ERROR message
    ...
    def set_network_token(self, net_tok, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_ctrl_message("SET_NET_TOKEN", net_tok=net_tok)
        return self.send_message(pld, gateway_addr, acked, time_to_live_s, port, priority)

    @classmethod
    def multicast_set_network_token(cls, net_tok, time_to_live_s, vers, gateways):
        ...
        Returns:
            :class:`conductor.subject.DownlinkMessage`
        """
        pld = cls._get_spec(vers).build_ctrl_message("SET_NET_TOKEN", net_tok=net_tok)
        return cls._issue_multicast(pld, time_to_live_s, vers, gateways)
    ...
    @classmethod
    def multicast_set_dl_band(
        cls, edge_lower, edge_upper, edge_guard, edge_ch_step, edge_ch_offset, time_to_live_s, vers, gateways
    ):
        """
        Sets the Downlink Link Band Configuration for the Symphony Link Module.
    ...
    def set_ds_network_token(self, net_tok, gateway_addr=None, acked=True, time_to_live_s=60.0, port=0, priority=10):
        """
    ...
    def vfota_update(
        ...
        pld = spec.build_vfota_message(
            "UPDATE",
            file_id=file_id,
            file_version=file_version.to_int(),
            spread_image=int(spread_image),
            img_src=int(image_source),
    ...
    def multicast_vfota_update(
        ...
        pld = spec.build_vfota_message(
            "UPDATE",
            file_id=file_id,
            file_version=file_version.to_bytes(),
            spread_image=spread_image,
