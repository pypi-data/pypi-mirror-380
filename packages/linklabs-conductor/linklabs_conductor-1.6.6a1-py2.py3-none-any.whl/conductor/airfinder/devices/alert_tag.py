...
class AlertTagDownlinkMessageSpecV1(DownlinkMessageSpec):
    ...
    header = {"def": ["msg_type", "msg_spec_version"], "struct": ">BB", "defaults": [0x00, 0x01]}
        ...
        self.msg_types["Configuration"].update(
            {
                ...
                "struct": ">HHBBBHBBBB",
                "defaults": [0x00, 0x0258, 0x1E, 0x0F, 0x03, 0x012C, 0x03, 0x03, 0x01, 0b01000000],
            }
        )


class AlertTagDownlinkMessageSpecV3(AlertTagDownlinkMessageSpecV1):
    """Message Spec for the Alert Tag v2.0."""
...
class AlertTag(Tag):
    ...
    def _get_spec(cls, vers):
        ...
        if vers == 1:
            ...
            return AlertTagDownlinkMessageSpecV3()
        else:
    ...
    @classmethod
    def multicast_ack(cls, vers, gws, time_to_live_s=60, access_point=None, ap_vers=None):
    ...
    @classmethod
    def multicast_close(cls, vers, gws, time_to_live_s=60, access_point=None, ap_vers=None):
    ...
    def msg_spec_version(self):
        ...
        return int(self._md.get("messageSpecVersion"))

    ###########################################################################
    # Configuration Methods.
    ###########################################################################

    def configure(self, time_to_live_s=900, access_point=None, **kwargs):
    ...
    @classmethod
    def multicast_configure(cls, vers, gws, time_to_live_s=60, access_point=None, ap_vers=None, **kwargs):
