...
class FormLabel:
    def __init__(self, children: Optional[Union[State, str, QWidget, List[QWidget]]], classes: Optional[Union[State, Dict]], color: Union[State, str], component: Optional[Union[State, str]], disabled: Union[State, bool], label: Union[State, str], error: Union[State, bool], filled: Union[State, bool], focused: Union[State, bool], required: Union[State, bool], sx: Optional[Union[State, List, Dict, Callable, str]], **kwargs): ...
