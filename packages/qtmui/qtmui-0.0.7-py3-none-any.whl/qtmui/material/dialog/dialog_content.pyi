...
class DialogContent:
    def __init__(self, children: Optional[Union[State, QWidget, List[QWidget]]], classes: Optional[Union[State, Dict]], dividers: Union[State, bool], sx: Optional[Union[State, Dict, Callable, str]], text: Optional[Union[State, str]], ref: Optional[Union[State, object]], **kwargs): ...
