...
class DurationParser:
    ...
    def get_default_duration(self) -> timedelta:
        """Get default blocking duration (1 day)"""
...
class TimeManager:
    ...
    def calculate_expires_at(self, duration_str: Optional[str] = None) -> datetime:
        """
        ...
        Returns:
            datetime when the block should expire
        """
        if duration_str:
            ...
            delta = self.parser.get_default_duration()
