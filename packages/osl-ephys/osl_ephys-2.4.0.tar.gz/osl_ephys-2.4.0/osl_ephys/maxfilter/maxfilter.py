...
def run_maxfilter(infif, outfif, args, logfile_tag=''):
    ...
    ----------
        ...
        args : dict
            Dictionary of arguments to pass to maxfilter.  See ``help(osl_ephys.maxfilter)`` for all options, and 
...
def run_multistage_maxfilter(infif, outbase, args):
    ...
    ----------
        ...
        outbase : str
            output directory.
        args : dict
            Dictionary of arguments to pass to maxfilter. See ``help(osl_ephys.maxfilter)`` for all options.
...
def run_maxfilter_batch(files, outdir, args=None):
    ...
    args : str
        List of additional optional arguments to pass to osl_maxfilter.  See ``help(osl_ephys.maxfilter)`` for all options.
