...
def get_Ms_and_Ds(n, q, **kwargs):
    ...
    Updated to make M and D with ensure both matrices are the same no matter how many num_subsample and num_repeat are passed in. (e.g. Ms[0] will be the same no matter if num_subsample is 3 or 4)
    """
