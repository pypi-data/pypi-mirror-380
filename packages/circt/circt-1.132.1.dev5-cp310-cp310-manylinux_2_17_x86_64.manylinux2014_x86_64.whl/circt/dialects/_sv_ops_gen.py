...
def case(cond, case_patterns, num_case_regions, *, case_style=None, validation_qualifier=None, loc=None, ip=None) -> CaseOp:
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, module_type, *, per_argument_attrs=None, input_locs=None, result_locs=None, verilogName=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_649')) else
      _ods_ir.AttrBuilder.get('anonymous_649')(module_type, context=_ods_context))
