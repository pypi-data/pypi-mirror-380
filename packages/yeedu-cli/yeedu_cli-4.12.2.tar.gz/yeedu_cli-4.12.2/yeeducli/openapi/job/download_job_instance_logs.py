...
class DownloadJobInstanceLogs:
    def get_job_instance_log_records(workspace_id, log_type, run_id, last_n_lines=None, file_size_bytes=None):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/workspace/{workspace_id}/spark/job/run/{run_id}/log/{log_type}"
