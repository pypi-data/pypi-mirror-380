...
async def main_async(speed:int=5,food_emoji :str= "🍎",grid_size : tuple = (20,20 ),block_emoji:str= "🔲" ):
    await asyncio.gather( check_keys(),print_loop(speed=speed,food_emoji=food_emoji,grid_size=grid_size,block_emoji=block_emoji))




def main(speed:int=5,food_emoji :str= "🍎",grid_size : tuple = (20,20 ),block_emoji:str= "🔲" ) :
    try :
        asyncio.run(main_async(speed=speed,food_emoji =food_emoji ,grid_size = grid_size,block_emoji=block_emoji ))    
