...
class InferenceRule:
    ...
    def specialize(self, specialization_map: SpecializationMap) -> \
        ...
        for variable in specialization_map:
            assert is_variable(variable), print(f'{variable} is not a variable')
            if isinstance(specialization_map[variable], str):
                specialization_map[variable] = Formula.parse(specialization_map[variable])
