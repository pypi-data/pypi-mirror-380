...
# proof1 = remove_assumption(remove_assumption(parse_proof("""Proof of ['p', 'q'] ==> '(r->(r&(p&q)))' via inference rules:
#   [] ==> '(p->(q->(p&q)))'
#   ['p', '(p->q)'] ==> 'q'
#   [] ==> '(q->(p->q))'
#   [] ==> '((p->(q->r))->((p->q)->(p->r)))'
...
# Lines:
#   0) p
#   1) (p->(r->p))    (Inference Rule [] ==> '(q->(p->q))')
#   2) (r->p)    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 0,1)
#   3) q
#   4) (q->(r->q))    (Inference Rule [] ==> '(q->(p->q))')
#   5) (r->q)    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 3,4)
#   6) p
#   7) (p->(r->p))    (Inference Rule [] ==> '(q->(p->q))')
#   8) (r->p)    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 6,7)
#   9) q
#  10) (q->(r->q))    (Inference Rule [] ==> '(q->(p->q))')
#  11) (r->q)    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 9,10)
#  12) (p->(q->(p&q)))    (Inference Rule [] ==> '(p->(q->(p&q)))')
#  13) ((p->(q->(p&q)))->(r->(p->(q->(p&q)))))    (Inference Rule [] ==> '(q->(p->q))')
#  14) (r->(p->(q->(p&q))))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 12,13)
#  15) ((r->(p->(q->(p&q))))->((r->p)->(r->(q->(p&q)))))    (Inference Rule [] ==> '((p->(q->r))->((p->q)->(p->r)))')
#  16) ((r->p)->(r->(q->(p&q))))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 14,15)
#  17) (r->(q->(p&q)))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 2,16)
#  18) ((r->(q->(p&q)))->((r->q)->(r->(p&q))))    (Inference Rule [] ==> '((p->(q->r))->((p->q)->(p->r)))')
#  19) ((r->q)->(r->(p&q)))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 17,18)
#  20) (r->(p&q))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 5,19)
#  21) (r->r)    (Inference Rule [] ==> '(p->p)')
#  22) (r->r)    (Inference Rule [] ==> '(p->p)')
#  23) ((r->(q->(p&q)))->((r->q)->(r->(p&q))))    (Inference Rule [] ==> '((p->(q->r))->((p->q)->(p->r)))')
#  24) ((r->q)->(r->(p&q)))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 17,23)
#  25) (r->(p&q))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 5,24)
#  26) (r->((p&q)->(r&(p&q))))    (Inference Rule [] ==> '(p->(q->(p&q)))')
#  27) ((r->((p&q)->(r&(p&q))))->(r->(r->((p&q)->(r&(p&q))))))    (Inference Rule [] ==> '(q->(p->q))')
#  28) (r->(r->((p&q)->(r&(p&q)))))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 26,27)
#  29) ((r->(r->((p&q)->(r&(p&q)))))->((r->r)->(r->((p&q)->(r&(p&q))))))    (Inference Rule [] ==> '((p->(q->r))->((p->q)->(p->r)))')
#  30) ((r->r)->(r->((p&q)->(r&(p&q)))))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 28,29)
#  31) (r->((p&q)->(r&(p&q))))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 21,30)
#  32) ((r->((p&q)->(r&(p&q))))->((r->(p&q))->(r->(r&(p&q)))))    (Inference Rule [] ==> '((p->(q->r))->((p->q)->(p->r)))')
#  33) ((r->(p&q))->(r->(r&(p&q))))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 26,32)
#  34) (r->(r&(p&q)))    (Inference Rule ['p', '(p->q)'] ==> 'q' on lines 20,33)
# QED""")))
