...
# graph1 = (7, {(1,6),(2,6),(3,6),(4,6),(5,6),(6,7),(1,4),(2,4),(2,3),(3,5),(4,6),(4,5),(1,7),(2,7),(3,7),(4,7)})

# graph = (8, {(1,6),(2,6),(3,6),(4,6),(5,6),(6,7),(6,8),(1,4),(1,7),(2,4),(2,3),(3,5),(4,6),(4,5),(4,7),(5,7),(5,8),(7,8)})
# print(tricolor_graph(graph1))
...
# formula = graph3coloring_to_formula(graph)
# print(formula,'\n')
# print(tricolor_graph(graph))


# one = list(range(1,3))
# two = one[1:]
# two.append(one[0])
# three = set(zip(one, two))
# graph = (len(three), three)
# formula = graph3coloring_to_formula(graph)
# print(formula)
# print('\n\n',to_not_or(formula))
