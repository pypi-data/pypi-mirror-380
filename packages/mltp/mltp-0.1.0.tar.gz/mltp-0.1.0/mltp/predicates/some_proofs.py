...
# prover.add_ug(quantified, nonquantified_line_number)
# prover.add_universal_instantiation(instantiation, line_number, term)
# prover.add_free_instantiation(instantiation, line_number, substitution_map)
# prover.add_flipped_equality(flipped, line_number)
# prover.add_substituted_equality(substituted, line_number, parametrized_term)
# prover.add_instantiated_assumption(instantiated, assumption, inst_map)
# prover.add_tautological_implication(implication, line_numbers)
# prover.add_existential_derivation(consequent, line_number1, line_number2) 1 = Ex[antecedent], 2 = '(antecedent(x)->consequent)'
