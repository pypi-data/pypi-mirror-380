    ...
    return {
        "search_sessions": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "Search keywords for fuzzy matching across session content"},
        ...
        "search_sessions_by_speaker": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "speaker_name": {"type": "string", "description": "Speaker name or partial name for fuzzy matching"},
                    "limit": {"type": "number", "description": "Number of results per page", "default": 20, "minimum": 1, "maximum": 100},
                    "cursor": {"type": "string", "description": "Pagination cursor for next page"}
                },
                "required": ["speaker_name"]
            },
            "handler": lambda args: service.search_sessions_by_speaker(args.get("speaker_name"), args.get("limit", 20), args.get("cursor", 0))
        }
    }
