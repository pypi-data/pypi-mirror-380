...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "autoComplete", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column("autoDeleteDateTime", sa.DateTime(), nullable=True),
        sa.Column(
            "autoDelete", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column(
            "stateFlags", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column(
        ...
        sa.Column(
            "displayAs", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column(
            "displayPriority", sa.Integer(), server_default="0", nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("uniqueId"),
        schema="pl_inbox",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["taskId"], ["pl_inbox.Task.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="pl_inbox",
    )
    op.create_index(
        "idx_TaskAction_taskId",
        "TaskAction",
        ["taskId"],
        unique=False,
        schema="pl_inbox",
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "idx_TaskAction_taskId", table_name="TaskAction", schema="pl_inbox"
    )
