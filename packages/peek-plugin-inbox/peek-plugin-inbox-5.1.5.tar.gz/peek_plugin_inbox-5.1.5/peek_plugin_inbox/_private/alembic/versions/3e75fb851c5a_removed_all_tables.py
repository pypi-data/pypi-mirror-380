...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text(
                "nextval('pl_inbox.\"Task_id_seq\"'::regclass)"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "userId", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
            "dateTime",
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('pl_inbox.\"Setting_id_seq\"'::regclass)"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('pl_inbox.\"Activity_id_seq\"'::regclass)"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "settingId", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "key", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
            "type", sa.VARCHAR(length=16), autoincrement=False, nullable=True
        ),
        sa.Column(
            "int_value", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "char_value", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "boolean_value", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["settingId"],
            ["pl_inbox.Setting.id"],
