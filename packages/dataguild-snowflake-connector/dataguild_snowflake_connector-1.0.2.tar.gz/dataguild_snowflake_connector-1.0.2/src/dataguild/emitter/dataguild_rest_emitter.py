"""
DataGuild REST Emitter - DataHub Compatible Implementation

Enterprise-grade REST emitter with comprehensive error handling, batching,
retry logic, and observability features inspired by DataHub's best practices.
"""
...
class DataGuildRestEmitterConfig(ConfigModel):
    ...
    retry_status_codes: List[int] = field(default_factory=lambda: _DEFAULT_RETRY_STATUS_CODES)
...
class DataGuildRestEmitter:
    ...
    Features:
    - DataHub-compatible API endpoints
