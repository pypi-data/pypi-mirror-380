...
class OperationalError(MetaError):
    """Exception raised for operational errors during runtime."""

    def __init__(self, message: str, operation: Optional[str] = None, code: Optional[int] = None):
        super().__init__(message, code)
        self.operation = operation

    def __str__(self):
        if self.operation:
            return f"OperationalError(operation={self.operation}): {self.message}"
        return f"OperationalError: {self.message}"
