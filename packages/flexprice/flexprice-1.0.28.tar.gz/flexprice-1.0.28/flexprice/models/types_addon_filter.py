...
class TypesAddonFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addon_ids", "addon_type", "end_time", "expand", "filters", "limit", "lookup_keys", "offset", "order", "sort", "start_time", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypesAddonFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypesAddonFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "lookup_keys": obj.get("lookup_keys"),
