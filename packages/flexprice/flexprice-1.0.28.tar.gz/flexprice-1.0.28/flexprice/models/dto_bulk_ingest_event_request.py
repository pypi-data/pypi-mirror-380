...
class DtoBulkIngestEventRequest(BaseModel):
    ...
    """ # noqa: E501
    events: Annotated[List[DtoIngestEventRequest], Field(min_length=1, max_length=1000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [DtoIngestEventRequest.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
