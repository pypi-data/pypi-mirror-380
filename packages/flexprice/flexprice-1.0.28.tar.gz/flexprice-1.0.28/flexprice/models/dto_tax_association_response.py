...
class DtoTaxAssociationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["auto_apply", "created_at", "created_by", "currency", "entity_id", "entity_type", "environment_id", "id", "metadata", "priority", "status", "tax_rate", "tax_rate_id", "tenant_id", "updated_at", "updated_by", "valid_from", "valid_to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DtoTaxAssociationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DtoTaxAssociationResponse from a dict"""
        if obj is None:
            return None
