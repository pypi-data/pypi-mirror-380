...
class DtoUpdateInvoiceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["due_date", "invoice_pdf_url", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DtoUpdateInvoiceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DtoUpdateInvoiceRequest from a dict"""
        if obj is None:
            return None
