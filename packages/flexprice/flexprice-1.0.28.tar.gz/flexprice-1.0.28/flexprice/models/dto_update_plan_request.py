...
class DtoUpdatePlanRequest(BaseModel):
    ...
    """ # noqa: E501
    credit_grants: Optional[List[DtoUpdatePlanCreditGrantRequest]] = None
    ...
    __properties: ClassVar[List[str]] = ["credit_grants", "description", "display_order", "entitlements", "lookup_key", "metadata", "name", "prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credit_grants": [DtoUpdatePlanCreditGrantRequest.from_dict(_item) for _item in obj["credit_grants"]] if obj.get("credit_grants") is not None else None,
