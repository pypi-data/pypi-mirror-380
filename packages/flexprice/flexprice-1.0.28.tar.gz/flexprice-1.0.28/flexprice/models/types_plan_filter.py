...
class TypesPlanFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["end_time", "entity_ids", "entity_type", "expand", "filters", "limit", "offset", "order", "plan_ids", "sort", "start_time", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypesPlanFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypesPlanFilter from a dict"""
        if obj is None:
            return None
