...
class DtoPriceUnitResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_currency", "code", "conversion_rate", "created_at", "created_by", "environment_id", "id", "name", "precision", "status", "symbol", "tenant_id", "updated_at", "updated_by"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DtoPriceUnitResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DtoPriceUnitResponse from a dict"""
        if obj is None:
            return None
