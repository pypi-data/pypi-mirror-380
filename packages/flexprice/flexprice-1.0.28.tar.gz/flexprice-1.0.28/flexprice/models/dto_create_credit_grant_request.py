...
class DtoCreateCreditGrantRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cadence", "credits", "expiration_duration", "expiration_duration_unit", "expiration_type", "metadata", "name", "period", "period_count", "plan_id", "priority", "scope", "subscription_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DtoCreateCreditGrantRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DtoCreateCreditGrantRequest from a dict"""
        if obj is None:
            return None
