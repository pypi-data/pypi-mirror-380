...
class DtoCancelSubscriptionRequest(BaseModel):
    ...
    reason: Optional[StrictStr] = Field(default=None, description="Reason for cancellation (for audit and business intelligence)")
    __properties: ClassVar[List[str]] = ["cancellation_type", "proration_behavior", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DtoCancelSubscriptionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DtoCancelSubscriptionRequest from a dict"""
        if obj is None:
            return None
