...
class DtoAggregatedFeature(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entitlement", "feature", "sources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlement": DtoAggregatedEntitlement.from_dict(obj["entitlement"]) if obj.get("entitlement") is not None else None,
