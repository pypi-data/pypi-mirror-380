...
class TypesQueryFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["expand", "limit", "offset", "order", "sort", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypesQueryFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypesQueryFilter from a dict"""
        if obj is None:
            return None
