...
class DtoUsageAnalyticPoint(BaseModel):
    ...
    event_count: Optional[StrictInt] = Field(default=None, description="Number of events in this time window")
    timestamp: Optional[StrictStr] = None
    usage: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["cost", "event_count", "timestamp", "usage"]
