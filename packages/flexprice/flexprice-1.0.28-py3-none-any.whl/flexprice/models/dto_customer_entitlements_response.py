...
class DtoCustomerEntitlementsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customer_id", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": [DtoAggregatedFeature.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
