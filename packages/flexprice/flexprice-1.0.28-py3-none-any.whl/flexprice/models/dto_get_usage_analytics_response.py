...
class DtoGetUsageAnalyticsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency", "items", "total_cost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DtoUsageAnalyticItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
