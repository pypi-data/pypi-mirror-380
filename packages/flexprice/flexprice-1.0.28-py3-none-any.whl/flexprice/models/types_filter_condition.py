...
class TypesFilterCondition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data_type", "field", "operator", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": GithubComFlexpriceFlexpriceInternalTypesValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
