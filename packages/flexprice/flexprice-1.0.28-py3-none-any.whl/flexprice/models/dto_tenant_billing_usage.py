...
class DtoTenantBillingUsage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["subscriptions", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [DtoSubscriptionResponse.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
            "usage": DtoCustomerUsageSummaryResponse.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
