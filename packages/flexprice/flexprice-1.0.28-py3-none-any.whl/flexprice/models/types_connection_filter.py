...
class TypesConnectionFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connection_ids", "end_time", "expand", "filters", "limit", "offset", "order", "provider_type", "sort", "start_time", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypesConnectionFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypesConnectionFilter from a dict"""
        if obj is None:
            return None
