...
class DtoGetUsageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_name", "results", "type", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [DtoUsageResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "type": obj.get("type"),
            "value": obj.get("value")
        })
        return _obj
