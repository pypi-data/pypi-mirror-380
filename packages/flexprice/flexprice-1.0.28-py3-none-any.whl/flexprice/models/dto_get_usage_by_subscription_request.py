...
class DtoGetUsageBySubscriptionRequest(BaseModel):
    ...
    lifetime_usage: Optional[StrictBool] = None
    start_time: Optional[StrictStr] = None
    subscription_id: StrictStr
    __properties: ClassVar[List[str]] = ["end_time", "lifetime_usage", "start_time", "subscription_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lifetime_usage": obj.get("lifetime_usage"),
