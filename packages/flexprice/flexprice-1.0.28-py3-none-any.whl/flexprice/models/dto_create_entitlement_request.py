...
class DtoCreateEntitlementRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entity_id", "entity_type", "feature_id", "feature_type", "is_enabled", "is_soft_limit", "plan_id", "static_value", "usage_limit", "usage_reset_period"]
