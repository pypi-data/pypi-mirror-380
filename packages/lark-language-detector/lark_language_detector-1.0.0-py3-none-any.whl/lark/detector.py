...
# 导入模型和分词器
from farshore.model import LarkModel
from farshore.tokenizer import batch_tokenize
...
class LarkDetector:
    ...
    def _download_model(self) -> str:
        ...
        # 如果包内没有，尝试用户目录
        model_url = "https://huggingface.co/jiangchengchengNLP/Lark/resolve/main/lark_epoch1.pth"
    ...
    def _download_labels(self) -> str:
        ...
        # 如果包内没有，尝试用户目录
        labels_url = "https://huggingface.co/jiangchengchengNLP/Lark/resolve/main/all_dataset_labels.json"
