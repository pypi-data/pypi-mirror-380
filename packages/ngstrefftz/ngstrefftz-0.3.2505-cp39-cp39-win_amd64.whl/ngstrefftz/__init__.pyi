...
import typing
__all__: list[str] = ['BOXTYPE', 'BilinearForm', 'BoxDifferentialSymbol', 'BoxIntegral', 'ClipCoefficientFunction', 'CompoundEmbTrefftzFESpace', 'CondenseDG', 'CoordCF', 'ET', 'EmbeddedTrefftzFES', 'FESpace', 'FFacetBFI', 'FFacetLFI', 'GetWave', 'IntegrationPointFunction', 'IntegrationRule', 'L2', 'L2EmbTrefftzFESpace', 'LinearForm', 'Mesh1dTents', 'MonomialEmbTrefftzFESpace', 'PUFESpace', 'PrintCF', 'QTWaveTents1', 'QTWaveTents2', 'SpaceTimeDG_FFacetBFI', 'SpaceTimeDG_FFacetLFI', 'SymbolicBFI', 'SymbolicLFI', 'TWave', 'TWaveTents1', 'TWaveTents2', 'TWaveTents3', 'Tent', 'TentSlab', 'TrefftzEmbTrefftzFESpace', 'TrefftzEmbedding', 'TrefftzTents', 'VectorL2EmbTrefftzFESpace', 'WeightedRadiusFunction', 'dball', 'dbox', 'monomialfespace', 'ngsolve', 'ngstrefftz', 'trefftzfespace']
class BOXTYPE:
    """
...
class TrefftzEmbedding:
    ...
    def GetParticularSolution(self, arg0: ngsolve.la.BaseVector) -> ngsolve.la.BaseVector:
        ...
        """
    def __init__(self, top: ngsolve.comp.SumOfIntegrals = None, trhs: ngsolve.comp.SumOfIntegrals = None, cop: ngsolve.comp.SumOfIntegrals = None, crhs: ngsolve.comp.SumOfIntegrals = None, ndof_trefftz: int = 18446744073709551615, eps: float = 0.0, fes: ngsolve.comp.FESpace = None, fes_test: ngsolve.comp.FESpace = None, fes_conformity: ngsolve.comp.FESpace = None, fes_ip: ngsolve.comp.SumOfIntegrals = None, ignoredofs: pyngcore.pyngcore.BitArray = None, stats: dict | None = None) -> None:
        """
