                ...
                for result in pool.imap_unordered(self.convert_folder, dicom_folders):
                    ...
                    # Handled skip - returns the skip reason and the dicom folder
                        ...
                        match reason:
                            case "mincount":
                                warning_message(
                                    "because there were too few dicom files."
                                )
                            case "nan":
                            ...
                            case "not-ax":
                                warning_message(
                                    "because the series was not an axial CT"
                                )
                            case "mip":
                                warning_message(
                                    "because the series was likely a MIP scan"
                                )
                            case "conversion":
                                warning_message(
                                    "due to a conversion error in dicom2nifti."
                                )
