...
import trigger_model.templates 
...
class TriggerModel:
    ...
    def build_emulator(self, ad_shift: list, ad_offsets: list, n_outputs: int):
        ...
        with pkg_resources.path(trigger_model.templates, "scales.h") as scales_template_path:
        ...
        with pkg_resources.path(trigger_model.templates, "model_template.cpp") as emulator_template_path:
            emulator_out_path = model_dir / "emulator.cpp"
            self._render_template(emulator_template_path, emulator_out_path, context)
        
        with pkg_resources.path(trigger_model.templates, "makefile_version") as makefile_template_path:
            makefile_out_path = model_dir / "Makefile"
            self._render_template(makefile_template_path, makefile_out_path, {"MODEL_NAME": self.name})

        with pkg_resources.path(trigger_model.templates, "makefile") as makefile_template_path:
