...
import src.list_coll
from src.list_coll import collisions, doors


class Stage_collisions:
    def __init__(self):
        self.floor_collisions = copy.deepcopy(src.list_coll.og_floor_col)
        self.stairs_collisions = copy.deepcopy(src.list_coll.og_stair_col)
