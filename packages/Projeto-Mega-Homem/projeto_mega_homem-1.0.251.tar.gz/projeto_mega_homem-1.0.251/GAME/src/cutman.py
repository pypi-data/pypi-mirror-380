...
from src.rolling_cutter import Rolling_Cutter
...
class Cutman(Enemy, Life_bar):
    def __init__(self, x, y, width=48, height=72, max_health=28, damage=6):
        ...
        self.idle_spr = [
            src.global_var.cutman_sprites["Cutman_Idle_us"],
            src.global_var.cutman_sprites["Cutman_Idle_1_us"],
            src.global_var.cutman_sprites["Cutman_Idle"],
            src.global_var.cutman_sprites["Cutman_Idle_1"],
        ]

        self.walking_spr = [
            src.global_var.cutman_sprites["Cutman_Walk_1_us"],
            src.global_var.cutman_sprites["Cutman_Walk_2_us"],
            src.global_var.cutman_sprites["Cutman_Walk_3_us"],
            src.global_var.cutman_sprites["Cutman_Walk_2_us"],
            src.global_var.cutman_sprites["Cutman_Walk_1"],
            src.global_var.cutman_sprites["Cutman_Walk_2"],
            src.global_var.cutman_sprites["Cutman_Walk_3"],
            src.global_var.cutman_sprites["Cutman_Walk_2"],
        ]

        self.jumping_spr = [
            src.global_var.cutman_sprites["Cutman_Jump_us"],
            src.global_var.cutman_sprites["Cutman_Jump"],
        ]

        self.shoot_spr = [
            src.global_var.cutman_sprites["Cutman_Shoot_1"],
            src.global_var.cutman_sprites["Cutman_Shoot_2"],
        ]
    ...
    def follow(self, megaman):
        if 0 > self.x - src.global_var.camera_x:
            self.direction = True
        elif self.x - src.global_var.camera_x > 600:
            self.direction = False
        self.walking = True
        if self.direction:
            self.speed = 5
