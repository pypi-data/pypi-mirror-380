...
import GAME.src.list_coll
from GAME.src.list_coll import collisions, doors


class Stage_collisions:
    def __init__(self):
        self.floor_collisions = copy.deepcopy(GAME.src.list_coll.og_floor_col)
        self.stairs_collisions = copy.deepcopy(GAME.src.list_coll.og_stair_col)
