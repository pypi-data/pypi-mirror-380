...
The package ``ut_uts`` can be installed from.

To install with ``pip``:

.. code-block:: shell

	$ python -m pip install ut_uts
...
The Package ``ut_uts`` consist of the following file types (c.f.: **Appendix**: `Package Logging`)
