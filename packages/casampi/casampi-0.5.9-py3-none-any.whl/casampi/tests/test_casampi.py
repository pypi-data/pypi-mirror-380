...
class test_MPICommandServer(unittest.TestCase):
    ...
    Current workarounds for CASA 6:

    - `unittest`: runs tests in alphabetical order. The names 'test_0_MPIInterface',
    'test_0_MPiCommandClient puts them before this test_MPICommandServer.

    - `pytest`: the order of execution of tests follows the order of appearance in the file.
    For that case, this test class should remain the last in the file (or be run separately).
    """
