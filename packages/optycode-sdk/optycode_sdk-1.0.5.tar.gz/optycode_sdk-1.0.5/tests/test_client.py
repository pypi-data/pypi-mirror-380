...
class OptycodeAPI:
    ...
    def log_data(self, user_question: str, model_answer: str, model_id: int, session_id: None, model_input: None) -> dict:
        """
    ...
    def log_data_async(self, user_question: str, model_answer: str, model_id: int, session_id: None, model_input: None):
        payload = {
            "timestamp": datetime.now().isoformat(),
            "question": user_question,
            "answer": model_answer,
...
client.log_data_async(user_question="routing question no returns", model_answer="the answer in the test", model_id=2, session_id=2, model_input="last test no returns")
