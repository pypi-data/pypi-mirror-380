...
class MetadataWithStatus(object):
    ...
    def __init__(self, created_date=None, created_by=None, created_by_user_id=None, last_modified_date=None, last_modified_by=None, last_modified_by_user_id=None, resource_urn=None, state=None, message=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def state(self):
        """Gets the state of this MetadataWithStatus.  # noqa: E501

        The resource state.  # noqa: E501

        :return: The state of this MetadataWithStatus.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this MetadataWithStatus.

        The resource state.  # noqa: E501

        :param state: The state of this MetadataWithStatus.  # noqa: E501
        :type state: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this MetadataWithStatus.  # noqa: E501
        ...
        :return: The message of this MetadataWithStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this MetadataWithStatus.

        A human readable message describing the current state. In case of an error, the message will contain a detailed error message.   # noqa: E501

        :param message: The message of this MetadataWithStatus.  # noqa: E501
        :type message: str
        """
