...
class MetadataWithStatusAllOf(object):
    ...
    @property
    def state(self):
        """Gets the state of this MetadataWithStatusAllOf.  # noqa: E501

        The resource state.  # noqa: E501

        :return: The state of this MetadataWithStatusAllOf.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this MetadataWithStatusAllOf.

        The resource state.  # noqa: E501

        :param state: The state of this MetadataWithStatusAllOf.  # noqa: E501
        :type state: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this MetadataWithStatusAllOf.  # noqa: E501
        ...
        :return: The message of this MetadataWithStatusAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this MetadataWithStatusAllOf.

        A human readable message describing the current state. In case of an error, the message will contain a detailed error message.   # noqa: E501

        :param message: The message of this MetadataWithStatusAllOf.  # noqa: E501
        :type message: str
        """
