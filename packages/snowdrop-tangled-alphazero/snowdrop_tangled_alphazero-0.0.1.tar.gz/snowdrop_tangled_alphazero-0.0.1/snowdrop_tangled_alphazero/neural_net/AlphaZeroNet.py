...
class AlphaZeroNet(nn.Module):
    def __init__(self, board_size, action_size, verbose=False):
        ...
        self.nn_args = {
            ...
            # 4,002 trainable parameters
            # 'num_channels': 8,
            # 'num_res_blocks': 2,
            # 'first_out_layer_size': 16,
            # 'second_out_layer_size': 32

            # 34,188 trainable parameters -- for paper, used for all NNs up to but not including Moser
            'num_channels': 16,
            'num_res_blocks': 2,
            'first_out_layer_size': 32,
            'second_out_layer_size': 64

            # 223,437 trainable parameters -- for paper, used for Moser Spindle
            # 'num_channels': 32,
            # 'num_res_blocks': 5,
            ...
            # 6,056,015 trainable parameters  -- for paper, used for mutant C_60
            # 'num_channels': 128,
            # 'num_res_blocks': 9,
