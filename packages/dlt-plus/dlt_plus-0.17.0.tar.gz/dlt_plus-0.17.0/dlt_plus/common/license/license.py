...
from dlt_plus.common.license.exceptions import (
...
class LicenseContext(ContainerInjectableContext):
    ...
    def reload(self) -> None:
        ...
        self.license = validate_license(license_string)
...
def create_self_signed_license(scope: str, additional_scopes: Set[str] = None) -> str:
