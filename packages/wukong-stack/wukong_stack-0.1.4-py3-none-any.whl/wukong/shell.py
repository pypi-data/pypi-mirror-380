...
class WukongShell:
    ...
    def start(self):
        click.echo(PROMPT)
        click.echo(
            "Welcome to the Wukong interactive shell! Type 'exit' to quit; 'edit' for multi-line input; 'clear history' to clear conversation history; 'save history' to save conversation history."
        )
        while True:
            try:
                ...
                click.echo("\n\n")  # For a new line after the response
