...
/* src/icons/stopped_topology.svg*/
skadi.icon_stopped_topology = 'data:image/svg+xml;base64,';

/* src/icons/running_topology.svg*/
skadi.icon_running_topology = 'data:image/svg+xml;base64,';
...
skadi.TopologyStore = class extends skadi.StoreBase {
    ...
    constructor(workspace_id, designer_or_application, in_memory) {
        super()
    ...
    async create_topology(topology_id, from_topology_id) {
        ...
        if (from_topology_id) {
            ...
            if (!(await this.topology_exists(from_topology_id))) {
                // existing topology does not exist, see if it defined as a template
                if (this.options.templates && from_topology_id in this.options.templates) {
                    await this.load_from_url(this.options.templates[from_topology_id].url,topology_id);
                }
            } else {
        ...
        // register the topology in the workspace
    ...
    async load_topology(topology_id) {
        let exists = await this.topology_exists(topology_id);
        if (!exists && this.options.templates && topology_id in this.options.templates) {
            await this.load_from_url(this.options.templates[topology_id].url, topology_id);
        }
    ...
    async load_from_url(url, into_topology_id) {
        let r = await fetch(url);
        let blob = await r.blob();
        let db = new hyrrokkin_engine.ClientStorage(this.get_topology_path(into_topology_id));
        try {
            await this.load_db(blob, db);
            let ws = await this.open_workspace();
            try {
                await ws.set_item(into_topology_id, {});
            } finally {
                ws.close();
            }
        } finally {
    ...
    async load_from(file) {
        try {
            ...
            try {
                let topology_object = await this.load_db(file, db);
    ...
    async load_db(from_blob, db) {
        ...
        for (let idx = 0; idx < entries.length; idx++) {
            ...
            if (name_components[0] === "node") {
                ...
                if (this.designer_or_application && this.designer_or_application.get_network().has_node(node_id)) {
...
skadi.Api = class {
    ...
    async load_schema(package_urls) {
        let load_package_from_url = async (url,schema) => {
            ...
            let overlay_content = await fetch(url+"/ui-overlay.json");
            let overlay_config = await overlay_content.json();
            let combined_config = this.merge_config(overlay_config,schema_config);
            await schema.load_package(url, combined_config);
        }
...
skadi.Api.EXECUTION_STATE_RUNNING = "running";
skadi.Api.EXECUTION_STATE_COMPLETED = "completed";
...
skadi.DirectoryApi = class extends skadi.Api {
    ...
    make_create_topology_callback() {
        return async () => {
            ...
            if (!(topology_id in this.topology_metadata)) {
                let splash_screen = new skadi.Alert("Copying...", {});
    ...
    draw(initial_topologies) {
        ...
        for(let topology_id in initial_topologies) {
            this.add_topology(topology_id, initial_topologies[topology_id]["metadata"], initial_topologies[topology_id]["status"]);
        }
    ...
    add_topology(topology_id, metadata, status) {
        if (topology_id in this.topologies) {
            return; // already exists?
        }
        this.topology_metadata[topology_id] = metadata || {};
        this.topology_status[topology_id] = status || {"running":false};
    ...
    topology_removed(topology_id) {
        ...
        if (topology_id in this.topology_status) {
            delete this.topology_status[topology_id];
        }
        this.update_copy_options();
    }
    ...
    topology_status_updated(topology_id, updated_status) {
        this.topology_status[topology_id] = updated_status;
        if (this.options.show_status) {
            this.render_status(this.topologies[topology_id].status_img,updated_status);
        }
    }
    ...
    render_topology(topology_id) {
        ...
        let status = this.topology_status[topology_id] || "";
        ...
        let status_img = null;
        if (this.options.show_status) {
            status_img = label.append("img");
            this.render_status(status_img,status);
        }
        ...
        if (metadata["has_template"]) {
            ...
            div.append("div").attr("exo-1-cell").append("input").attr("type", "button").attr("value", reload_label).on("click", async (evt) => {
                await this.reload_topology(topology_id);
            });
        } else {
            let remove_label = this.l10n_utils.localise("directory.remove");
            div.append("div").attr("exo-1-cell").append("input").attr("type", "button").attr("value", remove_label).on("click", async (evt) => {
                await this.remove_topology(topology_id);
            });
        }
        ...
        if (status_img) {
            this.topologies[topology_id]["status_img"] = status_img;
        }
    }
    ...
    render_metadata(tbl, metadata) {
        ...
        if (metadata["has_template"]) {
            let tr = tbl.append("tr");
            let lkey = this.l10n_utils.localise("directory.loaded_from_template");
            tr.append("td").text(lkey + ":");
        }
    }

    render_status(status_img, status) {
        if (status && status["running"]) {
            status_img.attr("src", skadi.icon_running_topology).style("vertical-align", "text-top").style("margin-left", "10px");
        } else {
            status_img.attr("src", skadi.icon_stopped_topology).style("vertical-align", "text-top").style("margin-left", "10px");
        }
    }
