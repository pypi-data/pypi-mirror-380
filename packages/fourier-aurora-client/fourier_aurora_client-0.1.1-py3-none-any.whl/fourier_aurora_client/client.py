...
from .aurora_state_map import WholeBodyFsmState, UpperBodyFsmState, VelocityCommandSource
    ...
    def __new__(cls, domain_id, participant_qos, robot_name, serial_number):
        if not cls._instance:
            ...
            try:
                ...
                cls._instance = None
                raise RuntimeError(f"Failed to initialize AuroraClient: {e}")
    ...
    def get_instance(cls, domain_id: int =123, participant_qos = 0, robot_name: str = "gr2t2v2", serial_number = None) -> "AuroraClient":
        if cls._instance is None:
            try:
                ...
                print(f"Error getting AuroraClient instance: {e}")
        return cls._instance
