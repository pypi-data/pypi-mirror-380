...
class EditEntryDialog:
    ...
    def setup_ui(self):
        ...
        entry_id_widget = ttk.Entry(main_frame, textvariable=self.entry_id_var, state="readonly", width=20)
        entry_id_widget.grid(row=0, column=1, sticky=(tk.W, tk.E), pady=(0, 5))
        ...
        description_widget = ttk.Entry(main_frame, textvariable=self.description_var, width=40)
        description_widget.grid(row=2, column=1, sticky=(tk.W, tk.E), pady=(0, 5))
