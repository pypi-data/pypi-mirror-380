...
impl CodegenExtension for QirCodegenExtension {
        ...
        Self: 'a,
    {
        builder
            ...
            // todo melf impl CodegenExtension for RandomCodegenExtension {
            // https://github.com/CQCL/tket2/blob/6578240d1974f4f2855b3ed6c59a3412fe6eda94/tket-qsystem/src/llvm/random.rs#L20
            .custom_type(
                (
