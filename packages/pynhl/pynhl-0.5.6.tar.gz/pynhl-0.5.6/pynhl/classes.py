            ...
            if plays != []:
                for i in range(-1, -15, -1):
                    ...
                    if event_type == "goal":
                        ...
                        assist1_player_id = plays[i]["details"].get("assist1PlayerId")
                        assist1_player_total = plays[i]["details"].get("assist1PlayerTotal")
                        ...
                        assist2_player_id = plays[i]["details"].get("assist2PlayerId")
                        assist2_player_total = plays[i]["details"].get("assist2PlayerTotal")
    ...
    def linescore_info(self):
        ...
        if response.ok:
            try:
                ...
                current_period_type = data["periodDescriptor"]["periodType"]
