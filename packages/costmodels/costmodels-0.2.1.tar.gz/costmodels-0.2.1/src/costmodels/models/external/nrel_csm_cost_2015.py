...
class GearboxCost2015(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            50.0,
            units="USD/kN/m",
            desc="In 2024, modern 5-7MW gearboxes cost approx $50/kNm",
        )
    ...
    def compute(self, inputs, outputs):
        ...
        outputs["gearbox_cost"] = (
            inputs["gearbox_mass"]
            * inputs["gearbox_torque_density"]
            * inputs["gearbox_torque_cost"]
            * 1e-3
        )
...
class Turbine_CostsSE_2015(om.Group):
    ...
    def setup(self):
        ...
        self.set_input_defaults("gearbox_torque_density", units="N*m/kg", val=200.0)
        self.set_input_defaults("gearbox_torque_cost", units="USD/kN/m", val=50.0)
