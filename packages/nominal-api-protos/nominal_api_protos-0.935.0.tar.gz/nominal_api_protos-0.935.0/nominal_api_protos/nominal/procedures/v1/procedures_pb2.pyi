...
class ProcedureState(_message.Message):
    __slots__ = ("deprecated_global_fields", "global_fields", "nodes", "section_edges", "step_edges")
    class DeprecatedGlobalFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
    ...
    class StepEdgesEntry(_message.Message):
        ...
        value: NodeList
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[NodeList, _Mapping]] = ...) -> None: ...
    DEPRECATED_GLOBAL_FIELDS_FIELD_NUMBER: _ClassVar[int]
    ...
    deprecated_global_fields: _containers.MessageMap[str, FormField]
    global_fields: _containers.RepeatedCompositeFieldContainer[FormField]
    ...
    def __init__(self, deprecated_global_fields: _Optional[_Mapping[str, FormField]] = ..., global_fields: _Optional[_Iterable[_Union[FormField, _Mapping]]] = ..., nodes: _Optional[_Mapping[str, ProcedureNode]] = ..., section_edges: _Optional[_Mapping[str, NodeList]] = ..., step_edges: _Optional[_Mapping[str, NodeList]] = ...) -> None: ...
...
class NestedProcedure(_message.Message):
    __slots__ = ("title", "description", "steps", "deprecated_global_fields", "global_fields")
    class DeprecatedGlobalFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    deprecated_global_fields: _containers.MessageMap[str, FormField]
    global_fields: _containers.RepeatedCompositeFieldContainer[FormField]
    def __init__(self, title: _Optional[str] = ..., description: _Optional[str] = ..., steps: _Optional[_Iterable[_Union[NestedProcedureNode, _Mapping]]] = ..., deprecated_global_fields: _Optional[_Mapping[str, FormField]] = ..., global_fields: _Optional[_Iterable[_Union[FormField, _Mapping]]] = ...) -> None: ...
