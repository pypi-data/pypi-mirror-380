...
class RunTool:
    ...
    def run_command(
        ...
        SUCCESS DEFINITION:
        - success=True: Command was executed (regardless of exit code)
        - success=False: Tool error (timeout, cleanup failed, invalid state, etc.)
        ...
        Returns:
            Dict with simplified output format: success, output, message
        """
