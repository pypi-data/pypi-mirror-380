...
def execute_query(
    ...
    It works by temporarily replacing the show method to capture the DataFrame
    ...
    original_show = ListBackend.show
    ListBackend.show = capture.create_capture_show_method()
    ...
    try:
        ...
        ListBackend.show = original_show
