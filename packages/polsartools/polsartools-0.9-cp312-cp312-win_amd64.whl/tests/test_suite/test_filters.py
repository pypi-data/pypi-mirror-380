...
from polsartools.preprocess.filters import rlee

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

def test_filters_processing(verbose=False):
    ...
    window_size = 5
    if verbose:
        logger.info("Applying RLEE filter...")
    rlee(T3_folder, win=window_size, sub_dir=False)
