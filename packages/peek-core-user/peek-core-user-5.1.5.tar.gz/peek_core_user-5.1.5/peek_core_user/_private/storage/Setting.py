...
FIELD_OTP_LOGIN_GROUP = PropertyKey(
    "Field OTP Login Group",
    "peek-field-app-otp-login",
    propertyDict=globalProperties,
)
FIELD_LOGIN_GROUP = PropertyKey(
    "Field Login Group", "peek-field-app-login", propertyDict=globalProperties
)
...
OFFICE_LOGIN_GROUP = PropertyKey(
    "Office Login Group", "peek-office-app-login", propertyDict=globalProperties
)
...
# =============================================================================
# ONE TIME PASSCODE PROPERTIES
# =============================================================================

oneTimePasscodeProperties = {}


def oneTimePasscodeSetting(ormSession, key=None, value=None):
    return _getSetting(
        ormSession,
        "One Time Passcode",
        oneTimePasscodeProperties,
...
OTP_NUMBER_OF_WORDS = PropertyKey(
    "One Time Passcode: Number of Words",
    5,
    propertyDict=oneTimePasscodeProperties,
)

OTP_NUMBER_OF_OPTIONS = PropertyKey(
    "One Time Passcode: Number of Options",
    20,
    propertyDict=oneTimePasscodeProperties,
)

OTP_VALID_SECONDS = PropertyKey(
    "One Time Passcode: Valid Seconds",
    180,
    propertyDict=oneTimePasscodeProperties,
)
