...
class FrontendBuilderABC(BuilderABC):
    ...
    def _loadPluginConfigs(self) -> [PluginDetail]:
        ...
        for plugin in self._loadedPlugins:
            ...
            moduleDirAdmin = jsonCfgNode.moduleDirAdmin(None)
            if moduleDirAdmin and not self.isAdmin:
                raise Exception("moduleDirAdmin can only be set for admin-app")
            ...
            def checkRootComponents(rootComponentArg):
                rootComponentArg["selector"] = rootComponentArg.get("selector")
    ...
    def _syncPluginFiles(
        ...
        for pluginDetail in pluginDetails:
            ...
            self.fileSync.addSyncMapping(
                ...
                deleteExtraDstFiles=deleteExtraDstFiles,
            )
