...
class _Notifier(ACIProcessorStatusNotifierABC):
    ...
    def setProcessorStatus(self, state: bool, queueSize: int):
        ...
        self._adminStatusController.status.rawValueQueueLastUpdateDate = (
    ...
    def setProcessorTableTotal(self, total: int):
        ...
        self._adminStatusController.status.rawValueTableTotal = total
        self._adminStatusController.status.rawValueQueueLastTableTotalUpdate = (
            datetime.now(timezone.utc)
        )
        self._adminStatusController.notify()
