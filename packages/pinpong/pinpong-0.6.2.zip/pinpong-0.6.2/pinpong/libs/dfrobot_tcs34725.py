...
class TCS34725:
  ...
  def _error_handling(self, lens=0):
    result = [0] * lens
    self._connect += 1
    print("tcs34725 iic communication faild, please wait")
    time.sleep(0.5)
    return result
  ...
  def write_reg (self, reg, value):
    ...
    while True:
      ...
      if self._connect > self.ERROR_COUNT:
        raise ValueError("Please check the tcs34725 connection or Reconnection sensor!!!")
  ...
  def read_reg(self, reg):
    ...
    while True:
      try:
        result = self.i2c.readfrom_mem(self.TCS34725_ADDRESS, reg, 1)
        return result
      except:
        result = self._error_handling(1)
      if self._connect > self.ERROR_COUNT:
        raise ValueError("Please check the tcs34725 connection or Reconnection sensor!!!")
  ...
  def read_reg_word(self, reg):
    ...
    while True:
      try:
        result = self.i2c.readfrom_mem(self.TCS34725_ADDRESS, reg, 2)
        return result
      except:
        result = self._error_handling(2)
      if self._connect > self.ERROR_COUNT:
        raise ValueError("Please check the tcs34725 connection or Reconnection sensor!!!")
