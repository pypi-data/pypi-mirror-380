...
class BMM150_I2C(BMM150):
  def __init__(self, i2c_addr = 0x13, bus_num = 0):
  ...
  def _error_handling(self, lens=0):
    result = [0] * lens
    self._connect += 1
    print("BMM150 iic communication faild, please wait")
    time.sleep(0.5)
    return result
  ...
  def write_reg(self, reg, data):
    ...
    while True:
      ...
      if self._connect > self.ERROR_COUNT:
        raise ValueError("Please check the BMM150 connection or Reconnection sensor!!!")
  '''
