...
class BME280:
  ...
  def __init__(self, board=None, i2c_addr=0x77, bus_num=0):
    ...
    self._sCalib_p8 = 0
    self._sCalib_p9 = 0
    self._sCalibHumi_h1 = 0
    self._sCalibHumi_h2 = 0
    self._sCalibHumi_h3 = 0
    self._sCalibHumi_h4 = 0
    self._sCalibHumi_h5 = 0
    self._sCalibHumi_h6 = 0
    self._sCalibHumi_h4 = 0
    self._sCalibHumi_h5 = 0
    self.reset()
  ...
  def _error_handling(self, lens=0):
    result = [0] * lens
    self._connect += 1
    print("Bme280 iic communication faild, please wait")
    time.sleep(0.5)
    return result
  ...
  def read_reg(self, reg, lens):
    ...
    while True:
      try:
        result = self.i2c.readfrom_mem(self.i2c_addr, reg, lens)
        return result
      except:
        result = self._error_handling(lens)
      if self._connect > self.ERROR_COUNT:
        raise ValueError("Please check the bme280 connection or Reconnection sensor!!!")
