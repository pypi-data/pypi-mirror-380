...
class MCP4725():
  ...
  2048, 1648, 1264,  910,  600,  345,  156,   39,
    ...
    def _error_handling(self, lens=0):
        result = [0] * lens
        self._connect += 1
        print("mcp4725 iic communication faild, please wait")
        time.sleep(0.5)
        return result
    ...
    def write_reg(self, reg, value):
        ...
        while True:
            ...
            if self._connect > self.ERROR_COUNT:
                raise ValueError("Please check the mcp4725 connection or Reconnection sensor!!!")
    
    def read_reg(self, reg, len):
        self._connect = 0
        while True:
            try:
                result = self._i2c.readfrom_mem(self.i2c_addr, reg, len)
                return result
            except:
