...
#buzzer.play(buzzer.ENTERTAINER, buzzer.OnceInBackground) #后台播放音乐一次
#buzzer.play(buzzer.DADADADUM,buzzer.Once)
#buzzer.play(buzzer.ENTERTAINER, buzzer.Forever) #永久播放
buzzer.play(buzzer.FUNK, buzzer.ForeverInBackground) #后台一直播放
...
buzzer.redirect(Pin.P23) #引脚重定向，只支持PWM引脚
buzzer.pitch(494, 8) #播放音符
...
buzzer.redirect(Pin.P26) #引脚重定向，只支持PWM引脚
buzzer.pitch(494, 8) #播放音符
buzzer.play(buzzer.DADADADUM,buzzer.Once)
while True:
  led.value(1) #输出高电平
