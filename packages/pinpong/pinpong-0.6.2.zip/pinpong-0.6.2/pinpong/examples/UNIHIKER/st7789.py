...
res = Pin(pin=6, mode=Pin.OUT)
lcd = ST7789_SPI(width=240, height=320, bus_num=0,device_num=0, dc=dc, res=res) #初始化屏幕
lcd.reset()
...
lcd.text(string, 0, 10, lcd.COLOR_WHITE)     #打印文字（text,x,y,color）
