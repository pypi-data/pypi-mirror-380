...
pub fn read_until_pixels(
    ...
    // TODO accept multiple stop tag formats e.g. keyword
    // TODO implement max_size
    let mut tags = Vec::new();
    tags.extend(stop_tags);
    tags.extend(PIXEL_TAGS);
    let result = find_tag_offset(file, 10_000_000, &tags)
