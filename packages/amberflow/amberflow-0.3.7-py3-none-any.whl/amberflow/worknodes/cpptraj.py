...
class BaseCpptrajAnalysis(BaseAnalysis):
...
class ImageFit(BaseCpptrajAnalysis):
    ...
    def fill_output_artifacts(self, sysname: str, *, out_top: filepath_t, out_trj: filepath_t) -> ArtifactContainer:
...
class CpptrajDefault(BaseCpptrajAnalysis):
    ...
    def _run(
        ...
        **kwargs,
        ...
        out_top = self.work_dir / in_top.name
        shutil.copy(in_top, out_top)
        self.output_artifacts = self.fill_output_artifacts(sysname, out_top=out_top)
