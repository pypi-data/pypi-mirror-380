...
class FlowBuild1(BaseFlow):
    ...
    def __init__(
        ...
        bafeb = BuildAFEBoxes(wnid=f"bafeb_{self.name}", to_guess=to_guess, solvent=solvent, skippable=skippable)
        ...
        gtc = GenerateTopology(
            wnid=f"gtc_{self.name}", solvent=solvent, ions=ions, box_or_oct=box_or_oct, skippable=skippable
        )
        ...
        gtb = GenerateTopology(
            wnid=f"gtb_{self.name}", solvent=solvent, ions=ions, box_or_oct=box_or_oct, skippable=skippable
        )
