...
class FlowRoeRelax1(BaseFlow):
    ...
    def __init__(
        ...
        *,
        ...
        crs_min_complex = CreateReferenceStructure(wnid=f"crs_min_complex_{self.name}")
        crs_min_binder = CreateReferenceStructure(wnid=f"crs_min_binder_{self.name}")
        ...
        density_params_binder0 = MDRestrainedParameters(
        ...
        density0_binder = MDRun(
            ...
            mdparameters=density_params_binder0,
            skippable=skippable,
        )
        density1_params_binder = attrs.evolve(density_params_binder0, nstlim=nstlim_density_equilibration)
        ...
        density_params_complex0 = attrs.evolve(density_params_binder0, restraintmask=complex_noh_restraint_mask)
        density0_complex = MDRun(
            wnid=f"density0_complex_{self.name}",
            mdin_template="md_restrained",
            mdparameters=density_params_complex0,
            skippable=skippable,
        )
        density_params_complex1 = attrs.evolve(density_params_complex0)
        density1_complex = MDRun(
            wnid=f"density1_complex_{self.name}",
            mdin_template="md_restrained",
            mdparameters=density_params_complex1,
            skippable=skippable,
        )
