...
| bootstrap.image.tag | string | `"38.2.0-v0.3.0"` | The specific image tag to use for the bootstrap container |
...
| configure.rses.STORAGE-1.protocols[0].scheme | string | `"root"` |  |
...
| configure.rses.STORAGE-2.protocols[0].scheme | string | `"root"` |  |
...
| iam.bootstrap.extraVolumes[3].secret.defaultMode | int | `272` |  |
...
| iam.bootstrap.extraVolumes[6].secret.defaultMode | int | `272` |  |
...
| rucio-server.image.tag | string | `"38.2.0-v0.3.0"` | The specific image tag to deploy |
