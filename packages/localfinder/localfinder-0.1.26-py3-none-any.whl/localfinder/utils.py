...
def find_significantly_different_regions(
    ...
    df_pos_regs = df_pos_avgHMC_avgES[['chr', 'start', 'end', 'avg_HMC']]
    ...
    df_neg_regs = df_neg_avgHMC_avgES[['chr', 'start', 'end', 'avg_HMC']]
    ...
    df_pos_regs.sort_values('avg_HMC', ascending=False, inplace=True)
    ...
    df_neg_regs.sort_values('avg_HMC', ascending=False, inplace=True)
