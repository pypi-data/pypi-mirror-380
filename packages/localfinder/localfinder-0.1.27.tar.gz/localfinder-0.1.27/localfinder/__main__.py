...
def main():
    ...
    subparsers = parser.add_subparsers(
        dest="command", required=True, title="Sub-commands", metavar="{bin,calc,findreg,viz,pipeline}"  
    )
    ...
    g_method.add_argument('--norm_method', choices=['scale', 'cpm', 'rpkm'], default='rpkm',
    ...
    g_calc.add_argument("--FC_thresh", type=float, default=1.5,
                        help="Fold-change threshold used as log base in enrichment.")
    g_calc.add_argument('--norm_method', choices=['scale', 'cpm', 'rpkm'], default='rpkm',
                        help='Normalisation strategy.')
