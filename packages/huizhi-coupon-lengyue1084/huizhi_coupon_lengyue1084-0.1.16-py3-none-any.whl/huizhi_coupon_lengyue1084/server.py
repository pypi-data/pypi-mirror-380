...
class ApiEndpoints(Enum):
    ...
    BASEURL = "http://192.168.2.100:8179/func"
...
def list_takeaway_coupons(
        ...
        search_id: Annotated[str, Field(description="仅搜索场景分页使用，首次调用不用填", default="0")],
...
def get_takeaway_promotion_link(
        link_type: Annotated[int, Field(
            description="转链类型 1 H5长链接；2 H5短链接；3 deeplink(唤起)链接；4 微信小程序唤起路径；5 团口令；6 小程序码",default=2)],
