...
# 上线要求替换成实际的配置信息
CATEGORY_DICT = {
    "takeaway_coupons": 1,  # 外卖商品券
    "restaurant_coupons": 2,  # 美食优惠券
    "entertainment_coupons": 3,  # 休闲娱乐
    "hotel_coupons": 4,  # 酒店民宿
    "travel_coupons": 5,  # 门票度假
    "medical_coupons": 6,  # 医药
}
# 渠道
SOURCE_DICT = {
    "meituan": 1,
...
class ApiEndpoints(Enum):
    """请求地址"""
    BASEURL = "https://www.sit.agentsyun.com/api/singleFunc"
    # BASEURL = "https://www.agentsyun.com/api/singleFunc"
    # 查询指定类目的优惠券列表
    COUPON_LIST_CATEGORY = "/openapi/recommend/coupon/list/category"
    # 查询指定类目的优惠券列表
    GET_SHORT_LINK = "/openapi/recommend/coupon/referral/link"
...
def list_takeaway_coupons(
        search_text: Annotated[str, Field(description="搜索关键词,券名、店铺名称")] = "",
        search_id: Annotated[str, Field(description="仅搜索场景分页使用，首次调用不用填")] = "",
        size: Annotated[str, Field(description="每页显示条数")] = "10",
        current: Annotated[str, Field(description="当前页")] = "1",
