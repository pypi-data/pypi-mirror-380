...
class EmailReportConfig(object):
    ...
    """
    openapi_types = {
        'alert_criteria': 'dict(str, object)',
    ...
    def __init__(self, alert_criteria=None, data_views=None, email_subject=None, email_template_id=None, from_email=None, send_to_list=None):  # noqa: E501
        ...
        if alert_criteria is not None:
            self.alert_criteria = alert_criteria
    ...
    def alert_criteria(self):
        """Gets the alert_criteria of this EmailReportConfig.  # noqa: E501


        :return: The alert_criteria of this EmailReportConfig.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self._alert_criteria

    @alert_criteria.setter
    def alert_criteria(self, alert_criteria):
        """Sets the alert_criteria of this EmailReportConfig.


        :param alert_criteria: The alert_criteria of this EmailReportConfig.  # noqa: E501
        :type: dict(str, object)
        """

        self._alert_criteria = alert_criteria
