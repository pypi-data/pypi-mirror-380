...
class AggregationTaskMetric(object):
    ...
    def __init__(self, add=None, average=None, avg=None, collect=None, collect_set=None, constant=None, count=None, count_distinct=None, count_distinct_approx=None, cumulative=None, cumulative_count=None, cumulative_sum=None, divide=None, implode=None, kurtosis=None, max=None, min=None, multiply=None, percentage=None, percentile_lookup=None, sample_standard_deviation=None, sample_stddev=None, skewness=None, standard_deviation=None, stddev=None, subtract=None, sum=None, variance=None):  # noqa: E501
    ...
    @property
    def max(self):
        """Gets the max of this AggregationTaskMetric.  # noqa: E501


        :return: The max of this AggregationTaskMetric.  # noqa: E501
        :rtype: UnaryMetric
        """
        return self._max
    ...
    @max.setter
    def max(self, max):
        """Sets the max of this AggregationTaskMetric.


        :param max: The max of this AggregationTaskMetric.  # noqa: E501
        :type: UnaryMetric
        """
