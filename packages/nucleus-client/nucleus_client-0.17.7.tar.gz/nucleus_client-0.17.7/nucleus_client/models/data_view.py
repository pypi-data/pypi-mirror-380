...
class DataView(object):
    ...
    attribute_map = {
        ...
        'intervals': 'intervals',
        'is_data_table_request': 'is_data_table_request',
        'limit': 'limit',
        'lookups': 'lookups',
        'metrics': 'metrics',
        'mode': 'mode',
    ...
    def __init__(self, all_dimensions=None, all_fields=None, client_id=None, columns=None, dataset=None, dimensions=None, exclude_future=None, filters=None, granularity=None, id=None, include_goals=None, intervals=None, is_data_table_request=None, limit=None, lookups=None, metrics=None, mode=None, query_type=None, sort=None, unique_limit=None):  # noqa: E501
        ...
        self._is_data_table_request = None
        self._limit = None
        self._lookups = None
        self._metrics = None
        self._mode = None
        ...
        if is_data_table_request is not None:
            self.is_data_table_request = is_data_table_request
    ...
    @property
    def is_data_table_request(self):
        """Gets the is_data_table_request of this DataView.  # noqa: E501


        :return: The is_data_table_request of this DataView.  # noqa: E501
        :rtype: bool
        """
        return self._is_data_table_request

    @is_data_table_request.setter
    def is_data_table_request(self, is_data_table_request):
        """Sets the is_data_table_request of this DataView.


        :param is_data_table_request: The is_data_table_request of this DataView.  # noqa: E501
        :type: bool
        """

        self._is_data_table_request = is_data_table_request
