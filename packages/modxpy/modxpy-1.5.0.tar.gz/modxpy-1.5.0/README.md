...
MAJOR UPDATE! Replaced function modules_added()
with dependencies() instead because imported()
and modximported() shows modules imported anyway.

dependencies(): type in a module name and returns
the modules dependencies that comes with it!

COMPLETELY fixed imported() and modximported()
counting and listing bugs.
