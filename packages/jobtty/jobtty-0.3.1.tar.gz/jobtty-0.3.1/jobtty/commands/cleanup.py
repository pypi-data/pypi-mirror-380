    ...
    for i, search in enumerate(searches):
        ...
        for j, other_search in enumerate(searches[i+1:], i+1):
            ...
            if search.location and other_search.location:
                ...
                location_sim = 0.5  # One has location, other doesn't
            
            # Combined similarity score
            combined_sim = (query_sim * 0.7) + (location_sim * 0.3)
...
@click.option('--threshold', type=float, default=0.8, help='Similarity threshold for duplicates (0.0-1.0)')
