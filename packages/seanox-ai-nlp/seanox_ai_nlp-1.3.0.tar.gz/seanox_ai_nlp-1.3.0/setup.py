...
setup(
    ...
    keywords=[
        ...
        # logics
        "semantic logic",
        "logic composition", "logic builder", "logic assembly", "logic chain",
        "logic normalization", "logic parsing", "logic mapping",
        "logical structure", "logical operators", "boolean logic"
    ]
)
