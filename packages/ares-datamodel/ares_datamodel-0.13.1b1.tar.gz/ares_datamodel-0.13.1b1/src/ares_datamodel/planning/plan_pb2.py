...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PLANNINGREQUEST']._serialized_end = 260
    _globals['_PLANNINGRESPONSE']._serialized_start = 262
    _globals['_PLANNINGRESPONSE']._serialized_end = 351
    _globals['_PLANNINGPARAMETER']._serialized_start = 354
    _globals['_PLANNINGPARAMETER']._serialized_end = 787
    _globals['_PARAMETERHISTORYINFO']._serialized_start = 790
    _globals['_PARAMETERHISTORYINFO']._serialized_end = 937
    _globals['_PLANNEDPARAMETER']._serialized_start = 940
    _globals['_PLANNEDPARAMETER']._serialized_end = 1094
    _globals['_PLANNERMETADATA']._serialized_start = 1096
    _globals['_PLANNERMETADATA']._serialized_end = 1136