...
class PlanningRequest(_message.Message):
    __slots__ = ("planning_parameters", "adapter_settings", "analysis_results")
    ...
    def __init__(self, planning_parameters: _Optional[_Iterable[_Union[PlanningParameter, _Mapping]]] = ..., adapter_settings: _Optional[_Union[_ares_struct_pb2.AresStruct, _Mapping]] = ..., analysis_results: _Optional[_Iterable[float]] = ...) -> None: ...
