...
class AssetRegisterRequest(object):
    ...
    @property
    def name(self):
        """Gets the name of this AssetRegisterRequest.  # noqa: E501

        Name of the asset  # noqa: E501

        :return: The name of this AssetRegisterRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AssetRegisterRequest.

        Name of the asset  # noqa: E501

        :param name: The name of this AssetRegisterRequest.  # noqa: E501
        :type: str
        """
        if (
    ...
    @property
    def path(self):
        """Gets the path of this AssetRegisterRequest.  # noqa: E501

        Target path under the teamspace  # noqa: E501

        :return: The path of this AssetRegisterRequest.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this AssetRegisterRequest.

        Target path under the teamspace  # noqa: E501

        :param path: The path of this AssetRegisterRequest.  # noqa: E501
        :type: str
        """
        if (
