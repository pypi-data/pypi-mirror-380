...
def ellipse_to_curve(ellipse: sp.Ellipse, parameter: str | sp.Symbol = "t") -> sp.Curve:
    """
    Convert an ellipse into a parameterized curve.

    Parameters:
    • ellipse: the ellipse to convert into curve
    • parameter: the curve's parameter
    """
    px, py = ellipse.arbitrary_point(parameter)
    t, t0, t1 = ellipse.plot_interval(parameter)
    return sp.Curve((px, py), (t, t0, t1))
