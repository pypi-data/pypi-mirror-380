...
from bot_utils import send_message, parse_ai_response, process_events, send_welcome_file
...
async def start_handler(message: Message, state: FSMContext):
    ...
    admin_manager = get_global_var('admin_manager')
    from admin_logic import admin_start_handler
    from debug_routing import debug_user_state
...
async def user_start_handler(message: Message, state: FSMContext):
    ...
    from bot_utils import parse_utm_from_start_param
...
async def message_without_state_handler(message: Message, state: FSMContext):
    ...
    from admin_logic import AdminStates
    from debug_routing import debug_user_state
