...
class ScenarioLoader:
    ...
    def load_all_scenarios_for_bot(bot_id: str) -> List[TestScenario]:
        ...
        tests_dir = Path(f"bots/{bot_id}/tests")
...
class BotTester:
    ...
    def _initialize_bot(self):
        ...
        try:
            ...
            config_dir = root_dir / 'bots' / self.bot_id
            ...
            prompts_dir = f"bots/{self.bot_id}/prompts"
    ...
    async def get_welcome_file_caption_test(self) -> str:
        ...
        try:
            ...
            folder = Path(f'bots/{bot_id}/welcome_files')
...
class ReportGenerator:
    ...
    def save_report(bot_id: str, results: List[TestResult]) -> str:
        ...
        reports_dir = f"bots/{bot_id}/reports"
...
async def main():
    ...
    try:
        ...
        if scenario_file:
            ...
            scenario_path = f"bots/{args.bot_id}/tests/{scenario_file}"
