...
class AnalyticsManager:
    ...
    # В analytics_manager.py замените функцию get_user_journey на эту:
    ...
    # Исправленная функция format_user_journey в analytics_manager.py для показа детальной истории
