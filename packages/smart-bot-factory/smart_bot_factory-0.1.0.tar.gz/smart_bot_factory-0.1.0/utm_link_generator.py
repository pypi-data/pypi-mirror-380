...
Создает ссылки в формате: @https://t.me/bot?start=utmSource-vk_utmCampaign-summer2025
"""
...
def create_utm_string(utm_data):
    """Создает строку UTM параметров в формате utmSource-vk_utmCampaign-summer2025"""
    utm_parts = []
    
    # Маппинг полей базы данных на camelCase формат
    field_mapping = {
