    ...
    def __init__(self, config: dict[str, Any] | None = None) -> None:
        ...
        Args:
            config: Dictionary containing:
                ...
                - outputs (dict)
        """
        dataloaders_registry = PluginLoadedRegistry.dataloaders_registry
        metrics_registry = PluginLoadedRegistry.metrics_registry
        outputs_registry = PluginLoadedRegistry.outputwiter_registry
