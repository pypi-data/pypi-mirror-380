...
class ConversationResponseUploadStatus(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "success": [ConversationResponseUploadStatusSuccessInner.from_dict(_item) for _item in obj["success"]] if obj.get("success") is not None else None,
            "failure": [ConversationResponseUploadStatusFailureInner.from_dict(_item) for _item in obj["failure"]] if obj.get("failure") is not None else None
        })
        return _obj
