...
def buildUI(data, title, description=None, directions=[]):
    app = _UIConstructor(data, toolTitle=title, description=description, directions=directions)
...
class _UIConstructor(ctk.CTk):
    def __init__(self, dataModel: DataModel, toolTitle: str = "IntraDev GUI", description=None, directions = [], browseFirstInput: bool = True):
        super().__init__()
