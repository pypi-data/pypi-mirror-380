...
{order};'''
SQLT_QUERY_LATEST = '''
select eo.hashid, eo.slug, eo.title, pub_date, feedid, fo.slug, fo.title, eo.description, episode.html_url
from obj eo
...
SELECT eo.hashid, eo.slug, eo.title, episode.pub_date, episode.feedid, fo.slug, fo.title, eo.description, episode.html_url
  FROM episode
