...
class MAVLink_identifier_message(MAVLink_message):
    ...
    def __init__(self, fw_version, particle_id_full, device_id, device_name, local_ip, mac):
...
class MAVLink(object):
    ...
    def identifier_encode(self, fw_version, particle_id_full, device_id, device_name, local_ip, mac):
        """
        Indentifiying information about the EOS device
    ...
    def identifier_send(self, fw_version, particle_id_full, device_id, device_name, local_ip, mac, force_mavlink1=False):
        """
        Indentifiying information about the EOS device
