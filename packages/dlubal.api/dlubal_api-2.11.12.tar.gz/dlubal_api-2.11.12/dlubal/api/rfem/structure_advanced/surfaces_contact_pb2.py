...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n9dlubal/api/rfem/structure_advanced/surfaces_contact.proto\x12\"dlubal.api.rfem.structure_advanced\"\xbf\x02\n\x0fSurfacesContact\x12\x0f\n\x02no\x18\x01 \x01(\x05H\x00\x88\x01\x01\x12\"\n\x15surfaces_contact_type\x18\x02 \x01(\x05H\x01\x88\x01\x01\x12\x17\n\x0fsurfaces_group1\x18\x03 \x03(\x05\x12\x17\n\x0fsurfaces_group2\x18\x04 \x03(\x05\x12\x14\n\x07\x63omment\x18\x05 \x01(\tH\x02\x88\x01\x01\x12!\n\x14id_for_export_import\x18\x06 \x01(\tH\x03\x88\x01\x01\x12\'\n\x1ametadata_for_export_import\x18\x07 \x01(\tH\x04\x88\x01\x01\x42\x05\n\x03_noB\x18\n\x16_surfaces_contact_typeB\n\n\x08_commentB\x17\n\x15_id_for_export_importB\x1d\n\x1b_metadata_for_export_importb\x06proto3')
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SURFACESCONTACT']._serialized_end=417
