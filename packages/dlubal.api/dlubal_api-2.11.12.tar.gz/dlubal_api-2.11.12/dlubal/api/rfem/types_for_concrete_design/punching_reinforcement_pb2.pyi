...
class PunchingReinforcement(_message.Message):
    __slots__ = ("no", "type", "user_defined_name_enabled", "name", "nodes", "material", "placement_type", "distances_type", "number_of_perimeters", "number_of_perimeters_calculated", "number_of_perimeters_auto_enabled", "number_of_perimeters_auto_minimum", "number_of_perimeters_auto_maximum", "number_of_perimeters_auto_priority", "number_of_legs_in_each_perimeter", "number_of_legs_in_each_perimeter_calculated", "number_of_legs_in_each_perimeter_auto_enabled", "number_of_legs_in_each_perimeter_auto_minimum", "number_of_legs_in_each_perimeter_auto_maximum", "number_of_legs_in_each_perimeter_auto_priority", "perimeter_spacing_type", "multiple_static_depth_spacing_between_perimeters", "multiple_static_depth_spacing_between_perimeters_calculated", "multiple_static_depth_spacing_between_perimeters_auto_enabled", "multiple_static_depth_spacing_between_perimeters_auto_minimum", "multiple_static_depth_spacing_between_perimeters_auto_maximum", "multiple_static_depth_spacing_between_perimeters_auto_increment", "multiple_static_depth_spacing_between_perimeters_auto_priority", "multiple_static_depth_spacing_between_support_face_and_first_perimeter", "multiple_static_depth_spacing_between_support_face_and_first_perimeter_calculated", "multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_enabled", "multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_minimum", "multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_maximum", "multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_increment", "multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_priority", "absolute_spacing_between_perimeters", "absolute_spacing_between_perimeters_calculated", "absolute_spacing_between_perimeters_auto_enabled", "absolute_spacing_between_perimeters_auto_minimum", "absolute_spacing_between_perimeters_auto_maximum", "absolute_spacing_between_perimeters_auto_increment", "absolute_spacing_between_perimeters_auto_priority", "absolute_spacing_between_support_face_and_first_perimeter", "absolute_spacing_between_support_face_and_first_perimeter_calculated", "absolute_spacing_between_support_face_and_first_perimeter_auto_enabled", "absolute_spacing_between_support_face_and_first_perimeter_auto_minimum", "absolute_spacing_between_support_face_and_first_perimeter_auto_maximum", "absolute_spacing_between_support_face_and_first_perimeter_auto_increment", "absolute_spacing_between_support_face_and_first_perimeter_auto_priority", "bend_up_diameter", "bend_up_diameter_calculated", "bend_up_size_designation", "bend_up_size_designation_auto_minimum", "bend_up_size_designation_auto_maximum", "bend_up_diameter_auto_enabled", "bend_up_size_designation_auto_designations_list", "bend_up_diameter_auto_priority", "bend_up_diameter_auto_minimum", "bend_up_diameter_auto_maximum", "bend_up_diameter_auto_diameters_list_enabled", "bend_up_diameter_auto_diameters_list", "perimeter_area", "total_area", "integrated_in_surfaces", "comment", "is_generated", "generating_object_info", "different_placement_perimeters", "different_placement_perimeter_spacing_type", "id_for_export_import", "metadata_for_export_import")
    ...
    def __init__(self, no: _Optional[int] = ..., type: _Optional[_Union[PunchingReinforcement.Type, str]] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., nodes: _Optional[_Iterable[int]] = ..., material: _Optional[int] = ..., placement_type: _Optional[_Union[PunchingReinforcement.PlacementType, str]] = ..., distances_type: _Optional[_Union[PunchingReinforcement.DistancesType, str]] = ..., number_of_perimeters: _Optional[int] = ..., number_of_perimeters_calculated: _Optional[int] = ..., number_of_perimeters_auto_enabled: bool = ..., number_of_perimeters_auto_minimum: _Optional[int] = ..., number_of_perimeters_auto_maximum: _Optional[int] = ..., number_of_perimeters_auto_priority: _Optional[int] = ..., number_of_legs_in_each_perimeter: _Optional[int] = ..., number_of_legs_in_each_perimeter_calculated: _Optional[int] = ..., number_of_legs_in_each_perimeter_auto_enabled: bool = ..., number_of_legs_in_each_perimeter_auto_minimum: _Optional[int] = ..., number_of_legs_in_each_perimeter_auto_maximum: _Optional[int] = ..., number_of_legs_in_each_perimeter_auto_priority: _Optional[int] = ..., perimeter_spacing_type: _Optional[_Union[PunchingReinforcement.PerimeterSpacingType, str]] = ..., multiple_static_depth_spacing_between_perimeters: _Optional[float] = ..., multiple_static_depth_spacing_between_perimeters_calculated: _Optional[float] = ..., multiple_static_depth_spacing_between_perimeters_auto_enabled: bool = ..., multiple_static_depth_spacing_between_perimeters_auto_minimum: _Optional[float] = ..., multiple_static_depth_spacing_between_perimeters_auto_maximum: _Optional[float] = ..., multiple_static_depth_spacing_between_perimeters_auto_increment: _Optional[float] = ..., multiple_static_depth_spacing_between_perimeters_auto_priority: _Optional[int] = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter: _Optional[float] = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter_calculated: _Optional[float] = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_enabled: bool = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_minimum: _Optional[float] = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_maximum: _Optional[float] = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_increment: _Optional[float] = ..., multiple_static_depth_spacing_between_support_face_and_first_perimeter_auto_priority: _Optional[int] = ..., absolute_spacing_between_perimeters: _Optional[float] = ..., absolute_spacing_between_perimeters_calculated: _Optional[float] = ..., absolute_spacing_between_perimeters_auto_enabled: bool = ..., absolute_spacing_between_perimeters_auto_minimum: _Optional[float] = ..., absolute_spacing_between_perimeters_auto_maximum: _Optional[float] = ..., absolute_spacing_between_perimeters_auto_increment: _Optional[float] = ..., absolute_spacing_between_perimeters_auto_priority: _Optional[int] = ..., absolute_spacing_between_support_face_and_first_perimeter: _Optional[float] = ..., absolute_spacing_between_support_face_and_first_perimeter_calculated: _Optional[float] = ..., absolute_spacing_between_support_face_and_first_perimeter_auto_enabled: bool = ..., absolute_spacing_between_support_face_and_first_perimeter_auto_minimum: _Optional[float] = ..., absolute_spacing_between_support_face_and_first_perimeter_auto_maximum: _Optional[float] = ..., absolute_spacing_between_support_face_and_first_perimeter_auto_increment: _Optional[float] = ..., absolute_spacing_between_support_face_and_first_perimeter_auto_priority: _Optional[int] = ..., bend_up_diameter: _Optional[float] = ..., bend_up_diameter_calculated: _Optional[float] = ..., bend_up_size_designation: _Optional[float] = ..., bend_up_size_designation_auto_minimum: _Optional[_Union[PunchingReinforcement.BendUpSizeDesignationAutoMinimum, str]] = ..., bend_up_size_designation_auto_maximum: _Optional[_Union[PunchingReinforcement.BendUpSizeDesignationAutoMaximum, str]] = ..., bend_up_diameter_auto_enabled: bool = ..., bend_up_size_designation_auto_designations_list: _Optional[_Iterable[_Union[PunchingReinforcement.BendUpSizeDesignationAutoDesignationsList, str]]] = ..., bend_up_diameter_auto_priority: _Optional[int] = ..., bend_up_diameter_auto_minimum: _Optional[float] = ..., bend_up_diameter_auto_maximum: _Optional[float] = ..., bend_up_diameter_auto_diameters_list_enabled: bool = ..., bend_up_diameter_auto_diameters_list: _Optional[_Iterable[float]] = ..., perimeter_area: _Optional[float] = ..., total_area: _Optional[float] = ..., integrated_in_surfaces: _Optional[_Iterable[int]] = ..., comment: _Optional[str] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., different_placement_perimeters: _Optional[_Union[PunchingReinforcement.DifferentPlacementPerimetersTable, _Mapping]] = ..., different_placement_perimeter_spacing_type: _Optional[_Union[PunchingReinforcement.DifferentPlacementPerimeterSpacingType, str]] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
