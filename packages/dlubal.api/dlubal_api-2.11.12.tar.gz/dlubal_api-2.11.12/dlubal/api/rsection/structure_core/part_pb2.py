...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PART']._serialized_end=1130
  _globals['_PART_GEOMETRY']._serialized_start=744
  _globals['_PART_GEOMETRY']._serialized_end=805
