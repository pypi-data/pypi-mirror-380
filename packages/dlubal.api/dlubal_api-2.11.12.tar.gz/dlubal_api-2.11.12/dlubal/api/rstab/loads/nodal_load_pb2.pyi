...
class NodalLoad(_message.Message):
    __slots__ = ("no", "load_type", "nodes", "has_force_eccentricity", "force_eccentricity_x", "force_eccentricity_y", "force_eccentricity_z", "coordinate_system", "has_specific_direction", "specific_direction_type", "axes_sequence", "comment", "components_force", "components_force_x", "components_force_y", "components_force_z", "components_moment", "components_moment_x", "components_moment_y", "components_moment_z", "directed_to_node_direction_node", "load_direction", "force_magnitude", "generating_object_info", "is_generated", "load_case", "mass", "individual_mass_components", "mass_angle", "mass_angular_acceleration", "mass_angular_velocity", "mass_axis_of_rotation", "mass_global", "mass_has_rotational_mass", "mass_moment_of_inertia", "mass_moment_of_inertia_x", "mass_moment_of_inertia_y", "mass_moment_of_inertia_z", "mass_radius", "mass_rotational_mass", "mass_x", "mass_y", "mass_z", "moment_magnitude", "parallel_to_member", "parallel_to_two_nodes_first_node", "parallel_to_two_nodes_second_node", "rotated_about_angle_1", "rotated_about_angle_2", "rotated_about_angle_3", "rotated_about_angle_x", "rotated_about_angle_y", "rotated_about_angle_z", "has_shifted_display", "offset", "offset_x", "offset_y", "offset_z", "size_or_distance", "has_load_graphic_position_below", "id_for_export_import", "metadata_for_export_import")
    ...
    def __init__(self, no: _Optional[int] = ..., load_type: _Optional[_Union[NodalLoad.LoadType, str]] = ..., nodes: _Optional[_Iterable[int]] = ..., has_force_eccentricity: bool = ..., force_eccentricity_x: _Optional[float] = ..., force_eccentricity_y: _Optional[float] = ..., force_eccentricity_z: _Optional[float] = ..., coordinate_system: _Optional[int] = ..., has_specific_direction: bool = ..., specific_direction_type: _Optional[_Union[NodalLoad.SpecificDirectionType, str]] = ..., axes_sequence: _Optional[_Union[NodalLoad.AxesSequence, str]] = ..., comment: _Optional[str] = ..., components_force: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., components_force_x: _Optional[float] = ..., components_force_y: _Optional[float] = ..., components_force_z: _Optional[float] = ..., components_moment: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., components_moment_x: _Optional[float] = ..., components_moment_y: _Optional[float] = ..., components_moment_z: _Optional[float] = ..., directed_to_node_direction_node: _Optional[int] = ..., load_direction: _Optional[_Union[NodalLoad.LoadDirection, str]] = ..., force_magnitude: _Optional[float] = ..., generating_object_info: _Optional[str] = ..., is_generated: bool = ..., load_case: _Optional[int] = ..., mass: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., individual_mass_components: bool = ..., mass_angle: _Optional[float] = ..., mass_angular_acceleration: _Optional[float] = ..., mass_angular_velocity: _Optional[float] = ..., mass_axis_of_rotation: _Optional[_Union[NodalLoad.MassAxisOfRotation, str]] = ..., mass_global: _Optional[float] = ..., mass_has_rotational_mass: bool = ..., mass_moment_of_inertia: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., mass_moment_of_inertia_x: _Optional[float] = ..., mass_moment_of_inertia_y: _Optional[float] = ..., mass_moment_of_inertia_z: _Optional[float] = ..., mass_radius: _Optional[float] = ..., mass_rotational_mass: _Optional[float] = ..., mass_x: _Optional[float] = ..., mass_y: _Optional[float] = ..., mass_z: _Optional[float] = ..., moment_magnitude: _Optional[float] = ..., parallel_to_member: _Optional[int] = ..., parallel_to_two_nodes_first_node: _Optional[int] = ..., parallel_to_two_nodes_second_node: _Optional[int] = ..., rotated_about_angle_1: _Optional[float] = ..., rotated_about_angle_2: _Optional[float] = ..., rotated_about_angle_3: _Optional[float] = ..., rotated_about_angle_x: _Optional[float] = ..., rotated_about_angle_y: _Optional[float] = ..., rotated_about_angle_z: _Optional[float] = ..., has_shifted_display: bool = ..., offset: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., offset_x: _Optional[float] = ..., offset_y: _Optional[float] = ..., offset_z: _Optional[float] = ..., size_or_distance: _Optional[float] = ..., has_load_graphic_position_below: bool = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
