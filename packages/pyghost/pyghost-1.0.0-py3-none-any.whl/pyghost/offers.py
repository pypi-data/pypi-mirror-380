...
class Offers:
    ...
    def create(self,
        ...
        :param type: Discount type ('percent' or 'fixed')
        :type type: str
        ...
        offer_data = {
            ...
            "status": "active",  # New offers are active by default
            "tier": {"id": tier_id}
        }
    ...
    def archive(self, offer_id: str) -> Dict:
        ...
        """
        return self.update(offer_id, status="archived")
    ...
    def activate(self, offer_id: str) -> Dict:
        ...
        """
        return self.update(offer_id, status="active")
