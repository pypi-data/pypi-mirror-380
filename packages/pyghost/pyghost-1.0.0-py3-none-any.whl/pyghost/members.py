...
class Members:
    ...
    def get_paid_members(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="status:paid", include=include)
    ...
    def get_free_members(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="status:free", include=include)
        return response.get("members", [])
    ...
    def get_member_statistics(self) -> Dict:
        ...
        paid_members = self.list(filter_="status:paid", limit=1)
        free_members = self.list(filter_="status:free", limit=1)
