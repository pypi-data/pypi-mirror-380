...
class Users:
    ...
    def update(self,
        ...
        if roles is not None:
            user_data["roles"] = [
                {"id": role_id} if isinstance(role_id, str) else role_id
    ...
    def get_owners(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="role:owner", include=include)
    ...
    def get_administrators(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="role:administrator", include=include)
        return response.get("users", [])
    ...
    def get_editors(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="role:editor", include=include)
        return response.get("users", [])
    ...
    def get_authors(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="role:author", include=include)
        return response.get("users", [])
    ...
    def get_contributors(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="role:contributor", include=include)
        return response.get("users", [])
    ...
    def get_active_users(self, include: Optional[str] = None) -> List[Dict]:
        ...
        """
        response = self.list(filter_="status:active", include=include)
        return response.get("users", [])
