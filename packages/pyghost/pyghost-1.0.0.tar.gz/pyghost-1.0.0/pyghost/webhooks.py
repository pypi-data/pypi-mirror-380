...
class Webhooks:
    ...
    def create(self, event: str, target_url: str, name: Optional[str] = None,
    ...
    def get_active_webhooks(self) -> List[Dict]:
        ...
        """
        response = self.list(filter_="status:available")
        return response.get("webhooks", [])
    ...
    def get_webhook_statistics(self) -> Dict:
        ...
        stats = {
            "total": len(webhooks),
            "active": len([w for w in webhooks if w.get("status") == "available"]),
            "events": {},
            "last_triggered": None
        }
    ...
    def create_post_webhook(self, target_url: str, event: str = "post.published",
    ...
    def create_member_webhook(self, target_url: str, event: str = "member.added",
                              name: Optional[str] = None, secret: Optional[str] = None) -> Dict:
        """
