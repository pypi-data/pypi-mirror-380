...
class Posts:
    ...
    def create(self,
        ...
        Args:
            ...
            content_type: Content type ('lexical' or 'html')
        ...
        if content:
            if content_type == "lexical":
                post_data["lexical"] = content
            elif content_type == "html":
                post_data["html"] = content
            else:
                raise ValidationError("content_type must be 'lexical' or 'html'")
    ...
    def publish(self, post_id: str, updated_at: str) -> Dict:
        ...
        Returns:
            Updated post data
        """
        return self.update(post_id, updated_at, status="published")
    ...
    def schedule(self, post_id: str, updated_at: str, publish_at: Union[str, datetime]) -> Dict:
        ...
        return self.update(post_id, updated_at, status="scheduled", published_at=publish_at)
    ...
    def unpublish(self, post_id: str, updated_at: str) -> Dict:
        ...
        Returns:
            Updated post data
        """
        return self.update(post_id, updated_at, status="draft")
