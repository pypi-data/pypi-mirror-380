    ...
    def fetch_from_unity_catalog(self, ref: CatalogReference) -> Any:
        ...
        for attempt in range(max_retries):
            try:
                ...
                # Try to convert to Spark DataFrame if PySpark is available
                try:
                    ...
                    from ..models.intercepted_dataframe import InterceptedDataFrame
                    return InterceptedDataFrame(df, ref)
