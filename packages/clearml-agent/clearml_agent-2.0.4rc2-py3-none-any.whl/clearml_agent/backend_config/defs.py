...
ENV_DEBUG_EXCLUDE_LOGGERS = EnvEntry("CLEARML_AGENT_DEBUG_EXCLUDE_LOGGERS")
"""
Exclude these loggers from setting level to DEBUG when the agent's debug mode is turned on. Whitespace-separated list.
"""
