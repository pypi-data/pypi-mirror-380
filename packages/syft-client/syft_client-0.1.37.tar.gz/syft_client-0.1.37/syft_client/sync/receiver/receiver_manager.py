...
class ReceiverManager:
    ...
    def start(self, check_interval: int = 30,
        ...
        Args:
            ...
            auto_accept: Auto-accept peer requests (default: client's accept_requests setting)
        ...
        # Use client's accept_requests setting if auto_accept not explicitly provided
