...
class PeerManager:
    ...
    def _invalidate_peers_cache(self):
        """No longer needed - we don't cache peers anymore"""
        pass
    ...
    def clear_all_caches(self, verbose: bool = True) -> None:
        ...
        # No in-memory cache to clear anymore
    ...
    def _load_or_create_peer(self, email: str) -> Peer:
        """Always create fresh peer - no disk loading"""
        # Always create new peer
        peer = Peer(email=email)
        return peer
    
    def _save_peer(self, peer: Peer):
        """No longer save peers to disk - always load fresh"""
        pass
