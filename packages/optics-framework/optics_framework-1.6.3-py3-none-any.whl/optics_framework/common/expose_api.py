...
@app.post("/{deviceId}/v1/sessions/{sessionId}/action")
...
@app.get("/{deviceId}/session/{sessionId}/screenshot")
...
@app.get("/{deviceId}/session/{sessionId}/elements")
...
@app.delete(
    "/{deviceId}/v1/sessions/{sessionId}/stop", response_model=TerminationResponse
)
