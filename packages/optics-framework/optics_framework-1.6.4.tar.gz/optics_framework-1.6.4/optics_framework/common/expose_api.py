...
@app.post("/{deviceId}/v1/sessions/start", response_model=SessionResponse)
...
@app.post("/{deviceId}/v1/sessions/{session_id}/action")
...
@app.get("/{deviceId}/session/{session_id}/screenshot")
...
@app.get("/{deviceId}/v1/sessions/{session_id}/driver-id")
...
@app.get("/{deviceId}/session/{session_id}/elements")
...
@app.get("/{deviceId}/v1/sessions/{session_id}/source")
...
@app.get("/{deviceId}/v1/sessions/{session_id}/screen_elements")
...
@app.get("/{deviceId}/v1/keywords", response_model=List[KeywordInfo])
...
@app.delete(
    "/{deviceId}/v1/sessions/{session_id}/stop", response_model=TerminationResponse
)
