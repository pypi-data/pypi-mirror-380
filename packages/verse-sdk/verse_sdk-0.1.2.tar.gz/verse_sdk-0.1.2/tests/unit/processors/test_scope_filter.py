...
from verse_sdk.processors.scope_filter import ScopeFilterProcessor


class TestScopeFilterProcessor:
    ...
    def test_initialization_with_scopes(self):
        ...
        processor = ScopeFilterProcessor(self.mock_exporter, config)

        assert processor._exporter == self.mock_exporter
        assert processor._allowed_scopes == ["user", "admin"]
    ...
    def test_initialization_with_empty_scopes(self):
        ...
        assert processor._exporter == self.mock_exporter
        assert processor._allowed_scopes == []
    ...
    def test_initialization_with_none_scopes(self):
        ...
        assert processor._exporter == self.mock_exporter
        assert processor._allowed_scopes is None
