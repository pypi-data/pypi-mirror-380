...
class LatestCls:
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			- 1 Date: str: Date of the calibration as string
			- 2 Time: str: Time of the calibration as string
			- 3 Type_Py: enums.CalibType: FSCorrection | CALibration | OGCal Type of the calibration FSCorrection Correction performed in factory or service CALibration Verification in the factory OGCal Verification by the service (outgoing calibration)"""
		__meta_args_list = [
