...
class RdsDeviationCls:
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			- 1 Rds_Deviation: float: Maximum RDS deviation in Hz Range: 0 Hz to 10 kHz, Unit: Hz
			- 2 Ratio: float: Maximum RDS deviation as percentage of the multiplex deviation Range: 0 % to 100 %, Unit: %"""
		__meta_args_list = [
