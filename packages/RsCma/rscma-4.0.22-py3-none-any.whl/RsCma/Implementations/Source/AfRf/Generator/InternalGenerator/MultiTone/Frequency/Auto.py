...
class AutoCls:
	...
	class AutoStruct(StructBase):
		"""Response structure. Fields: \n
			- 1 Start_Freq: float: Frequency for tone 1 in the multitone list Range: 20 Hz to 20 kHz, Unit: Hz
			- 2 Freq_Increment: float: Frequency increment for subsequent tones in the list Range: 1 Hz to 20 kHz, Unit: Hz"""
		__meta_args_list = [
