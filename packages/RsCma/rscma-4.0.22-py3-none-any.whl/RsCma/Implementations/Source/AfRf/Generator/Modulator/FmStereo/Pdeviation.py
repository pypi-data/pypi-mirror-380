...
class PdeviationCls:
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			- 1 Max_Pilot_Deviation: float: Maximum pilot deviation in Hz Range: 0 Hz to 10 kHz, Unit: Hz
			- 2 Ratio: float: Maximum pilot deviation as percentage of the multiplex deviation Range: 0 % to 100 %, Unit: %"""
		__meta_args_list = [
