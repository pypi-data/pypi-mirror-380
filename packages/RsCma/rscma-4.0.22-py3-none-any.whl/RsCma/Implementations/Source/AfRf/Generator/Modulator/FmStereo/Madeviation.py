...
class MadeviationCls:
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			- 1 Max_Audio_Deviation: float: Maximum audio deviation in Hz Range: 0 Hz to 100 kHz, Unit: Hz
			- 2 Ratio: float: Maximum audio deviation as percentage of the multiplex deviation Range: 0 % to 100 %, Unit: %"""
		__meta_args_list = [
