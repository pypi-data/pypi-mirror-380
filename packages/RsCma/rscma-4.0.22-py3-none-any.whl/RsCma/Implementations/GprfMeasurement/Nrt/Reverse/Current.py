...
class CurrentCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 2 Power: enums.ResultStatus: Reverse power or forward power Unit: dBm
			- 3 Return_Loss: enums.ResultStatus: Unit: dB
			- 4 Reflection: enums.ResultStatus: Unit: %
			- 5 Swr: enums.ResultStatus: Standing wave ratio"""
		__meta_args_list = [
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			- 1 Reliability: int: See 'Reliability indicator values'
			- 2 Power: float: Reverse power or forward power Unit: dBm
			- 3 Return_Loss: float: Unit: dB
			- 4 Reflection: float: Unit: %
			- 5 Swr: float: Standing wave ratio"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
