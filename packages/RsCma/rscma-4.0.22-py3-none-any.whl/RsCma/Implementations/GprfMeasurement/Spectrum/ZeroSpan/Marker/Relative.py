...
class RelativeCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			- 1 Dx_Value: float: Delta X value of the marker relative to the reference marker Unit: s
			- 2 Dy_Value: float: Delta Y value of the marker relative to the reference marker Unit: dB"""
		__meta_args_list = [
