...
class MaximumCls:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- 2 Level_Peak: float: Delta peak level of the AC component of the measured AF signal. Unit: %
			- 3 Level_Rms: float: Effective (RMS-averaged) delta level of the AC component of the measured AF signal. Unit: %"""
		__meta_args_list = [
