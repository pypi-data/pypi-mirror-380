...
SpecificAuthorization = Union[BearerTokenAuthorization, APIKeyAuthorization]
SpecificAuthorizationT = TypeVar("SpecificAuthorizationT", bound=SpecificAuthorization)
OptionalSpecificAuthorization = Optional[SpecificAuthorization]
OptionalSpecificAuthorizationT = TypeVar(
    "OptionalSpecificAuthorizationT", bound=OptionalSpecificAuthorization
)


AnyAuthorization = Union[BaseAuthorization, SpecificAuthorization]
