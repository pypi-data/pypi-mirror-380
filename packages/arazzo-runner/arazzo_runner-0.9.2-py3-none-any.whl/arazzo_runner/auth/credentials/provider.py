...
from arazzo_runner.auth.credentials.transform import (
...
from arazzo_runner.auth.models import RequestAuthValue, SecurityOption
...
class CredentialProvider:
    ...
    ## Public API ##
    def get_credential(
        self, request: SecurityOption, fetch_options: FetchOptions | None = None
    ) -> list[Credential]:
        # Fetch credential
    ...
    def get_credentials(
        self, requests: list[SecurityOption], fetch_options: FetchOptions | None = None
    ) -> list[Credential]:
        credentials = []
    ...
    def resolve_credentials(
        self, security_options: list[SecurityOption], source_name: str | None = None
    ) -> list[RequestAuthValue]:
