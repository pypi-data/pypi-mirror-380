...
export function setHulls(nodes) {
    ...
    const groupColor = d3.scaleOrdinal()
        ...
        .range(d3.schemeObservable10.map(c => d3.interpolateRgb(c, "white")(0.5)))
    ...
    const hulls = d3.select("#view")
        ...
        .on("mouseenter", function (_, d) {
            ...
            if (isNotFocus && !AppState.isItADrag) {
                const tooltipColor = groupColor(d[0])
                highlightHull(d[0])
                addHullTooltip.call(this, tooltipColor)
            }
        })
