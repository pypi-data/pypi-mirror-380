...
from sklearn_dual.feature_selection import mutual_info_classif, mutual_info_regression
from sklearn_dual.feature_selection._mutual_info import _compute_mi
