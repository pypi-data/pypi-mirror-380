...
from sklearn_dual.cluster import SpectralClustering, spectral_clustering
from sklearn_dual.cluster._spectral import cluster_qr, discretize
from sklearn_dual.datasets import make_blobs
from sklearn_dual.feature_extraction import img_to_graph
from sklearn_dual.metrics import adjusted_rand_score
from sklearn_dual.metrics.pairwise import kernel_metrics, rbf_kernel
from sklearn_dual.neighbors import NearestNeighbors
from sklearn_dual.utils import check_random_state
from sklearn_dual.utils._testing import assert_array_equal
from sklearn_dual.utils.fixes import COO_CONTAINERS, CSR_CONTAINERS
