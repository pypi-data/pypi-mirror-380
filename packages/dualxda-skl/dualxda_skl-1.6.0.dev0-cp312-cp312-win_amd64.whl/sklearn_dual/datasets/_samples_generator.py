...
/ X[:, 0]) + noise * N(0, 1).
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import make_friedman3
...
def make_sparse_uncorrelated(n_samples=100, n_features=10, *, random_state=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import make_sparse_uncorrelated
...
def make_swiss_roll(n_samples=100, *, noise=0.0, random_state=None, hole=False):
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import make_swiss_roll
...
def make_s_curve(n_samples=100, *, noise=0.0, random_state=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import make_s_curve
...
def make_biclusters(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import make_biclusters
