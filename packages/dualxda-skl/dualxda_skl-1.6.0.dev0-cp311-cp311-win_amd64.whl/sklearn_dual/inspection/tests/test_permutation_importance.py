...
from sklearn_dual.ensemble import RandomForestClassifier, RandomForestRegressor
...
from sklearn_dual.preprocessing import KBinsDiscretizer, OneHotEncoder, StandardScaler, scale
