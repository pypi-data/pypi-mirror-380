...
from sklearn_dual.cross_decomposition import CCA, PLSSVD, PLSCanonical, PLSRegression
from sklearn_dual.cross_decomposition._pls import (
    _center_scale_xy,
    _get_first_singular_vectors_power_method,
    _get_first_singular_vectors_svd,
    _svd_flip_1d,
)
from sklearn_dual.datasets import load_linnerud, make_regression
...
from sklearn_dual.utils.extmath import svd_flip
