...
from sklearn_dual.datasets import make_blobs, make_classification, make_regression
...
from sklearn_dual.model_selection import LeaveOneGroupOut, cross_val_score
