...
from sklearn_dual.cross_decomposition import CCA, PLSCanonical, PLSRegression
from sklearn_dual.datasets import load_iris, make_classification, make_friedman1
from sklearn_dual.ensemble import RandomForestClassifier
from sklearn_dual.feature_selection import RFE, RFECV
from sklearn_dual.impute import SimpleImputer
from sklearn_dual.linear_model import LinearRegression, LogisticRegression
from sklearn_dual.metrics import get_scorer, make_scorer, zero_one_loss
from sklearn_dual.model_selection import GroupKFold, cross_val_score
from sklearn_dual.pipeline import make_pipeline
from sklearn_dual.preprocessing import StandardScaler
from sklearn_dual.svm import SVC, SVR, LinearSVR
