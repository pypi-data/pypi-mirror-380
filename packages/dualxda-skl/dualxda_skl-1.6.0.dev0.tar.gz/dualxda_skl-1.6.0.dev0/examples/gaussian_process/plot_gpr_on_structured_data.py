...
from sklearn_dual.gaussian_process import GaussianProcessClassifier, GaussianProcessRegressor
from sklearn_dual.gaussian_process.kernels import GenericKernelMixin, Hyperparameter, Kernel
