...
# to note:
#
# * the :class:`~sklearn_dual.ensemble.RandomTreesEmbedding` is not
#   technically a manifold embedding method, as it learn a high-dimensional
#   representation on which we apply a dimensionality reduction method.
#   However, it is often useful to cast a dataset into a representation in
#   which the classes are linearly-separable.
# * the :class:`~sklearn_dual.discriminant_analysis.LinearDiscriminantAnalysis` and
#   the :class:`~sklearn_dual.neighbors.NeighborhoodComponentsAnalysis`, are supervised
#   dimensionality reduction method, i.e. they make use of the provided labels,
#   contrary to other methods.
# * the :class:`~sklearn_dual.manifold.TSNE` is initialized with the embedding that is
