...
:func:`~sklearn_dual.model_selection.permutation_test_score` to evaluate the
...
# :func:`~sklearn_dual.model_selection.permutation_test_score` using the original
...
# :class:`~sklearn_dual.svm.SVC` classifier and :ref:`accuracy_score` to evaluate
