...
class NMSlibTransformer(TransformerMixin, BaseEstimator):
    """Wrapper for using nmslib as sklearn_dual's KNeighborsTransformer"""
...
# Both :class:`~sklearn_dual.neighbors.KNeighborsTransformer` and `NMSlibTransformer`
...
#
# We can observe that the default :class:`~sklearn_dual.manifold.TSNE` estimator with
# its internal :class:`~sklearn_dual.neighbors.NearestNeighbors` implementation is
# roughly equivalent to the pipeline with :class:`~sklearn_dual.manifold.TSNE` and
# :class:`~sklearn_dual.neighbors.KNeighborsTransformer` in terms of performance.
# This is expected because both pipelines rely internally on the same
# :class:`~sklearn_dual.neighbors.NearestNeighbors` implementation that performs
...
# :class:`~sklearn_dual.manifold.TSNE` pipeline, the gains of the approximate search
