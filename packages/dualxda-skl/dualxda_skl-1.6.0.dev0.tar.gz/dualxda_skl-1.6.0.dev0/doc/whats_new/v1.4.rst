...
- :func:`sklearn_dual.metrics.accuracy_score` and :func:`sklearn_dual.metrics.zero_one_loss` in
  :pr:`27137` by :user:`Edoardo Abati <EdAbati>`;
- :func:`sklearn_dual.model_selection.train_test_split` in :pr:`26855` by `Tim Head`_;
...
- |Fix| The `degree` parameter in the :class:`cluster.SpectralClustering`
  ...
  :class:`sklearn_dual.metrics.pairwise.polynomial_kernel`.
...
- |Efficiency| :meth:`sklearn_dual.neighbors.KNeighborsRegressor.predict` and
  :meth:`sklearn_dual.neighbors.KNeighborsClassifier.predict_proba` now efficiently support
...
- |Enhancement| :func:`sklearn_dual.utils.estimator_html_repr` dynamically adapts
...
- |Enhancement| Make :func:`sklearn_dual.utils.check_array` attempt to output
...
- |Fix| :func:`sklearn_dual.utils.check_array` should accept both matrix and array from
...
- |API| :func:`sklearn_dual.extmath.log_logistic` is deprecated and will be removed in 1.6.
