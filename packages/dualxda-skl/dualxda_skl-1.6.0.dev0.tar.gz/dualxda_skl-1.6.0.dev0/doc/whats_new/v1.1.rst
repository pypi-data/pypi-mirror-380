...
- |Efficiency| Low-level routines for reductions on pairwise distances
  ...
  For instance :class:`sklearn_dual.neighbors.NearestNeighbors.kneighbors` and
  :class:`sklearn_dual.neighbors.NearestNeighbors.radius_neighbors`
...
- |Enhancement| Adds :term:`get_feature_names_out` to all transformers in the
  :mod:`~sklearn_dual.cross_decomposition` module:
...
- |Enhancement| Adds :term:`get_feature_names_out` to all transformers in the
  :mod:`~sklearn_dual.decomposition` module:
  :class:`decomposition.DictionaryLearning`,
...
- |API| :class:`metrics.DistanceMetric` has been moved from
  :mod:`sklearn_dual.neighbors` to :mod:`sklearn_dual.metrics`.
...
- |Fix| Defines `__sklearn_dual_is_fitted__` in :class:`pipeline.FeatureUnion` to
...
:mod:`sklearn_dual.random_projection`
................................
...
- |Enhancement| Adds :term:`get_feature_names_out` to all transformers in the
  :mod:`sklearn_dual.random_projection` module:
