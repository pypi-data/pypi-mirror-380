...
- |Fix| Fix a bug where the current configuration was ignored in estimators using
  ...
  thread of `joblib` as :func:`sklearn_dual.get_config` used to access an empty thread
...
- |Efficiency| Low-level routines for reductions on pairwise distances
  ...
  For instance :meth:`sklearn_dual.neighbors.NearestNeighbors.kneighbors` and
  :meth:`sklearn_dual.neighbors.NearestNeighbors.radius_neighbors`
