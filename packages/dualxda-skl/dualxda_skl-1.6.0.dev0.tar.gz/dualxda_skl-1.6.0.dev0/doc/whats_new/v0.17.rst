...
- The ``labels`` parameter to :func:`sklearn_dual.metrics.f1_score`,
  :func:`sklearn_dual.metrics.fbeta_score`,
  :func:`sklearn_dual.metrics.recall_score` and
  :func:`sklearn_dual.metrics.precision_score` has been extended.
...
- Provide an option for sparse output from
  :func:`sklearn_dual.metrics.pairwise.cosine_similarity`. By
...
- RCV1 dataset loader (:func:`sklearn_dual.datasets.fetch_rcv1`).
