...
You may load a dataset like as follows::
  ...
  >>> from sklearn_dual.datasets import load_svmlight_file
...
The ``sklearn_dual.datasets`` package is able to download datasets
from the repository using the function
:func:`sklearn_dual.datasets.fetch_openml`.
...
will need converting to numerical features using :class:`~sklearn_dual.preprocessing.OneHotEncoder`
or :class:`~sklearn_dual.preprocessing.OrdinalEncoder` or similar.
