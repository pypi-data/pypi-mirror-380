...
parsed_version = parse(sklearn_dual.__version__)
...
if parsed_version.is_postrelease:
    ...
    release = sklearn_dual.__version__
...
default_global_config = sklearn_dual.get_config()


def reset_sklearn_dual_config(gallery_conf, fname):
    """Reset sklearn_dual config to default values."""
    sklearn_dual.set_config(**default_global_config)


sg_examples_dir = "../examples"
sg_gallery_dir = "auto_examples"
sphinx_gallery_conf = {
    "doc_module": "sklearn_dual",
    "backreferences_dir": os.path.join("modules", "generated"),
    "show_memory": False,
    "reference_url": {"sklearn_dual": None},
    ...
    "reset_modules": ("matplotlib", "seaborn", reset_sklearn_dual_config),
}
if with_jupyterlite:
...
if os.environ.get("sklearn_dual_WARNINGS_AS_ERRORS", "0") != "0":
    turn_warnings_into_errors()

# maps functions with a class name that is indistinguishable when case is
# ignore to another filename
autosummary_filename_map = {
    "sklearn_dual.cluster.dbscan": "dbscan-function",
    "sklearn_dual.covariance.oas": "oas-function",
    "sklearn_dual.decomposition.fastica": "fastica-function",
}
