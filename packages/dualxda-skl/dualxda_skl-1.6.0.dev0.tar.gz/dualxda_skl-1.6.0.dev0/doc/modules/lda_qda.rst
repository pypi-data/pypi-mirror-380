...
Oracle Approximating Shrinkage estimator :class:`sklearn_dual.covariance.OAS`
...
:mod:`sklearn_dual.covariance` module.
...
:class:`~sklearn_dual.discriminant_analysis.LinearDiscriminantAnalysis`, and it is
