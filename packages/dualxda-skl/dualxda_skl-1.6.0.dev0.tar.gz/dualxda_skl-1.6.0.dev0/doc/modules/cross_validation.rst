...
<sklearn_dual.base.ClassifierMixin>`.
...
.. dropdown:: Data transformation with held-out data
  ...
  A :class:`Pipeline <sklearn_dual.pipeline.Pipeline>` makes it easier to compose
...
:class:`KFold`.
  ...
  >>> from sklearn_dual.model_selection import StratifiedKFold, KFold
  >>> import numpy as np
...
:func:`~sklearn_dual.model_selection.permutation_test_score` offers another way
...
:func:`~sklearn_dual.model_selection.permutation_test_score` generates a null
...
samples.
:func:`~sklearn_dual.model_selection.permutation_test_score` provides information
...
Finally, :func:`~sklearn_dual.model_selection.permutation_test_score` is computed
