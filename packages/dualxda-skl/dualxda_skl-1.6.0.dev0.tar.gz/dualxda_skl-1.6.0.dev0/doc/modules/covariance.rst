...
.. currentmodule:: sklearn_dual.covariance
...
:mod:`sklearn_dual.covariance` package provides tools for accurately estimating
...
:mod:`sklearn_dual.covariance` package, or it can be otherwise obtained by
...
with the :meth:`oas` function of the :mod:`sklearn_dual.covariance`
...
The ``sklearn_dual.covariance`` package implements a robust estimator of covariance,
