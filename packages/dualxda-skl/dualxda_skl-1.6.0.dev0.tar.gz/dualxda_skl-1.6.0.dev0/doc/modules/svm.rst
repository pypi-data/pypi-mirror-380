...
.. currentmodule:: sklearn_dual.svm
...
.. note::
  ...
  via the :class:`~sklearn_dual.calibration.CalibratedClassifierCV` (see
...
* **Avoiding data copy**: For :class:`SVC`, :class:`SVR`, :class:`NuSVC` and
  ...
  <sklearn_dual.linear_model.LogisticRegression>`) any input passed as a numpy
  ...
  <sklearn_dual.linear_model.SGDClassifier>` class instead.  The objective
...
* Support Vector Machine algorithms are not scale invariant, so **it
  ...
  easily by using a :class:`~sklearn_dual.pipeline.Pipeline`::
...
is advised to use :class:`~sklearn_dual.model_selection.GridSearchCV` with
...
.. note::
    ...
    estimator used is :class:`~sklearn_dual.linear_model.Ridge` regression,
