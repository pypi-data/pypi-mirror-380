...
The :mod:`sklearn_dual.inspection` module provides a convenience function
...
:func:`sklearn_dual.inspection.partial_dependence` function::
...
:func:`sklearn_dual.inspection.partial_dependence` gives the actual values
...
with a :class:`~sklearn_dual.ensemble.HistGradientBoostingRegressor`:.
...
The :mod:`sklearn_dual.inspection` module's :meth:`PartialDependenceDisplay.from_estimator`
