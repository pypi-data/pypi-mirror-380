...
Random Projection
==================
.. currentmodule:: sklearn_dual.random_projection

The :mod:`sklearn_dual.random_projection` module implements a simple and
...
bounded distortion introduced by the random projection::
  ...
  >>> from sklearn_dual.random_projection import johnson_lindenstrauss_min_dim
...
projection transformer::
  ...
  >>> import numpy as np
  >>> from sklearn_dual import random_projection
