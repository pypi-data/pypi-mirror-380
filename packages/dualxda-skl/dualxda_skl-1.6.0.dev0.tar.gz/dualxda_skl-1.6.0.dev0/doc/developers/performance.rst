...
dataset and as in the :ref:`sphx_glr_auto_examples_classification_plot_digits_classification.py` example::
  ...
  In [1]: from sklearn_dual.decomposition import NMF

  In [2]: from sklearn_dual.datasets import load_digits
...
Now restart IPython and let us use this new toy::
  ...
  In [1]: from sklearn_dual.datasets import load_digits

  In [2]: from sklearn_dual.decomposition import NMF
    ... : from sklearn_dual.decomposition._nmf import _nls_subproblem
  ...
  File: sklearn_dual/decomposition/nmf.py
