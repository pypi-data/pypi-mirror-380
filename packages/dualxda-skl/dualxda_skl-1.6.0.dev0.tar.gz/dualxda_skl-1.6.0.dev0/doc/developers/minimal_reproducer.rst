...
:mod:`sklearn_dual.datasets` module. Most of the times the bug is not related to a
...
as :class:`sklearn_dual.preprocessing.StandardScaler`.
...
As hinted by the name, :class:`sklearn_dual.datasets.make_regression` produces
...
:class:`sklearn_dual.datasets.make_classification` creates multiclass datasets with multiple Gaussian
...
Similarly to `make_classification`, :class:`sklearn_dual.datasets.make_blobs` creates
