...
:func:`~sklearn_dual.inspection.PartialDependenceDisplay.from_estimator` and
:class:`~sklearn_dual.inspection.PartialDependenceDisplay` support plotting on
...
See for example, :meth:`~sklearn_dual.inspection.PartialDependenceDisplay.from_estimator`
