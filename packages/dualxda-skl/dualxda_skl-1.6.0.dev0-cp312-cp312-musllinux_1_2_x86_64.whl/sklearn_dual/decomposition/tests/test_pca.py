...
from sklearn_dual.datasets import load_iris, make_classification, make_low_rank_matrix
from sklearn_dual.decomposition import PCA
from sklearn_dual.decomposition._pca import _assess_dimension, _infer_dimension
from sklearn_dual.utils._array_api import (
    _atol_for_type,
    _convert_to_numpy,
    yield_namespace_device_dtype_combinations,
)
from sklearn_dual.utils._array_api import device as array_device
from sklearn_dual.utils._testing import _array_api_for_tests, assert_allclose
