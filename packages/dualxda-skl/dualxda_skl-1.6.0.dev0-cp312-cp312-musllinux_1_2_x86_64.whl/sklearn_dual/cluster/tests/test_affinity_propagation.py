...
from sklearn_dual.cluster import AffinityPropagation, affinity_propagation
from sklearn_dual.cluster._affinity_propagation import _equal_similarities_and_preferences
