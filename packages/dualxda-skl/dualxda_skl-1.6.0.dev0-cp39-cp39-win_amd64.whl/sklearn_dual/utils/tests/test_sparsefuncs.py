...
from sklearn_dual.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS, LIL_CONTAINERS
from sklearn_dual.utils.sparsefuncs import (
...
from sklearn_dual.utils.sparsefuncs_fast import (
    assign_rows_csr,
    csr_row_norms,
