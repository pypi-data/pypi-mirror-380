...
from sklearn_dual import base, datasets, linear_model, svm
from sklearn_dual.datasets import load_digits, make_blobs, make_classification
from sklearn_dual.exceptions import ConvergenceWarning
from sklearn_dual.svm.tests import test_svm
