...
from sklearn_dual.utils.fixes import _IS_32BIT, CSR_CONTAINERS, np_version, parse_version
...
def test_count_nonzero(
    ...
    from sklearn_dual.utils.sparsefuncs import count_nonzero as sparse_count_nonzero
