...
from sklearn_dual.base import ClassifierMixin, clone
...
from sklearn_dual.metrics import jaccard_score, mean_squared_error
...
from sklearn_dual.multioutput import (
    ClassifierChain,
