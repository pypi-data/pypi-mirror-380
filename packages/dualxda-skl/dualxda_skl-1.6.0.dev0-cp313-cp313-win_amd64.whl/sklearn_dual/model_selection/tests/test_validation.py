...
from sklearn_dual.metrics._scorer import _MultimetricScorer
...
from sklearn_dual.model_selection._validation import (
    _check_is_permutation,
    _fit_and_score,
    _score,
)
from sklearn_dual.model_selection.tests.common import OneTimeSplitter
from sklearn_dual.model_selection.tests.test_search import FailingClassifier
...
from sklearn_dual.preprocessing import LabelEncoder, scale
