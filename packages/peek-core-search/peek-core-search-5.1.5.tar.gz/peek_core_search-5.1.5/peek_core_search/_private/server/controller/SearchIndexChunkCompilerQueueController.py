...
class _Notifier(ACIProcessorStatusNotifierABC):
    ...
    def setProcessorStatus(self, state: bool, queueSize: int):
        ...
        self._adminStatusController.status.searchIndexCompilerQueueLastUpdateDate = datetime.now(
            timezone.utc
        )
    ...
    def setProcessorTableTotal(self, total: int):
        ...
        self._adminStatusController.status.searchIndexCompilerQueueTableTotal = (
            total
        )
        self._adminStatusController.status.searchIndexCompilerQueueLastTableTotalUpdate = datetime.now(
            timezone.utc
        )
        self._adminStatusController.notify()
...
class SearchIndexChunkCompilerQueueController(ACIProcessorQueueControllerABC):
    ...
    def __init__(
        ...
        self._clientSearchIndexUpdateHandler: (
            ClientSearchIndexChunkUpdateHandler
