...
def upgrade():
    ...
    op.create_index(
        "idx_EncodedSearchIndex_chunkKey",
        "EncodedSearchIndexChunk",
        ["chunkKey"],
        unique=True,
        schema="core_search",
    ...
    op.create_index(
        "idx_EncodedSearchObject_chunkKey",
        "EncodedSearchObjectChunk",
        ["chunkKey"],
        unique=True,
        schema="core_search",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["objectTypeId"],
            ["core_search.SearchObjectType.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="core_search",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["objectId"], ["core_search.SearchObject.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="core_search",
    )
...
def downgrade():
    ...
    op.drop_index(
        "idx_SearchObject_objectTypeId",
        table_name="SearchObject",
        schema="core_search",
    )
    op.drop_index(
        "idx_SearchObject_key", table_name="SearchObject", schema="core_search"
    )
    op.drop_index(
        "idx_SearchObject_chunkKey",
        table_name="SearchObject",
    ...
    op.drop_index(
        "idx_SearchProp_title",
        table_name="SearchProperty",
        schema="core_search",
    )
    op.drop_index(
        "idx_SearchProp_name", table_name="SearchProperty", schema="core_search"
    )
    op.drop_table("SearchProperty", schema="core_search")
    op.drop_index(
        "idx_SearchProp_title",
        table_name="SearchObjectType",
        schema="core_search",
    )
    op.drop_index(
        "idx_SearchProp_name",
    ...
    op.drop_index(
        "idx_EncodedSearchObject_chunkKey",
        table_name="EncodedSearchObjectChunk",
        schema="core_search",
    )
    op.drop_table("EncodedSearchObjectChunk", schema="core_search")
    op.drop_index(
        "idx_EncodedSearchIndex_chunkKey",
        table_name="EncodedSearchIndexChunk",
        schema="core_search",
    )
