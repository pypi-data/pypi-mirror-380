...
class _Notifier(ACIProcessorStatusNotifierABC):
    ...
    def setProcessorStatus(self, state: bool, queueSize: int):
        ...
        self._adminStatusController.status.searchObjectCompilerQueueLastUpdateDate = datetime.now(
            timezone.utc
        )
    ...
    def setProcessorTableTotal(self, total: int):
        ...
        self._adminStatusController.status.searchObjectCompilerQueueTableTotal = (
            total
        )
        self._adminStatusController.status.searchObjectCompilerQueueLastTableTotalUpdate = datetime.now(
            timezone.utc
        )
        self._adminStatusController.notify()
...
class SearchObjectChunkCompilerQueueController(ACIProcessorQueueControllerABC):
    ...
    def __init__(
        ...
        self._clientSearchObjectUpdateHandler: (
            ClientSearchObjectChunkUpdateHandler
