...
def upgrade():
    ...
    op.add_column(
        "SearchProperty",
        sa.Column(
            "showInHeader", sa.Boolean(), server_default="0", nullable=True
        ),
        schema="core_search",
    )

    op.execute(
        """ UPDATE "core_search"."SearchProperty" SET "showInHeader" = false """
    )
    ...
    op.add_column(
        "SearchProperty",
        sa.Column(
            "showOnResult", sa.Boolean(), server_default="1", nullable=True
        ),
        schema="core_search",
    )

    op.execute(
        """ UPDATE "core_search"."SearchProperty" SET "showOnResult" = true """
    )
