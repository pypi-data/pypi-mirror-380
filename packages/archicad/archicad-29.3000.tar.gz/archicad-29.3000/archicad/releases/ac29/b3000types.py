...
ProfileAttribute.get_classinfo().add_field('useWith', List[str], listitem_validator(value_set(['All', 'Wall', 'Column', 'Beam', 'Window', 'Door', 'Object', 'Lamp', 'Slab', 'Roof', 'Mesh', 'Zone', 'CurtainWall', 'Shell', 'Skylight', 'Morph', 'Stair', 'Railing', 'Opening'])))
...
TypeOfElement.get_classinfo().add_field('elementType', str, value_set(['All', 'Wall', 'Column', 'Beam', 'Window', 'Door', 'Object', 'Lamp', 'Slab', 'Roof', 'Mesh', 'Zone', 'CurtainWall', 'Shell', 'Skylight', 'Morph', 'Stair', 'Railing', 'Opening']))
...
CompositeAttribute.get_classinfo().add_field('useWith', List[str], listitem_validator(value_set(['All', 'Wall', 'Column', 'Beam', 'Window', 'Door', 'Object', 'Lamp', 'Slab', 'Roof', 'Mesh', 'Zone', 'CurtainWall', 'Shell', 'Skylight', 'Morph', 'Stair', 'Railing', 'Opening'])))
...
class NormalPropertyValue(_ACUnionType):
    ...
    def __new__(cls, type: str, value: Union[float, int, str, bool, List[float], List[int], List[str], List[bool], EnumValueId, List[EnumValueIdWrapper]], status: str = "normal"):
        return cls.constructor(type=type, value=value, status=status)

    def __init__(self, type: str, value: Union[float, int, str, bool, List[float], List[int], List[str], List[bool], EnumValueId, List[EnumValueIdWrapper]], status: str = "normal"):
        self.type: str = type
        self.value: Union[float, int, str, bool, List[float], List[int], List[str], List[bool], EnumValueId, List[EnumValueIdWrapper]] = value
        self.status: str = status
...
class Types:
    ...
    NormalPropertyValue=NormalPropertyValue
