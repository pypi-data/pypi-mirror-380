...
from .b3000types import ElementComponentIdArrayItem, InteriorElevationNavigatorItemOrError, RGBColor, ClassificationItemAvailabilityOrError, NavigatorTreeId, AttributeFolderIdWrapperItem, BoundingBox3DOrError, PropertyIdArrayItem, AddOnCommandId, ElementClassificationOrError, LineAttributeOrError, SurfaceAttributeOrError, ClassificationItemId, FillAttributeOrError, ImageOrError, AttributeFolderRenameParameters, ClassificationItemOrError, CompositeAttributeOrError, ElementComponentsOrError, AttributeFolderId, NavigatorItemId, AddOnCommandResponse, ZoneCategoryAttributeOrError, ElementsOrError, PropertyIdsOfElementOrError, NavigatorTree, BoundingBox2DOrError, PropertyUserId, AddOnCommandParameters, PropertyIdOrError, PenTableAttributeOrError, AttributeFolderStructure, LayoutParameters, TypeOfElementOrError, AttributeFolderOrError, Document3DNavigatorItemOrError, DetailNavigatorItemOrError, ProfileAttributeOrError, ClassificationSystem, ClassificationSystemIdArrayItem, ElementIdArrayItem, BuildingMaterialAttributeOrError, ClassificationSystemOrError, StoryNavigatorItemOrError, WorksheetNavigatorItemOrError, ElementClassification, ClassificationItemArrayItem, AttributeFolderCreationParameters, FolderParameters, AttributeIndexAndGuidOrError, ClassificationItemIdArrayItem, PropertyValuesOrError, ExecutionResult, SectionNavigatorItemOrError, Subset, AttributeIdOrError, ElevationNavigatorItemOrError, PropertyGroupOrError, LayerAttributeOrError, PropertyDefinitionAvailabilityOrError, PropertyDefinitionOrError, ElementPropertyValue, PropertyGroupIdArrayItem, NavigatorItemIdWrapper, BuiltInContainerNavigatorItemOrError, LayerCombinationAttributeOrError, ClassificationSystemId, NavigatorItemIdAndTypeOrError, AttributeIdWrapperItem
...
class Commands:
    ...
    def GetElementsByType(self, elementType: str) -> List[ElementIdArrayItem]:
        ...
        GetElementsByType_parameters.get_classinfo().add_field('elementType', str, value_set(['All', 'Wall', 'Column', 'Beam', 'Window', 'Door', 'Object', 'Lamp', 'Slab', 'Roof', 'Mesh', 'Zone', 'CurtainWall', 'Shell', 'Skylight', 'Morph', 'Stair', 'Railing', 'Opening']))
    ...
    def GetElementsRelatedToZones(self, zones: List[ElementIdArrayItem], elementTypes: List[str]) -> List[ElementsOrError]:
        ...
        Args:
            ...
            elementTypes (:obj:`list` of :obj:`str`): A list of element types.
        ...
        class GetElementsRelatedToZones_parameters(_ACBaseType):
            ...
            def __init__(self, zones: List[ElementIdArrayItem], elementTypes: List[str]):
                self.zones: List[ElementIdArrayItem] = zones
                self.elementTypes: List[str] = elementTypes

        GetElementsRelatedToZones_parameters.get_classinfo().add_field('zones', List[ElementIdArrayItem])
        GetElementsRelatedToZones_parameters.get_classinfo().add_field('elementTypes', List[str], listitem_validator(value_set(['All', 'Wall', 'Column', 'Beam', 'Window', 'Door', 'Object', 'Lamp', 'Slab', 'Roof', 'Mesh', 'Zone', 'CurtainWall', 'Shell', 'Skylight', 'Morph', 'Stair', 'Railing', 'Opening'])))
    ...
    def GetPropertyValuesOfElements(self, elements: List[ElementIdArrayItem], properties: List[PropertyIdArrayItem], onlySupportedTypes: Optional[bool] = None) -> List[PropertyValuesOrError]:
        ...
        class GetPropertyValuesOfElements_parameters(_ACBaseType):
            __slots__ = ("elements", "properties", "onlySupportedTypes", )
            def __init__(self, elements: List[ElementIdArrayItem], properties: List[PropertyIdArrayItem], onlySupportedTypes: Optional[bool] = None):
                self.elements: List[ElementIdArrayItem] = elements
                self.properties: List[PropertyIdArrayItem] = properties
        ...
        GetPropertyValuesOfElements_parameters.get_classinfo().add_field('onlySupportedTypes', Optional[bool])

        result = post_command(self.__req, json.dumps({"command": "API.GetPropertyValuesOfElements", "parameters": GetPropertyValuesOfElements_parameters(elements, properties, onlySupportedTypes).to_dict()}))
        if not result["succeeded"]:
            raise UnsucceededCommandCall(result)
