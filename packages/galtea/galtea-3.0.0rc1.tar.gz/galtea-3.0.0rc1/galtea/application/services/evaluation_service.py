...
class EvaluationService:
    ...
    def list(
        ...
        sortByCreatedAt: Optional[str] = None,
    ):
        """
        ...
        Args:
            ...
            sortByCreatedAt (str, optional): Sort by created at. Valid values are 'asc' and 'desc'.
        ...
        if session_id is not None and not is_valid_id(session_id):
            raise ValueError("Session ID provided is not valid.")
        if sortByCreatedAt is not None and sortByCreatedAt not in ["asc", "desc"]:
        ...
        query_params = build_query_params(
            ...
            offset=offset,
            limit=limit,
            sort=["createdAt", sortByCreatedAt] if sortByCreatedAt else None,
        )
