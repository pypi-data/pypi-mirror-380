        ...
        try:
            ...
            if final or num_lines > 0:
                ...
                if show <= 0 and not final:
                    # Update the live window even if no new stable lines
                    if not final and self.live:
                ...
                # Get the new lines and display them (only if we have new content)
                if show > 0:
            ...
            # If anything goes wrong with the live display, clean up
            if self.live:
                try:
                    self.live.stop()
                except Exception:
