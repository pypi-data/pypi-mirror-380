...
\t{click.style("vcp data search 'bed nucleus of stria terminalis' --exact", fg="green")} \n
\t ... equivalent to: {click.style("vcp data download --term 'bed nucleus of stria terminalis' --exact", fg="green")} \n
\n
\n
