...
class EpicsApi:
    ...
    def list_epics(
        ...
        _param = self._list_epics_serialize(
    ...
    def list_epics_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedEpicResponse]:
        """List epics
    ...
    @validate_call
    def list_epics_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
        cursor: Annotated[Optional[StrictStr], Field(description="Pagination cursor for getting next set of results")] = None,
    ...
    def _list_epics_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/workspaces/{slug}/projects/{project_id}/epics/',
    ...
    def retrieve_epic(
        ...
        _param = self._retrieve_epic_serialize(
            pk=pk,
            project_id=project_id,
            slug=slug,
            fields=fields,
    ...
    @validate_call
    def retrieve_epic_with_http_info(
        self,
        pk: StrictStr,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    @validate_call
    def retrieve_epic_without_preload_content(
        self,
        pk: StrictStr,
        project_id: Annotated[StrictStr, Field(description="Project ID")],
        slug: Annotated[StrictStr, Field(description="Workspace slug")],
    ...
    def _retrieve_epic_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/workspaces/{slug}/projects/{project_id}/epics/{pk}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
