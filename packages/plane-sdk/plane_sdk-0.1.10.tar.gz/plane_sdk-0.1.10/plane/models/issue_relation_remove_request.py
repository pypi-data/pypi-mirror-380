...
class IssueRelationRemoveRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    related_issue: StrictStr = Field(description="ID of the related work item to remove relation with")
    __properties: ClassVar[List[str]] = ["related_issue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "related_issue": obj.get("related_issue")
        })
        return _obj
