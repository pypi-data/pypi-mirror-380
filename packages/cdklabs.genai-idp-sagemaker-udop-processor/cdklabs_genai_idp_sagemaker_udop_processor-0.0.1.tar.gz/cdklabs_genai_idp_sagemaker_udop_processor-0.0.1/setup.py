    ...
    """
{
    ...
    "version": "0.0.1",
    "description": "@cdklabs/genai-idp-sagemaker-udop-processor",
    "license": "Apache-2.0",
    ...
    "packages": [
        "cdklabs.genai_idp_sagemaker_udop_processor",
        "cdklabs.genai_idp_sagemaker_udop_processor._jsii"
    ],
    "package_data": {
        "cdklabs.genai_idp_sagemaker_udop_processor._jsii": [
            "genai-idp-sagemaker-udop-processor@0.0.1.jsii.tgz"
        ],
        "cdklabs.genai_idp_sagemaker_udop_processor": [
            "py.typed"
        ]
