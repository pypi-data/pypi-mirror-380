...
if __name__ == '__main__':
    ...
    input_text = """<gui_think>Hmm, the previous click action might have had a parameter issue. Let's correct that. The Google search box is at <point>450 380</point>, so I need to click it properly to activate the input field. Then, type a query to find the closest ocean park to a hotel and the spiral direction of its main building. Let's start by searching for "closest ocean park to hotel spiral main building direction" to gather relevant information. First, ensure the search box is clicked correctly.</gui_think>\n<seed:tool_call>\n<function=click>\n<parameter=point><point>450 380</point></parameter>\n</function>\n</seed:tool_call>"""
    tool_schemas = [
        {
        "type": "function",
        "name": "click",
