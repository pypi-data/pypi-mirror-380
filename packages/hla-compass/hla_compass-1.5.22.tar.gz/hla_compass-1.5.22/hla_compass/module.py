...
class Module(ABC):
    ...
    def _initialize_helpers(self, context: ExecutionContext):
        ...
        self.peptides: PeptideData | None = None
        self.proteins: ProteinData | None = None
        self.samples: SampleData | None = None
        self.hla: HLAData | None = None
    ...
    def _load_metadata_parameter_paths(self) -> list[str] | None:
