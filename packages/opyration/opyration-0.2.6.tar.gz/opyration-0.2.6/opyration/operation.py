...
class Operation(object):
    ...
    def __join(self, join_type, **conditions):
        for key, value in conditions.items():
            ...
            if count == 2:
                ...
                table, column, alias = parts
                self.__sql = f'{self.__sql} {join_type} {self.__schema}{table} AS {alias} ON {alias}.{column}={value}'
        return self
    ...
    def group(self, *columns):
        self.__sql = f'{self.__sql} GROUP BY {", ".join(columns)}'
        return self
