...
def simulate_batch_processing():
    ...
    for batch_num in range(0, total_records, batch_size):
        ...
        # Log batch start
        batch_logger.debug("Processing batch",
        ...
        batch_logger.info("Batch completed",
                         batch_number=batch_num // batch_size + 1,
        ...
        if (batch_num // batch_size + 1) % 5 == 0:
            ...
            batch_logger.info("Processing progress",
...
async def simulate_async_buffering():
    ...
    async def process_message(message_id: int, priority: str):
        ...
        msg_logger = async_logger.bind(
            message_id=f"MSG-{message_id:04d}",
            priority=priority
        )
        ...
        msg_logger.info("Message processed",
    ...
    async_logger.info("Starting async message processing",
    ...
    for i in range(0, len(messages), batch_size):
        ...
        async_logger.info("Processing message batch",
        ...
        async_logger.info("Message batch completed",
                         batch_number=i // batch_size + 1,
                         messages_processed=len(results))
    
    async_logger.info("All async message processing completed",
                     total_messages=len(messages))
