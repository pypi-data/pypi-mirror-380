        ...
        with micktrace.context(batch_id=batch_id):
            ...
            for item in items:
                ...
                try:
                    ...
                    item_logger.error("Item processing failed",
                                    error_type=type(e).__name__,
                                    error_message=str(e))
                    failed_count += 1
        ...
        class MyLibrary:
            ...
            def handle_error(self, error_data):
                try:
                    ...
                    self.logger.exception("Error in library function",
        ...
        class AsyncHttpClient:
            ...
            async def post(self, url: str, data: dict):
                async with micktrace.acontext(url=url, method="POST"):
                    self.logger.info("HTTP POST request started",
...
class TestEndToEndScenarios:
    ...
    def test_complete_application_flow(self):
        ...
        with micktrace.context(request_id=request_id, user_id=user_id):
            ...
            external_logger.info("Calling external service", 
                                service="notification_service")
            external_logger.info("External service call completed",
    ...
    async def test_complete_async_application_flow(self):
        ...
        async def handle_user_signup(user_data: dict):
            ...
            async with micktrace.acorrelation(operation="user_signup") as correlation_id:
                ...
                signup_logger.info("User signup completed successfully",
