...
from .tokenizer import StringTokenizer, Token, TokenType, NonTextToken, AdvancedCommandParser, ParsedCommand
...
class MessageTokenizer:
    ...
    def _is_text_segment(self, segment) -> bool:
        ...
        return (hasattr(segment, 'text') and 
                hasattr(segment, 'msg_seg_type') and 
                segment.msg_seg_type in ['text', 'plain_text'])
