...
class SimpleChat:
    ...
    def display_welcome(self):
        ...
        welcome = Panel.fit(
            "[bold cyan]StockAI Simple Chat[/bold cyan]\n"
...
The full StockAI chat will integrate with Claude Code SDK.
            """
...
This is a simulated response. The full StockAI system would:
...
To test with real functionality, ensure Claude Code SDK is properly configured.
            ...
            response = "Hello! I'm StockAI. In full mode, I'd help you with stock analysis using live data."
        else:
        ...
        self.console.print(Panel(
            response,
            title="[bold green]StockAI (Test Mode)[/bold green]",
            border_style="green",
            padding=(1, 2)
        ))
