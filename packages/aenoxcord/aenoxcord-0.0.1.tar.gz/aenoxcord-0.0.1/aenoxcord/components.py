...
.. hint::
        ...
        You can use `discord.ui.View` instead of `aenoxcord.View`.
"""
...
class View(discord.ui.View):
    ...
    async def on_error(
        ...
        Executes all registered error handlers with the ``@aenoxcord.event`` decorator.
        """
        if not PYCORD:
...
class EzView(View):
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        warn_deprecated("aenoxcord.EzView", "discord.ui.View", "2.6")
...
class EzModal(Modal):
    ...
    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        warn_deprecated("aenoxcord.EzModal", "discord.ui.Modal", "2.6")
