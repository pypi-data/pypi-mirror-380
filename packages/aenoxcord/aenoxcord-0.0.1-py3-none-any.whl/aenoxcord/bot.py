...
class Bot(_main_bot):  # type: ignore
    ...
    **kwargs:
    ...
    def load_extension(self, name: str, **kwargs):
        ...
        on the `safe_loading` setting in the ``aenoxcord.Bot`` instance.
    ...
    def add_help_command(
        ...
        **kwargs: Callable | str,
        ...
        embed:
            ...
            embed will be used.
            All template variables that are listed in :meth:`aenoxcord.emb.set_embed_templates`
            can be used here.
        show_categories:
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("aenoxcord.cogs.pyc.help_setup", package="aenoxcord")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("aenoxcord.cogs.pyc.status_changer_setup", package="aenoxcord")
    ...
    def add_blacklist(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("aenoxcord.cogs.pyc.blacklist_setup", package="aenoxcord")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="aenoxcord")
