...
class MCPServer:
    ...
    def __init__(self, name: str = "ai-security-scanner"):
        ...
        self.auth_backend = "https://ai-security-mcp-final-722116092626.us-central1.run.app"
    ...
    async def _get_demo_scan_results(self, scan_path: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "mode": "fastmcp_production_fallback",
            "note": "This is fallback data - cloud service temporarily unavailable"
        }
