...
from .. import models
from .serializers import BFDConfigSerializer, BGPPeerGroupSerializer, BGPPeerSerializer, BGPSessionConfigSerializer, ISISConfigSerializer, VNISerializer, VXLANSerializer
