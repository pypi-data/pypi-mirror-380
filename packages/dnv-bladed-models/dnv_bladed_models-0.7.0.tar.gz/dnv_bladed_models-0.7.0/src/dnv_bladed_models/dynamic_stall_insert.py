...
class DynamicStallInsert(BladedEntity):
    ...
    """
    DynamicStallType: Literal['Insert'] = Field(alias="DynamicStallType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'DynamicStallType').merge(BladedEntity._type_info)
