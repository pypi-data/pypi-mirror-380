...
class SensorInsert(BladedEntity):
    ...
    """
    SensorType: Literal['Insert'] = Field(alias="SensorType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'SensorType').merge(BladedEntity._type_info)
