...
class BladeStabilityAnalysisIdling(BladeStabilityAnalysisModeOfOperation):
    ...
    """
    BladeStabilityAnalysisModeOfOperationType: Literal['Idling'] = Field(alias="BladeStabilityAnalysisModeOfOperationType", default='Idling', allow_mutation=False, const=True) # Not supported yet # type: ignore
    TorqueSpeedGain: float = Field(alias="TorqueSpeedGain", default=None) # Not supported yet

    _relative_schema_path = 'SteadyCalculation/BladeStabilityAnalysisModeOfOperation/BladeStabilityAnalysisIdling.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
