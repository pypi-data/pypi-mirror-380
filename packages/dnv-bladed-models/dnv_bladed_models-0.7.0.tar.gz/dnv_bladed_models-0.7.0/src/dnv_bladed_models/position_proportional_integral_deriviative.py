...
class PositionProportionalIntegralDeriviative(TransducerBehaviour):
    ...
    """
    TransducerBehaviourType: Literal['PositionProportionalIntegralDeriviative'] = Field(alias="TransducerBehaviourType", default='PositionProportionalIntegralDeriviative', allow_mutation=False, const=True) # Not supported yet # type: ignore
    ...
    _relative_schema_path = 'Turbine/BladedControl/MeasuredSignalProperties/common/PositionProportionalIntegralDeriviative.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
