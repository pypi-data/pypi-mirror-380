...
class RotorIdlingControlState(InitialControlState):
    ...
    """
    InitialConditionType: Literal['RotorIdling'] = Field(alias="InitialConditionType", default='RotorIdling', allow_mutation=False, const=True) # type: ignore
    IsControllerActive: bool = Field(alias="IsControllerActive", default=None)

    _relative_schema_path = 'TimeDomainSimulation/InitialCondition/RotorIdlingControlState.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
