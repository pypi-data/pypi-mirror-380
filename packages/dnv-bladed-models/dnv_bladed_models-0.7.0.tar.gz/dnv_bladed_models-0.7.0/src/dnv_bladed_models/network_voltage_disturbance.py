...
class NetworkVoltageDisturbance(Fault):
    ...
    """
    EventType: Literal['NetworkVoltageDisturbance'] = Field(alias="EventType", default='NetworkVoltageDisturbance', allow_mutation=False, const=True) # Not supported yet # type: ignore
    ...
    _relative_schema_path = 'TimeDomainSimulation/Event/NetworkVoltageDisturbance.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set(['TimeVsVoltageChange',]),
