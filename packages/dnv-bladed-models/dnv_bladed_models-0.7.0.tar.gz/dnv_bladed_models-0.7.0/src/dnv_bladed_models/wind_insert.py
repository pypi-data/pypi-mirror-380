...
class WindInsert(BladedEntity):
    ...
    """
    WindType: Literal['Insert'] = Field(alias="WindType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'WindType').merge(BladedEntity._type_info)
