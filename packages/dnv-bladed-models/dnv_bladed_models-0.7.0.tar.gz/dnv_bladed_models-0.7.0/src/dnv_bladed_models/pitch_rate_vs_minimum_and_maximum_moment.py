...
class PitchRateVsMinimumAndMaximumMoment(BladedModel):
    ...
    _relative_schema_path = 'Components/PitchSystem/PitchActuator/PitchTorqueLimits/PitchRateVsMinimumAndMaximumMoment/PitchRateVsMinimumAndMaximumMoment.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
