...
class ShaftSpeedVsShaftInputTorqueVsResistingTorque(BladedModel):
    ...
    _relative_schema_path = 'Components/DrivetrainAndNacelle/MechanicalLosses/ShaftSpeedVsShaftInputTorqueVsResistingTorque/ShaftSpeedVsShaftInputTorqueVsResistingTorque.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set(['ShaftInputTorqueVsResistingTorque',]),
