...
class GeneratorSpeedVsGeneratorTorque(BladedModel):
    ...
    _relative_schema_path = 'Turbine/TurbineOperationalParameters/VariableSpeedPitchRegulatedControlModel/PartialLoadOperation/GeneratorSpeedVsGeneratorTorque/GeneratorSpeedVsGeneratorTorque.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
