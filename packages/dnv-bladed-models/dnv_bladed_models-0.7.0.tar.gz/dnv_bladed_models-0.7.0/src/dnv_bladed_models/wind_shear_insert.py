...
class WindShearInsert(BladedEntity):
    ...
    """
    WindShearType: Literal['Insert'] = Field(alias="WindShearType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'WindShearType').merge(BladedEntity._type_info)
