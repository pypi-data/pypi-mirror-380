...
class BladeModellingInsert(BladedEntity):
    ...
    """
    BladeModellingType: Literal['Insert'] = Field(alias="BladeModellingType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'BladeModellingType').merge(BladedEntity._type_info)
