...
class TowerCanInsert(BladedEntity):
    ...
    """
    TowerCanType: Literal['Insert'] = Field(alias="TowerCanType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'TowerCanType').merge(BladedEntity._type_info)
