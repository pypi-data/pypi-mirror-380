...
class InitialConditionInsert(BladedEntity):
    r"""
    ...
    """
    InitialConditionType: Literal['Insert'] = Field(alias="InitialConditionType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'InitialConditionType').merge(BladedEntity._type_info)
