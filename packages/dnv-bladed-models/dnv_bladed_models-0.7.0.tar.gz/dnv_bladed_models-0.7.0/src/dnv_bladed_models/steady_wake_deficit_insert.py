...
class SteadyWakeDeficitInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    SteadyWakeDeficitType : Literal['Insert'], default='Insert'
    ...
    """
    SteadyWakeDeficitType: Literal['Insert'] = Field(alias="SteadyWakeDeficitType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'SteadyWakeDeficitType').merge(BladedEntity._type_info)
