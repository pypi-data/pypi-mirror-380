...
class AddedInertiaInsert(BladedEntity):
    ...
    """
    AddedInertiaType: Literal['Insert'] = Field(alias="AddedInertiaType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'AddedInertiaType').merge(BladedEntity._type_info)
