...
class InstantaneousActuatorResponse(ActuatorResponse):
    ...
    """
    ActuatorResponseType: Literal['InstantaneousActuatorResponse'] = Field(alias="ActuatorResponseType", default='InstantaneousActuatorResponse', allow_mutation=False, const=True) # type: ignore

    _relative_schema_path = 'Components/PitchSystem/PitchActuator/ActuatorResponse/InstantaneousActuatorResponse.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
