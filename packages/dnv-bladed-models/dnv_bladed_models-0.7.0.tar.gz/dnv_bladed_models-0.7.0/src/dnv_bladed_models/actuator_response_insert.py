...
class ActuatorResponseInsert(BladedEntity):
    ...
    """
    ActuatorResponseType: Literal['Insert'] = Field(alias="ActuatorResponseType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'ActuatorResponseType').merge(BladedEntity._type_info)
