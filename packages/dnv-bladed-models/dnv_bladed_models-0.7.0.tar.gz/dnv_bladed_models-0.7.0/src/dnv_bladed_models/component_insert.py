...
class ComponentInsert(BladedEntity):
    ...
    """
    ComponentType: Literal['Insert'] = Field(alias="ComponentType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'ComponentType').merge(BladedEntity._type_info)
