...
class PitchActuatorInsert(BladedEntity):
    ...
    """
    ActuatorDriveType: Literal['Insert'] = Field(alias="ActuatorDriveType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'ActuatorDriveType').merge(BladedEntity._type_info)
