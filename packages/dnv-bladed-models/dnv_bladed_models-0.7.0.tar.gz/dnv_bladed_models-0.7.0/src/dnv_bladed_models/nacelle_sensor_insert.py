...
class NacelleSensorInsert(BladedEntity):
    ...
    """
    NacelleSensorType: Literal['Insert'] = Field(alias="NacelleSensorType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'NacelleSensorType').merge(BladedEntity._type_info)
