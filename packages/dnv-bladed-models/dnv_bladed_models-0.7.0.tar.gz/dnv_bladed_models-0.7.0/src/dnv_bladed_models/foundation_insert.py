...
class FoundationInsert(BladedEntity):
    ...
    """
    FoundationType: Literal['Insert'] = Field(alias="FoundationType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'FoundationType').merge(BladedEntity._type_info)
