...
class SteadyCalculationInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    SteadyCalculationType : Literal['Insert'], default='Insert'
    ...
    """
    SteadyCalculationType: Literal['Insert'] = Field(alias="SteadyCalculationType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'SteadyCalculationType').merge(BladedEntity._type_info)
