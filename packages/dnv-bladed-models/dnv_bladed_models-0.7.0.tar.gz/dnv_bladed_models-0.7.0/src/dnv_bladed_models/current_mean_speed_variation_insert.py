...
class CurrentMeanSpeedVariationInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    MeanSpeedVariationType : Literal['Insert'], default='Insert'
    ...
    """
    MeanSpeedVariationType: Literal['Insert'] = Field(alias="MeanSpeedVariationType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'MeanSpeedVariationType').merge(BladedEntity._type_info)
