...
class PitchSystemDemandInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    PitchSystemDemandType : Literal['Insert'], default='Insert'
    ...
    """
    PitchSystemDemandType: Literal['Insert'] = Field(alias="PitchSystemDemandType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'PitchSystemDemandType').merge(BladedEntity._type_info)
