...
class PitchBearingFrictionRateRelationship(BladedModel):
    ...
    _relative_schema_path = 'Components/PitchSystem/Friction/PitchBearingKineticFriction/PitchBearingFrictionRateRelationship/PitchBearingFrictionRateRelationship.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set(['RateVsFrictionTorque',]),
