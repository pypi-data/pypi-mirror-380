...
class CurrentInsert(BladedEntity):
    ...
    """
    CurrentType: Literal['Insert'] = Field(alias="CurrentType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'CurrentType').merge(BladedEntity._type_info)
