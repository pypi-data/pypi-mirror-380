...
class EventInsert(BladedEntity):
    ...
    """
    EventType: Literal['Insert'] = Field(alias="EventType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'EventType').merge(BladedEntity._type_info)
