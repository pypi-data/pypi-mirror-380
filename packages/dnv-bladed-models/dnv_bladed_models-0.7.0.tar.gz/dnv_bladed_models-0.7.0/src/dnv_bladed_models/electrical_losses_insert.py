...
class ElectricalLossesInsert(BladedEntity):
    ...
    """
    ElectricalLossesType: Literal['Insert'] = Field(alias="ElectricalLossesType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'ElectricalLossesType').merge(BladedEntity._type_info)
