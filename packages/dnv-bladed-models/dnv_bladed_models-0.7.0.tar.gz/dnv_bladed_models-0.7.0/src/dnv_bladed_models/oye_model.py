...
class OyeModel(DynamicStall):
    ...
    """
    DynamicStallType: Literal['OyeModel'] = Field(alias="DynamicStallType", default='OyeModel', allow_mutation=False, const=True) # type: ignore

    _relative_schema_path = 'Settings/AerodynamicSettings/DynamicStall/OyeModel.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
