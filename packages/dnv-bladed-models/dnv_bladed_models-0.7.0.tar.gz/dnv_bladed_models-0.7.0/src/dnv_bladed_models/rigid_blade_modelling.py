...
class RigidBladeModelling(BladeModelling):
    ...
    """
    BladeModellingType: Literal['RigidBladeModelling'] = Field(alias="BladeModellingType", default='RigidBladeModelling', allow_mutation=False, const=True) # type: ignore

    _relative_schema_path = 'Components/Blade/BladeModelling/RigidBladeModelling.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
