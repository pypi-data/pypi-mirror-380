...
class ExplicitTowerCan(TowerCan):
    ...
    """
    TowerCanType: Literal['ExplicitTowerCan'] = Field(alias="TowerCanType", default='ExplicitTowerCan', allow_mutation=False, const=True) # type: ignore
    ...
    _relative_schema_path = 'Components/Tower/TowerCan/ExplicitTowerCan.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
