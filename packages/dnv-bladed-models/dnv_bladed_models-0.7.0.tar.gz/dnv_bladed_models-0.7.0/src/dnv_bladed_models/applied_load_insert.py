...
class AppliedLoadInsert(BladedEntity):
    ...
    """
    AppliedLoadType: Literal['Insert'] = Field(alias="AppliedLoadType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'AppliedLoadType').merge(BladedEntity._type_info)
