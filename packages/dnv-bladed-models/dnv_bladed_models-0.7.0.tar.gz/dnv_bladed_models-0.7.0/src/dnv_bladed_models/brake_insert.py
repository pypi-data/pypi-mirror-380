...
class BrakeInsert(BladedEntity):
    ...
    """
    BrakeType: Literal['Insert'] = Field(alias="BrakeType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'BrakeType').merge(BladedEntity._type_info)
