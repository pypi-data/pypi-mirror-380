...
class ResponseToDemandInsert(BladedEntity):
    ...
    """
    ResponseToDemandType: Literal['Insert'] = Field(alias="ResponseToDemandType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'ResponseToDemandType').merge(BladedEntity._type_info)
