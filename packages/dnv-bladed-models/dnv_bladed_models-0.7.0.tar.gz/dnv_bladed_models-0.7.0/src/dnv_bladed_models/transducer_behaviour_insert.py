...
class TransducerBehaviourInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    TransducerBehaviourType : Literal['Insert'], default='Insert'
    ...
    """
    TransducerBehaviourType: Literal['Insert'] = Field(alias="TransducerBehaviourType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'TransducerBehaviourType').merge(BladedEntity._type_info)
