...
class DynamicWakeInsert(BladedEntity):
    ...
    """
    DynamicWakeType: Literal['Insert'] = Field(alias="DynamicWakeType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'DynamicWakeType').merge(BladedEntity._type_info)
