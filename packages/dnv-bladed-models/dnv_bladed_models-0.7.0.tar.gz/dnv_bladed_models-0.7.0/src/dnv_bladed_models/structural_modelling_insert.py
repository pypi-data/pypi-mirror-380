...
class StructuralModellingInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    StructuralModellingType : Literal['Insert'], default='Insert'
    ...
    """
    StructuralModellingType: Literal['Insert'] = Field(alias="StructuralModellingType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'StructuralModellingType').merge(BladedEntity._type_info)
