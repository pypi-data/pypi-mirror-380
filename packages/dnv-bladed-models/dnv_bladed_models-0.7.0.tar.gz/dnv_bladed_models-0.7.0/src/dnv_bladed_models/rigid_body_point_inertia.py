...
class RigidBodyPointInertia(RigidBodyInertia):
    ...
    """
    ComponentType: Literal['RigidBodyPointInertia'] = Field(alias="ComponentType", default='RigidBodyPointInertia', allow_mutation=False, const=True) # type: ignore
    ...
    _relative_schema_path = 'Components/RigidBodyPointInertia.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
...
RigidBodyPointInertia.update_forward_refs()
