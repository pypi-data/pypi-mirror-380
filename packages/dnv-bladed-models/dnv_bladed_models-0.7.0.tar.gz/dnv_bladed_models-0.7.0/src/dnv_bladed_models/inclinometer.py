...
class Inclinometer(Sensor):
    ...
    """
    SensorType: Literal['Inclinometer'] = Field(alias="SensorType", default='Inclinometer', allow_mutation=False, const=True) # type: ignore

    _relative_schema_path = 'Components/common/Inclinometer.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
