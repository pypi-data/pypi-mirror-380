...
class CurrentDirectionShearTimeHistory(CurrentDirectionShearVariation):
    ...
    """
    DirectionShearVariationType: Literal['TimeHistory'] = Field(alias="DirectionShearVariationType", default='TimeHistory', allow_mutation=False, const=True) # Not supported yet # type: ignore
    TimeVsDirectionShear: List[TimeVsCurrentDirectionShear] = Field(alias="TimeVsDirectionShear", default=list()) # Not supported yet

    _relative_schema_path = 'TimeDomainSimulation/Environment/SeaState/Current/CurrentDirectionShearVariation/CurrentDirectionShearTimeHistory.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
