...
class PitchSafetySystemInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    PitchSafetySystemType : Literal['Insert'], default='Insert'
    ...
    """
    PitchSafetySystemType: Literal['Insert'] = Field(alias="PitchSafetySystemType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'PitchSafetySystemType').merge(BladedEntity._type_info)
