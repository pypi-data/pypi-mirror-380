...
class BendingTorsionCouplingTermsAboutElasticXY(BladedModel):
    ...
    _relative_schema_path = 'Components/Blade/CrossSection/StiffnessProperties/BendingTorsionCouplingTermsAboutElasticXY/BendingTorsionCouplingTermsAboutElasticXY.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
