...
class AerodynamicModelInsert(BladedEntity):
    ...
    """
    AerodynamicModelType: Literal['Insert'] = Field(alias="AerodynamicModelType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'AerodynamicModelType').merge(BladedEntity._type_info)
