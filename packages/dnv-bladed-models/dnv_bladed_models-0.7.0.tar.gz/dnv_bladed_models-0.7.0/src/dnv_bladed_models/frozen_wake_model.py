...
class FrozenWakeModel(DynamicWake):
    ...
    """
    DynamicWakeType: Literal['FrozenWakeModel'] = Field(alias="DynamicWakeType", default='FrozenWakeModel', allow_mutation=False, const=True) # type: ignore

    _relative_schema_path = 'Settings/AerodynamicSettings/AerodynamicModel/MomentumTheoryCorrections/DynamicWake/FrozenWakeModel.json'
    _type_info = TypeInfo(
        set([]),
        set([]),
        set([]),
