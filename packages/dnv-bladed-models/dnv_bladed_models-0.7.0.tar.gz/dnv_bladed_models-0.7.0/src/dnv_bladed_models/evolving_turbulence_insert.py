...
class EvolvingTurbulenceInsert(BladedEntity):
    r"""
    ...
    Attributes
    ----------
    EvolvingTurbulenceType : Literal['Insert'], default='Insert'
    ...
    """
    EvolvingTurbulenceType: Literal['Insert'] = Field(alias="EvolvingTurbulenceType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'EvolvingTurbulenceType').merge(BladedEntity._type_info)
