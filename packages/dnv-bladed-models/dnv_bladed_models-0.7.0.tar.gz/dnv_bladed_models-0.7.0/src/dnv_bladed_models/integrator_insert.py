...
class IntegratorInsert(BladedEntity):
    ...
    """
    IntegratorType: Literal['Insert'] = Field(alias="IntegratorType", default='Insert', allow_mutation=False, const=True) # type: ignore
    ...
    _type_info = TypeInfo(
        ...
        set([]),
        set([]),
        'IntegratorType').merge(BladedEntity._type_info)
