...
import time
from src.grit_guardian_cli.guardian.guardian import Guardian, GuardianMood
from src.grit_guardian_cli.analytics.analytics import identify_struggled_habits
...
class GritUI:
    ...
    def create_weekly_table(habits):
        ...
        table.add_column("Quest", style=GritUI.GOLD, width=18)
    ...
    def _show_weekly_stats(habits):
        ...
        if total_possible > 0:
            ...
            if completion_rate >= 90:
                console.print("🏆 [bold gold1]Legendary performance![/bold gold1]")
            elif completion_rate >= 75:
                console.print("⭐ [bold green]Excellent dedication![/bold green]")
            elif completion_rate >= 50:
                console.print("🗡️ [bold blue]Steady progress![/bold blue]")
            else:
                console.print(
                    "💪 [bold yellow]Room for improvement - you've got this![/bold yellow]"
                )

    @staticmethod
    def show_struggled_habits(habits, since):
    ...
    def show_get_started():
        console.print("\n🎯 Quick Start Guide:")
        console.print("  - View your habits: grit-guardian list")
