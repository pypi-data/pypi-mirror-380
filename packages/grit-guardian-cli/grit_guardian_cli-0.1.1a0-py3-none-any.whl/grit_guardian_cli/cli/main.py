...
from src.grit_guardian_cli.core.habit_tracker import HabitTracker
from src.grit_guardian_cli.persistence.database_manager import DatabaseManager
from src.grit_guardian_cli.ui.ui import GritUI
...
def complete(name):
    ...
    # UI presentation
    GritUI.show_quest_completed(name)
...
def struggled(since):
    ...
    # UI presentation
    GritUI.show_struggled_habits(struggled_habits, since)
    return True
