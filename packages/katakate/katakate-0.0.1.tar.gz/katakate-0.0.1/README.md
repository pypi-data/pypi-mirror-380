...
> <b>100% open‑source</b> (Apache‑2.0). To grow Katakate in the right direction, we’re looking for a handful of <b>enterprise design partners. Write us at: hi@katakate.org</b>
...
```bash
# Publish version and latest tags:
make api-buildx-push TAG=0.0.1
# Optional: override image name
# make api-buildx-push TAG=0.0.1 IMAGE=ghcr.io/Katakate/k7-api
```
