...
import code_size_analyzer_client.models
from code_size_analyzer_client import rest
from code_size_analyzer_client.api_response import ApiResponse
from code_size_analyzer_client.api_response import T as ApiResponseT
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/1.2.0a1/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(code_size_analyzer_client.models, klass)
