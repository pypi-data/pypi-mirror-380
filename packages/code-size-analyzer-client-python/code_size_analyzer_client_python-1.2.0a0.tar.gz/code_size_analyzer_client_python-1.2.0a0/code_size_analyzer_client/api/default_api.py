...
class DefaultApi:
    ...
    def metrics_health_get(
        ...
        _param = self._metrics_health_get_serialize(
    ...
    @validate_call
    def metrics_health_get_with_http_info(
        self,
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[
    ...
    @validate_call
    def metrics_health_get_without_preload_content(
        self,
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[
    ...
    def _metrics_health_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
