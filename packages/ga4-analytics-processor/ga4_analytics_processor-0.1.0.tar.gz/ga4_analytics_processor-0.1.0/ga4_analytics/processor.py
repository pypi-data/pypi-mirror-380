...
class GA4Processor:
    ...
    def get_general_report(self, start_date: Union[str, datetime], end_date: Union[str, datetime],
        ...
        """
        Get processed GA4 general report data
        ...
        """
        # Define report dimensions and metrics
        dimensions_general = [
        ...
        # Fetch raw data
        df_raw = self.run_report(dimensions_general, metrics_general, start_date, end_date)
