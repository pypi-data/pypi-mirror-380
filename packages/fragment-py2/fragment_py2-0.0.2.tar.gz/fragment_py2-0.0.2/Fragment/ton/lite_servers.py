...
def lite_server_random():
    ...
    Returns:
        LiteServer: A randomly selected liteserver with IP converted to human-readable format
    """
    ...
    if ip_int is not None:
        ...
        return LiteServer(**server_copy)
    
    return LiteServer(**server) 