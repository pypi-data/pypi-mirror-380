        ...
        **kwargs,
        ...
        if require_api_key:
            if config.api_key is None:
                raise AuthenticationException(
                    "API key is required, please visit the Team tab at https://agentbox.lingyiwanwu.com/dashboard to get your API key. "
        ...
        if require_access_token:
            if config.access_token is None:
                raise AuthenticationException(
                    "Access token is required, please visit the Personal tab at https://agentbox.lingyiwanwu.com/dashboard to get your access token. "
