...
class MDRClient:
    ...
    def __init__(self,
        ...
        self.url = f"{host}/services/collector/event" if host.startswith("http") else f"https://{host}/services/collector/event"
        ...
        self.client = httpx.Client(verify=ssl_verify, headers=headers)
