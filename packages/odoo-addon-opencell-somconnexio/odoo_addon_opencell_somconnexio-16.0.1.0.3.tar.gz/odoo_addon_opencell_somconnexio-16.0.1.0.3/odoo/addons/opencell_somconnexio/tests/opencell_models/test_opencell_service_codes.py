...
from odoo.addons.somconnexio.tests.factories import ContractFactory, ContractLineFactory
...
class TestOpenCellServiceCodes(SCTestCase):
    ...
    def test_services_to_activate(self):
        ...
        self.assertEqual(services_from_contract, self.expected_services)
    ...
    def test_services_to_activate_with_one_shot(self):
        ...
        self.assertEqual(one_shots_from_contract, expected_one_shots)
