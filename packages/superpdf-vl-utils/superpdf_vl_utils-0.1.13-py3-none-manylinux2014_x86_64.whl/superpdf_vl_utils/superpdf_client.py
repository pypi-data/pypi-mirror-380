...
class SuperPdfSamplingParams(SamplingParams):
    def __init__(
        self,
...
DEFAULT_SAMPLING_PARAMS: dict[str, SamplingParams] = {
    "table": SuperPdfSamplingParams(presence_penalty=1.0, frequency_penalty=0.005),
    "equation": SuperPdfSamplingParams(presence_penalty=1.0, frequency_penalty=0.05),
    "[default]": SuperPdfSamplingParams(presence_penalty=1.0, frequency_penalty=0.05),
    "[layout]": SuperPdfSamplingParams(),
}
...
class SuperPdfClient:
    def __init__(
        ...
        self.client = new_vlm_client(
            ...
            allow_truncated_content=True,  # Allow truncated content for SuperPdf
        ...
        self.helper = SuperPdfClientHelper(
            backend=backend,
            prompts=prompts,
