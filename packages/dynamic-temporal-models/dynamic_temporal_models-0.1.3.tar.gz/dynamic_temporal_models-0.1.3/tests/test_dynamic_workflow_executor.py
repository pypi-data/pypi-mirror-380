...
import models.workflow_input as input_module
...
async def test_workflow_with_timeout_configurations(mock_logger, mock_execute_activity):
    ...
    assert call_args.kwargs['schedule_to_close_timeout'] == 600
    assert call_args.kwargs['start_to_close_timeout'] == 300
    assert call_args.kwargs['heartbeat_timeout'] == 60
...
async def test_workflow_with_all_timeout_types(mock_logger, mock_execute_activity):
    ...
    call_args = mock_execute_activity.await_args
    assert call_args.kwargs['schedule_to_close_timeout'] == 1800
    assert call_args.kwargs['start_to_close_timeout'] == 900
    assert call_args.kwargs['heartbeat_timeout'] == 120
