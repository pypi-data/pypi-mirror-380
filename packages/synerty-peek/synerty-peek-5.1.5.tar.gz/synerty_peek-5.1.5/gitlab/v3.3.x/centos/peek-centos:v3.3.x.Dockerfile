...
ENV FEDORA_PACKAGES="https://dl.fedoraproject.org/pub/epel/7/x86_64/Packages"
RUN yum install -y \
    ${FEDORA_PACKAGES}/f/freetds-libs-1.3.3-1.el7.x86_64.rpm \
    ${FEDORA_PACKAGES}/f/freetds-1.3.3-1.el7.x86_64.rpm \
    ${FEDORA_PACKAGES}/f/freetds-devel-1.3.3-1.el7.x86_64.rpm
