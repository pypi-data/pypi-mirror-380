...
class MailerHelper:
    ...
    def get_revenue_report_subject(self, business_unit, execution_date, posting_period_val, frequency="Monthly"):
        if frequency.lower() == "monthly":
            return f"{frequency} {business_unit} Report for period - {posting_period_val}"
        else:
            return f"{frequency} {business_unit} Report for execution date - {execution_date}, period - {posting_period_val}"
    ...
    def get_revenue_report_body(self, env, business_unit, execution_date, period, frequency="monthly"):
