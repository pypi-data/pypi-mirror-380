...
public:
    ...
    py::array_t<float> read_signal(
        ...
        auto data = mzd->getRecordsAsMatrix(loc_1.binned_start, loc_1.binned_end, loc_2.binned_start, loc_2.binned_end, def_value, triangle);
    ...
    py::dict read_sparse_signal(
        ...
        auto mzd = hic_file->getMatrixZoomData(loc_1.chr_id, loc_2.chr_id, mode, normalization, unit, bin_size);
        auto data = mzd->getRecordsAsSparseMatrix(loc_1.binned_start, loc_1.binned_end, loc_2.binned_start, loc_2.binned_end, triangle);
