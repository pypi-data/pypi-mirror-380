...
try:
    from external.MolGpKa.predict_pka import model_pred, load_model as molgpka_load_model
    from external.MolGpKa.utils.ionization_group import get_ionization_aid
...
class MolGpKaWrapper(BaseWrapper):
    """
    ...
    def predict(self, mols: list[chem.Mol]):
        """
            Predict the most basic pKa value for a list of molecules.
            Returns a list of pKa predictions.
        """
        preds = []
