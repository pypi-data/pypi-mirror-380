...
class EventEmitter:
    ...
    def __init__(self, handlers: list[BaseEventHandler], event_level: EventLevel = ...) -> None:
        ...
        """
    @classmethod
    def with_console_handler(cls, event_level: EventLevel = ...) -> EventEmitter:
        ...
        """
    @classmethod
    def with_print_handler(cls, event_level: EventLevel = ...) -> EventEmitter:
        ...
        """
    @classmethod
    def with_stream_handler(cls, event_level: EventLevel = ...) -> EventEmitter:
