...
from .base import TOOLKIT_FOLDER_PATH
...
class Device:
    ...
    def with_switching(
        ...
        if isinstance(self._switch_capability, DmmSwitchCapability):
            ...
            # Initialitze the main switch session, which handles the connection.
            self._switch_capability.initialize_switches(
                sense_switch_resource_name=source_switch_resource_name,
