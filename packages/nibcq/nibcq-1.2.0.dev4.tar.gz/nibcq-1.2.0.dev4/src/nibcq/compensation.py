...
from nibcq.base import DEFAULT_COMPENSATION_DIR
...
class CompensationParameter:
    ...
    def from_item_dict(cls, item: Dict[str, Any]):
        ...
        val = i_str_to_complex(item["Compensation Value (Ohm)"])
    ...
    def to_item_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "Compensation Value (Ohm)": complex_to_i_str(self.compensation_value),
        }
