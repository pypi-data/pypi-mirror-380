...
class JiraServer:
    def __init__(self, base_url: str, default_token: str | None = None):
...
async def serve(jira_base_url: str | None = None, default_token: str | None = None) -> None:
    ...
    if not jira_base_url:
        raise ValueError("Jira base URL is required. Use --jira-base-url parameter.")
    jira_server = JiraServer(jira_base_url, default_token)
